(function($) {
    $.fn.sColor = function(d) {
        ...
        var v = g.keyEvent;
        var w = g.prevColor;
        var x = '<div id="bgColorSelector"><div id="bscParent"><div id="bscDrag" title="婊戝姩涓€涓嬶紝鐒曟柊鑹插僵"><img src="' + s + '" alt="" /></div><table id="bscDrop" cellpadding="0" cellspacing="0"><tr>';
        $.each(q,
        function(i, a) {
