...
LINK_DIC=[
	...
	'customer.htm?suid='+suid, 			//个人中心
	'mySalesList.htm?suid='+suid,  //我的导购
	'/mall5/order.html#/orderList?supplierId='+suid, //我的订单
	'getShoppingCart.htm?suid='+suid, 		  //我的购物车
	'myCouponList.htm?suid='+suid, //我的优惠券
	'getCustomerFavoriteStockList.htm?suid='+suid, //我的收藏
	'activityOfSeckill.htm?suid='+suid, //天天闪购
	'qiangHongBao.htm?suid='+suid, 	 //抢红包
	'javascript:;',
	'exchangeMall.htm?suid='+suid, //积分商城添加suid 【Add By LT】
	'pointSign.htm?supplierId='+suid,
	'special', //商品专题
	'discount',
	'scratch',
	'wheel'
...
PAGE_CONF={
	apiSaveConfUrl:[],// 保存装修配置 !!
	apiGetSupplierFrontConf:[],// 获取装修配置 !!
	apiGetSpecialPromotion:[],// 获取专题活动列表
	apiGetDiscountPromotion: [],// 获取满减满折活动列表
	apiGetScratchPromotion: [],// 刮刮卡列表
	apiGetWheelPromotion: [],// 获取大转盘列表
	apiGetCategoryList: [],// 获取商户下所有类目
	homePreviw:'http://www.qiakr.com/mall/storeHomePreview.htm?storeId=147&suid='+suid,// 移动端预览
	apiGetSelfGroupList:[],// 获取商户下的自定义分类
	apiGetBrandList: [],// 获取商户下所有的品牌
	apiGetStockList: [],// 获取商户下所有的商品列表
	apiGetStoreAllStock:[],// 根据门店ID获取门店所有上架的商品
	brandData:[],
	categorysData:[],
	groupData:[],
