...
<html>
	<head>
		...
		<script src="<{TEMPLE}>/js/L_slide.js"></script>
		<style>
			.contain{
				width: 1200px;
				margin: 0 auto;
				...
				<li class="figure1">
		        	<div class="contain" style="position:relative">
			        	<div class="brief">
			        		...
			        		<a href="<{site_url('index/allChannel')}>" class="btn-look">查看详情</a>
			        	</div>
			        	...
			        	<div class="figure1-bag">
                        	...
                        	<div class="people"><img src="<{TEMPLE}>/imges/figure1_3.png"/></div>
                        </div>
			        </div>
		        ...
		        <li class="figure2">
		        	<div class="contain" style="position:relative">
			        	<div class="brief">
			        		...
			        		<a href="<{site_url('index/memberService')}>" class="btn-look">查看详情</a>
			        	</div>
			        	<div style="clear:both"></div>
			        	<div class="figure2-bag">
                        	<div class="service"><img src="<{TEMPLE}>/imges/figure2_2.png" alt="" /></div>
                        </div>
			        </div>
		        ...
		        <li class="figure3">
		        	<div class="contain" style="position:relative">
			        	<div class="brief">
			        		...
			        		<a href="<{site_url('index/programm')}>" class="btn-look">查看详情</a>
			        	</div>
			        	<div style="clear:both"></div>
		...
		<div class="contain" style="margin-top: 70px;position: relative;">
			...
			<div class="action">
				<div class="action-banner">
					<div class="new-img"><img src="<{TEMPLE}>/imges/news.png" alt="" /></div>
			...
			<div class="action">
				<div class="action-banner">
					<div class="new-img"><img src="<{TEMPLE}>/imges/custom.png" alt=""/></div>
			...
			<div class="action" style="margin-right: 0;">
				<div class="action-banner">
					<div class="new-img"><img src="<{TEMPLE}>/imges/skill.png" alt=""/></div>
