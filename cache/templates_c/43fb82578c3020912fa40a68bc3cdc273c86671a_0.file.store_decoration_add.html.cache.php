<?php
/* Smarty version 3.1.29, created on 2017-08-04 15:16:31
  from "D:\www\yunjuke\application\pay\views\store_decoration_add.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_59841f4fafdef5_21655108',
  'file_dependency' => 
  array (
    '43fb82578c3020912fa40a68bc3cdc273c86671a' => 
    array (
      0 => 'D:\\www\\yunjuke\\application\\pay\\views\\store_decoration_add.html',
      1 => 1501206919,
      2 => 'file',
    ),
  ),
...
function content_59841f4fafdef5_21655108 ($_smarty_tpl) {
$_smarty_tpl->compiled->nocache_hash = '1841559841f4f813cc6_49453674';
  ...
  .openblock{
	...
	<body style="background-color: #FFF; overflow: auto;">
		<nav class="breadcrumb-x">
		    <i class="Hui-iconfont">&#xe67f;</i> 店铺管理 <span class="c-gray en p-lr">&gt;</span><a href="store_decoration_template" style="display: inline-block;color: #333;">装修模板列表</a><span class="c-gray en p-lr">&gt;</span>新增模板
...
" >
	    <input  id ="defaultMid" type="hidden" value="<?php if (isset($_smarty_tpl->tpl_vars['defaultMid']->value) && !empty($_smarty_tpl->tpl_vars['defaultMid']->value)) {
echo $_smarty_tpl->tpl_vars['defaultMid']->value;
}?>" >
			...
			<div class="panel-body">
				<div class="ovh mb20">
					<div class="form-inline dib l mr10">
						<label>模板名称：</label>
						<input type="text" class="form-control w180" id="tplName" placeholder="请输入模板名称" style="height: 30px;">
					</div>
                    ...
                    <div class="ui_form_row">
                        ...
                        <div class="row_content" id="carouselUploaderBoxme1001-4f6e">
                            ...
                            <table class="ui_table table">
                                ...
                                <thead>
                                    <tr>
                                        <th style="padding: 8px 7px;">排序值</th>
                                        <th>图片</th>
                                        <th>链接地址</th>
                                        <th>操作</th>
                                    </tr>
...
echo $_smarty_tpl->tpl_vars['brands_info']->value;
            ...
            <div class="ui_dialog_footer hide mt20 text-center">
                <a href="javascript:;" class="btn btn-primar" data-tag="save" data-id="me1004-70cc">暂存</a>
            </div>
        </div>
    </div>
