<?php
/* Smarty version 3.1.29, created on 2017-07-03 11:20:34
  from "D:\www\yunjuke\application\admin\views\store_shopping_guide.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5959b802a7c263_11969300',
  'file_dependency' => 
  array (
    '470bd7910f0c6799e4eb54c1c28410345fce1896' => 
    array (
      0 => 'D:\\www\\yunjuke\\application\\admin\\views\\store_shopping_guide.html',
      1 => 1497326497,
      2 => 'file',
    ),
  ),
...
function content_5959b802a7c263_11969300 ($_smarty_tpl) {
$_smarty_tpl->compiled->nocache_hash = '136175959b802918a97_14908893';
...
function update_role(id,check,role,name){
	role_ = (role==2)?'店员':'店长';
	if(check&&role!=2){
		title = '该门店已有店长确认修改导购:‘'+name+'’为'+role_+'吗？';
	}else{
		title = '确认修改导购:‘'+name+'’为'+role_+'吗？';
	}
	...
	layer.confirm(title,
			   ...
			   function(){
				   $.ajax({
				        ...
				        dataType: "json",
				        url: "update_role",
				        data: {id:id,role:role,check:check},
				        success: function(data){
						  if(data.state=='403'){
					           login_ajax('shopadmin');
				            }else if(data.state){
