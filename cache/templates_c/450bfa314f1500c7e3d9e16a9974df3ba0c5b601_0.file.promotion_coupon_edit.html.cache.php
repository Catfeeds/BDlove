...
if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  ...
  'version' => '3.1.29',
  'unifunc' => 'content_5980338bd5c7a4_58695599',
  'file_dependency' => 
  array (
...
function content_5980338bd5c7a4_58695599 ($_smarty_tpl) {
$_smarty_tpl->compiled->nocache_hash = '185535980338b818be0_26392912';
$_smarty_tpl->smarty->ext->_subtemplate->render($_smarty_tpl, "file:pageheader.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>

<link href="<?php echo TEMPLE;?>
css/module-page.css" rel="stylesheet" type="text/css">
<style>
    body {
        min-width: 500px;
    }
...
<body style="background-color: #FFF; overflow: auto;">
    <div class="ncap-form-default" ng-app="" ng-init="name = '<?php if (isset($_smarty_tpl->tpl_vars['coupon_info']->value['coupon_name'])) {
echo $_smarty_tpl->tpl_vars['coupon_info']->value['coupon_name'];
} else { ?>优惠券名称<?php }?>';
        denomination = '<?php if (isset($_smarty_tpl->tpl_vars['coupon_info']->value['coupon_denomination'])) {
echo $_smarty_tpl->tpl_vars['coupon_info']->value['coupon_denomination'];
} else { ?>0.00<?php }?>';
        order_limit = '<?php if (isset($_smarty_tpl->tpl_vars['coupon_info']->value['coupon_order_limit'])) {
echo $_smarty_tpl->tpl_vars['coupon_info']->value['coupon_order_limit'];
} else { ?>0.00<?php }?>';
        starttime = '<?php if (isset($_smarty_tpl->tpl_vars['coupon_info']->value['coupon_start_time'])) {
echo $_smarty_tpl->tpl_vars['coupon_info']->value['coupon_start_time'];
} else {
}?>';
        endtime = '<?php if (isset($_smarty_tpl->tpl_vars['coupon_info']->value['coupon_end_time'])) {
echo $_smarty_tpl->tpl_vars['coupon_info']->value['coupon_end_time'];
} else {
}?>'">
        ...
        <form id="coupon_form" method="post" name="coupon_form"  enctype="multipart/form-data">
            ...
            <dl class="row"><dt class="tit"><label for="class_sort"><em>*</em>面值</label></dt>
                <dd class="opt">
                    <input id="coupon_denomination" name="coupon_denomination" type="text" placeholder="0.00" ng-model="denomination" class="input-txt" value="<?php if (!empty($_smarty_tpl->tpl_vars['coupon_info']->value['coupon_denomination'])) {?>$coupon_info.coupon_denomination<?php }?>"><span class="err"></span>
                </dd>
            </dl>

            <dl class="row"><dt class="tit"><label for="class_sort"><em>*</em>订单满</label></dt>
                <dd class="opt">
                    <input id="coupon_order_limit" name="coupon_order_limit" type="text" class="input-txt" ng-model="order_limit" placeholder="0.00" value="<?php if (!empty($_smarty_tpl->tpl_vars['coupon_info']->value['coupon_order_limit'])) {?>$coupon_info.coupon_order_limit<?php }?>">元可用<span class="err"></span>
                </dd>
            </dl>
                ...
                <dd class="opt">
                    <div class="area-region-select">
                        <select class="valid select2" id="coupon_limit_type" name="limit_goods_type">
                            <option value="0" <?php if (isset($_smarty_tpl->tpl_vars['coupon_info']->value['limit_goods_type']) && $_smarty_tpl->tpl_vars['coupon_info']->value['limit_goods_type'] == 0) {?> selected<?php }?>>无限制</option>
                            <option value="1" <?php if (isset($_smarty_tpl->tpl_vars['coupon_info']->value['limit_goods_type']) && $_smarty_tpl->tpl_vars['coupon_info']->value['limit_goods_type'] == 1) {?> selected<?php }?>>限制品类</option>
                            <option value="2" <?php if (isset($_smarty_tpl->tpl_vars['coupon_info']->value['limit_goods_type']) && $_smarty_tpl->tpl_vars['coupon_info']->value['limit_goods_type'] == 2) {?> selected<?php }?>>限制商品</option>
                            <option value="3" <?php if (isset($_smarty_tpl->tpl_vars['coupon_info']->value['limit_goods_type']) && $_smarty_tpl->tpl_vars['coupon_info']->value['limit_goods_type'] == 3) {?> selected<?php }?>>限制品牌</option>
                        </select>
                        <input type="hidden" id="limit_goods"  name="limit_goods" value="<?php if (isset($_smarty_tpl->tpl_vars['coupon_info']->value['limit_goods'])) {
echo $_smarty_tpl->tpl_vars['coupon_info']->value['limit_goods'];
}?>">
                        <input class="btn btn-link radius" type="button" id="BtnLimitGoods" <?php if (isset($_smarty_tpl->tpl_vars['coupon_info']->value['limit_goods_type']) && $_smarty_tpl->tpl_vars['coupon_info']->value['limit_goods_type'] > 0 && !isset($_smarty_tpl->tpl_vars['coupon_id']->value)) {
} else { ?>style="display:none"<?php }?> name="BtnLimitStore" value="编辑"></br>
                        <div id="limitResBox" class="limit-res-box" <?php if (isset($_smarty_tpl->tpl_vars['coupon_info']->value['limit_goods_type']) && $_smarty_tpl->tpl_vars['coupon_info']->value['limit_goods_type'] > 0) {
} else { ?>style="display:none"<?php }?>>
                            <?php if (isset($_smarty_tpl->tpl_vars['limitResBox']->value) && !empty($_smarty_tpl->tpl_vars['limitResBox']->value)) {?>
                                <?php if ($_smarty_tpl->tpl_vars['coupon_info']->value['limit_goods_type'] > 1) {?>
                                    <?php
$_from = $_smarty_tpl->tpl_vars['limitResBox']->value;
...
' class='rel dib w150 ell pr20 mr5'>
                                            <span></span><?php echo $_smarty_tpl->tpl_vars['v']->value['name'];?>
<i class='iconfont limit-close-btn' data-id='<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
'></i>
                                        </div>
                                    <?php
...
?>
                                <?php } else { ?>
                                    <?php echo $_smarty_tpl->tpl_vars['coupon_info']->value['limitResBox'];?>
                ...
                <dd class="opt">
                    <div class="area-region-select">
                        <select class="valid select2" id="SLLimitStore" name="limit_store_type">
                            <option value="0" <?php if (isset($_smarty_tpl->tpl_vars['coupon_info']->value['limit_store_type']) && $_smarty_tpl->tpl_vars['coupon_info']->value['limit_store_type'] == 0) {?> selected<?php }?>>所有门店</option>
                            <option value="1" <?php if (isset($_smarty_tpl->tpl_vars['coupon_info']->value['limit_store_type']) && $_smarty_tpl->tpl_vars['coupon_info']->value['limit_store_type'] == 1) {?> selected<?php }?>>部分门店</option>
                        </select>
                        <input type="hidden" id="limit_store" name="limit_store" value="<?php if (isset($_smarty_tpl->tpl_vars['coupon_info']->value['limit_store'])) {
echo $_smarty_tpl->tpl_vars['coupon_info']->value['limit_store'];
}?>">
                        <input class="btn btn-link radius" <?php if (isset($_smarty_tpl->tpl_vars['coupon_info']->value['limit_store_type']) && $_smarty_tpl->tpl_vars['coupon_info']->value['limit_store_type'] == 1 && !isset($_smarty_tpl->tpl_vars['coupon_id']->value)) {
} else { ?>style="display:none"<?php }?> type="button" id="BtnLimitStore" name="BtnLimitStore" value="编辑"></br>
                        <div id="LimitStoreResBox" class="limit-res-box" <?php if (isset($_smarty_tpl->tpl_vars['coupon_info']->value['limit_store_type']) && $_smarty_tpl->tpl_vars['coupon_info']->value['limit_store_type'] == 1) {
} else { ?>style="display:none"<?php }?>>
                            <?php if (isset($_smarty_tpl->tpl_vars['LimitStoreResBox']->value)) {?>
                                <?php if (is_array($_smarty_tpl->tpl_vars['LimitStoreResBox']->value)) {?>
                                    <?php
$_from = $_smarty_tpl->tpl_vars['LimitStoreResBox']->value;
if (!is_array($_from) && !is_object($_from)) {
settype($_from, 'array');
}
...
?>
                                <?php } else { ?>
                                    <?php echo $_smarty_tpl->tpl_vars['LimitStoreResBox']->value;?>
...
<?php if (!empty($_smarty_tpl->tpl_vars['coupon_info']->value['coupon_desc'])) {
echo $_smarty_tpl->tpl_vars['coupon_info']->value['coupon_desc'];
} else { ?>
1. 必须在订单金额满足时才能使用；
