...
if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  ...
  'version' => '3.1.29',
  'unifunc' => 'content_5980202a826351_26852499',
  'file_dependency' => 
  array (
...
function content_5980202a826351_26852499 ($_smarty_tpl) {
$_smarty_tpl->compiled->nocache_hash = '203215980202a515023_52976997';
								...
								<div class="mobile_bd">
									...
									<ul class="pre_menu_list">
										...
										<li class="add_pre_menu_box pre_menu_link on">
											<a class="addimgparent"><img src="<?php echo TEMPLE;?>
images/add_pre_menu_box.png" class="addimg"  alt="添加菜单">
											</a>
										</li>
										<?php } else { ?>
										<?php
...
?>
										<li class="pre_menu_item size1of3" data-name="<?php echo $_smarty_tpl->tpl_vars['v']->value['menu_name'];?>
" data-type="<?php echo $_smarty_tpl->tpl_vars['v']->value['menu_type'];?>
" data-value="<?php echo $_smarty_tpl->tpl_vars['v']->value['menu_value'];?>
" <?php if (count($_smarty_tpl->tpl_vars['menu']->value) == 1) {?>style="display: block; width: 50%;"<?php }
if (count($_smarty_tpl->tpl_vars['menu']->value) > 1) {?>style="display: block; width: 33.33%;"<?php }?>>
										<a href="javascript:void(0);" class="pre_menu_link">
										<i class="icon_menu_dot"></i><span class=""><?php echo $_smarty_tpl->tpl_vars['v']->value['menu_name'];?>
</span>
										</a>
										<div class="sub_pre_menu_box" style="display: none;">
										<ul class="sub_pre_menu_list">
										<?php if (empty($_smarty_tpl->tpl_vars['v']->value['son'])) {?>
										...
										<?php } else { ?>
										<?php
$_from = $_smarty_tpl->tpl_vars['v']->value['son'];
if (!is_array($_from) && !is_object($_from)) {
settype($_from, 'array');
}
...
foreach ($_from as $_smarty_tpl->tpl_vars['vs']->value) {
$_smarty_tpl->tpl_vars['vs']->_loop = true;
$__foreach_vs_1_saved_local_item = $_smarty_tpl->tpl_vars['vs'];
?>
										<li id="" class="jslevel2" data-name="<?php echo $_smarty_tpl->tpl_vars['vs']->value['menu_name'];?>
" data-type="<?php echo $_smarty_tpl->tpl_vars['vs']->value['menu_type'];?>
" data-value="<?php echo $_smarty_tpl->tpl_vars['vs']->value['menu_value'];?>
">
										<a href="javascript:void(0);" class="jsSubView">
										<span class="sub_pre_menu_inner js_sub_pre_menu_inner"><i class="icon20_common"></i><span class="js_l2Title"><?php echo $_smarty_tpl->tpl_vars['vs']->value['menu_name'];?>
</span></span>
										</a></li>
										<?php
...
?>
										...
										<li class="add_pre_menu_box pre_menu_link on" <?php if (count($_smarty_tpl->tpl_vars['menu']->value) == 0) {?>style="display: block; width: 100%;"<?php }
if (count($_smarty_tpl->tpl_vars['menu']->value) == 1) {?>style="display: block; width: 48%;"<?php }
if (count($_smarty_tpl->tpl_vars['menu']->value) == 2) {?>style="display: block; width: 32.33%;"<?php }
if (count($_smarty_tpl->tpl_vars['menu']->value) >= 3) {?>style="display: none;"<?php }?>>
											<a class="addimgparent"><img src="<?php echo TEMPLE;?>
images/add_pre_menu_box.png" class="addimg"  alt="添加菜单">
											</a>
										</li>
