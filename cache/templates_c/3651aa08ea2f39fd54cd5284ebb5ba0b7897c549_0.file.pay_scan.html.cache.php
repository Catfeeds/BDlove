...
if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  ...
  'version' => '3.1.29',
  'unifunc' => 'content_5983cc0221fd46_77360257',
  'file_dependency' => 
  array (
...
function content_5983cc0221fd46_77360257 ($_smarty_tpl) {
$_smarty_tpl->compiled->nocache_hash = '205715983cc01d27fd7_80576596';
?>
<!DOCTYPE html>
<html>
...
@media only screen and (max-width: 1180px) {
	...
	<body>
		...
		<div class="pull-right guide mr-20 mt-10">
										<div class="guide-icon"><img src="<?php echo TEMPLE;?>
images/guide.png" class="img-responsive"/></div>
										...
										<div id="storeG" style="display: none;">
											<select id="storeGuide" name="storeGuide" class="selectarea">
												<?php
$_from = $_smarty_tpl->tpl_vars['storeGuide']->value;
...
?>
												<option value="<?php echo $_smarty_tpl->tpl_vars['v']->value['spg_id'];?>
"><?php echo $_smarty_tpl->tpl_vars['v']->value['spg_name'];?>
</option>
												<?php
...
login_out";
		  ...
		  var LODOP; //声明为全局变量   
		    function install_print(){
		    	url_32 = "<?php echo base_url('data/print/CLodop_Setup_for_Win32NT_2.090.zip');?>
";
				url_64 = "<?php echo base_url('data/print/CLodop_Setup_for_Win64NT_2.090.zip');?>
";
				url_3264 = "<?php echo base_url('data/print/CLodopPrint_Setup_for_Win32NT.zip');?>
";
				layer.open({
		            type: 1,
		            title: '<b>打印控件下载</b>',
