...
if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  ...
  'version' => '3.1.29',
  'unifunc' => 'content_59b394cad25128_90762393',
  'file_dependency' => 
  array (
...
function content_59b394cad25128_90762393 ($_smarty_tpl) {
$_smarty_tpl->compiled->nocache_hash = '2998359b394ca447697_23680084';
...
<div class="page-container wrapper_search">
    ...
    <form action="goods_add_goods_third?op=edit&goods_id=<?php echo $_smarty_tpl->tpl_vars['goods_id']->value;?>
" id="form_2" method="post">
    <input type="hidden" name="editGoodsId" id="editGoodsId" value="<?php echo $_smarty_tpl->tpl_vars['goods_id']->value;?>
">
    <?php if ($_smarty_tpl->tpl_vars['color_amount']->value > 1) {?>
    <input type="hidden" name="single_stocks_code_flag" value="multiple">
    <?php }?>
    <input id="color_arr" value='<?php echo $_smarty_tpl->tpl_vars['colors']->value;?>
' type="hidden">
        <div class="ncsc-form-goods">
            ...
            <dl>
                ...
                <dd>
                    <input name="base_info[goods_name]" type="text" class="text w400" value="<?php echo $_smarty_tpl->tpl_vars['goods_info']->value['goods_name'];?>
">
                    <span class="err"></span>
            ...
            <dl>
                ...
                <dd id="gcategory">
                    <input type="hidden" name="base_info[gc_name]" id="gc_name" value="<?php echo $_smarty_tpl->tpl_vars['goods_info']->value['gc_name'];?>
">
                    <select name="base_info[gc_id]" id="gc_id" data-ids="<?php echo $_smarty_tpl->tpl_vars['class_id']->value;?>
" class="selecte pd-5 mb-10 select2" onchange="get_info_by_class(this)">
                        <option value="<?php echo $_smarty_tpl->tpl_vars['class_id']->value;?>
" selected><?php echo $_smarty_tpl->tpl_vars['goods_info']->value['gc_name'];?>
</option>
                    </select>
                    <span class="err"></span>
...
echo $_smarty_tpl->tpl_vars['type_id']->value;
                ...
                <dd>
                    <div class="ncsc-brand-select">
                        <div class="selection">
                            <input name="base_info[brand_name]" id="brand_name" value="<?php echo $_smarty_tpl->tpl_vars['goods_info']->value['brand_name'];?>
" type="text" class="text w180" readonly="">
                            <input type="hidden" name="base_info[brand_id]" id="b_id" value="<?php echo $_smarty_tpl->tpl_vars['goods_info']->value['brand_id'];?>
"><em class="add-on">
                            <i class="fa fa-caret-square-o-down"></i></em></div>
                        <div class="ncsc-brand-select-container">
                            <div class="brand-index" data-tid="<?php echo $_smarty_tpl->tpl_vars['type_id']->value;?>
...
?>
                ...
                <dl>
                    ...
                    <dd>
                        <input name="base_info[year_to_market]" type="text" class="text" value="<?php echo $_smarty_tpl->tpl_vars['goods_info']->value['year_to_market'];?>
">
                        <span class="err"></span>
                ...
                <dl>
                    ...
                    <dd id="gcategory">
                        <select name="base_info[season_to_market]"  class="selecte pd-5 mb-10 select2 ">
	                        ...
	                        <option value="1" <?php if ($_smarty_tpl->tpl_vars['goods_info']->value['season_to_market'] == 1) {?>selected<?php }?> >春季</option>
	                        <option value="2" <?php if ($_smarty_tpl->tpl_vars['goods_info']->value['season_to_market'] == 2) {?>selected<?php }?> >夏季</option>
	                        <option value="3" <?php if ($_smarty_tpl->tpl_vars['goods_info']->value['season_to_market'] == 3) {?>selected<?php }?> >秋季</option>
	                        <option value="4" <?php if ($_smarty_tpl->tpl_vars['goods_info']->value['season_to_market'] == 4) {?>selected<?php }?> >冬季</option>
                        </select>
                        <span class="err"></span>
                ...
                <dl>
                    ...
                    <dd id="gcategory">
                        <select name="base_info[sex]" class="selecte pd-5 mb-10 select2 ">
	                        ...
	                        <option value="2" <?php if ($_smarty_tpl->tpl_vars['goods_info']->value['sex'] == 2) {?>selected<?php }?> >男</option>
	                        <option value="1" <?php if ($_smarty_tpl->tpl_vars['goods_info']->value['sex'] == 1) {?>selected<?php }?> >女</option>
	                        <option value="0" <?php if ($_smarty_tpl->tpl_vars['goods_info']->value['sex'] == 0) {?>selected<?php }?> >通用</option>
                        </select>
                        <span class="err"></span>
            ...
            <dl>
                <dt>商品自定义标签分类：</dt>
                <dd>
                    <select name="gstn[]" class="selecte pd-5 mb-10 select2" id="gstn_id" data-ids="<?php echo $_smarty_tpl->tpl_vars['gstn_ids']->value;?>
" multiple="multiple" >
                    </select>
                    <span class="err"></span>
            ...
            <dl>
                <dt>商品卖点：</dt>
                <dd>
                    <textarea maxlength="140" onchange="this.value=this.value.substring(0, 140)" onkeyup="this.value=this.value.substring(0, 140)"  name="base_info[goods_jingle]" class="textarea h60 w400"><?php echo $_smarty_tpl->tpl_vars['goods_info']->value['goods_jingle'];?>
</textarea>
                    <span></span>
            ...
            <dl>
                ...
                <dd nc_type="no_spec">
                    <input name="base_info[goods_price]" value="<?php echo $_smarty_tpl->tpl_vars['goods_info']->value['goods_price'];?>
" data-old="0.00" type="text" class="text w60"><em class="add-on"><i class="fa fa-rmb"></i></em> <span class="price"></span><span class="err"></span>
            ...
            <dl>
                ...
                <dd>
                    <input name="base_info[goods_marketprice]" value="<?php echo $_smarty_tpl->tpl_vars['goods_info']->value['goods_marketprice'];?>
" type="text" class="text w60"><em class="add-on"><i class="fa fa-rmb"></i></em> <span class="err"></span>
            ...
            <dl>
                <dt>折扣：</dt>
                <dd>
                    <input name="base_info[discount]" value="<?php echo $_smarty_tpl->tpl_vars['goods_info']->value['discount'];?>
" type="text" class="text w60"><em class="add-on">%</em>
            ...
            <dl>
                ...
                <dd nc_type="no_spec">
                    <p>
                        <input name="base_info[goods_spu]" id="stocks_code" class="stocks_code" value="<?php echo $_smarty_tpl->tpl_vars['goods_info']->value['goods_spu'];?>
" type="text" class="text" nctype="stocks_code"><span class="err"></span>
                    </p>
            ...
            <dl>
                ...
                <dd nc_type="no_spec">
                    <p>
                        <input name="base_info[weight]" id="weight" class="weight" value="<?php echo $_smarty_tpl->tpl_vars['goods_info']->value['weight'];?>
" type="number" class="text" nctype="weight"><span>克</span><span class="err"></span>
                    </p>
                    <p class="hint"></p>
                </dd>
            </dl>
            <dl nctype="spec_group_dl" style="overflow: visible" spec_img="t">
                ...
                <dd nctype="" class="pos-r">
                    <div class="choose_color_box">
                        <?php if ($_smarty_tpl->tpl_vars['color_amount']->value <= 1) {?>
                        <?php if (!empty($_smarty_tpl->tpl_vars['goods_amount_info']->value)) {?>
                        <div class="choose_color_box_list mb-10" id="creat_tr_0">
                            <input type="hidden" name="color[0][goods_a_id]" class="color_value color_a_id"  value="<?php echo $_smarty_tpl->tpl_vars['goods_amount_info']->value[0]['goods_a_id'];?>
">
                            ...
                            <input type="text" name="color[0][color]" nctype="pv_name" class="picker-text w300 mr-5" onchange="change_color(this)" onfocus="f1(this)"  value="<?php echo $_smarty_tpl->tpl_vars['goods_amount_info']->value[0]['color'];?>
" readonly placeholder="选择主色" maxlength="30" data-old="">
                            <input type="hidden" name="color[0][color_value]" class="color_value"  value="<?php echo $_smarty_tpl->tpl_vars['goods_amount_info']->value[0]['color_value'];?>
">
                            <input type="text" name="color[0][color_remark]" class="picker-remark" placeholder="备注（如丁香紫,宝石蓝等）" value="<?php echo $_smarty_tpl->tpl_vars['goods_amount_info']->value[0]['color_remark'];?>
" maxlength="30">
                        ...
                        <div class="choose_color_box_list mb-10" id="creat_tr_0">
                            <input type="checkbox" nctype="input_checkbox" onchange="color_check_click(this)" class="color-select mr-5" name="color-select[]">
                            <input type="text" name="color[0][color]" nctype="pv_name" class="picker-text w300 mr-5" onfocus="f1(this)" readonly value="" placeholder="选择主色" maxlength="30" data-old="">
                        ...
                        <?php }?>
                        <?php } elseif ($_smarty_tpl->tpl_vars['color_amount']->value > 1) {?>
                        <?php
$_from = $_smarty_tpl->tpl_vars['goods_amount_info']->value;
if (!is_array($_from) && !is_object($_from)) {
settype($_from, 'array');
}
...
?>
                        <div class="choose_color_box_list mb-10" id="creat_tr_<?php echo $_smarty_tpl->tpl_vars['key']->value;?>
">
                            <input type="hidden" name="color[<?php echo $_smarty_tpl->tpl_vars['key']->value;?>
][goods_a_id]" class="color_value color_a_id"  value="<?php echo $_smarty_tpl->tpl_vars['v']->value['goods_a_id'];?>
">
                            ...
                            <input type="text" name="color[<?php echo $_smarty_tpl->tpl_vars['key']->value;?>
][color]" nctype="pv_name" class="picker-text w300 mr-5" onfocus="f1(this)"  value="<?php echo $_smarty_tpl->tpl_vars['v']->value['color'];?>
" readonly placeholder="选择主色" maxlength="30" data-old="">
                            <input type="hidden" name="color[<?php echo $_smarty_tpl->tpl_vars['key']->value;?>
][color_value]" class="color_value"  value="<?php echo $_smarty_tpl->tpl_vars['v']->value['color_value'];?>
">
                            <input type="text" name="color[<?php echo $_smarty_tpl->tpl_vars['key']->value;?>
][color_remark]" class="picker-remark" placeholder="备注（如丁香紫,宝石蓝等）" value="<?php echo $_smarty_tpl->tpl_vars['v']->value['color_remark'];?>
" maxlength="30">
                            <div class="pos-a choose_color_box_hide hide mt-10 c-333">
                            </div>
                        </div>	
...
?>
                        <div class="choose_color_box_list mb-10" id="creat_tr_<?php echo $_smarty_tpl->tpl_vars['color_amount']->value;?>
">
                            <input type="checkbox" nctype="input_checkbox" onchange="color_check_click(this)" class="color-select mr-5" name="color-select[]">
                            <input type="text" name="color[<?php echo $_smarty_tpl->tpl_vars['color_amount']->value;?>
][color]s" nctype="pv_name" class="picker-text w300 mr-5" onfocus="f1(this)" readonly  value="" placeholder="选择主色" maxlength="30" data-old="">
                            <input type="hidden" name="color[<?php echo $_smarty_tpl->tpl_vars['color_amount']->value;?>
][color_value]" class="color_value"  value="">
                            <input type="text" name="color[<?php echo $_smarty_tpl->tpl_vars['color_amount']->value;?>
][color_remark]" class="picker-remark" placeholder="备注（如丁香紫,宝石蓝等）" value="" maxlength="30">
                            <div class="pos-a choose_color_box_hide hide mt-10 c-333">
                            </div>
                        </div>
                        <?php }?>
...
$_smarty_tpl->tpl_vars['v'] = new Smarty_Variable();
$_smarty_tpl->tpl_vars['__smarty_foreach_name'] = new Smarty_Variable(array('index' => -1));
...
" <?php if ($_smarty_tpl->tpl_vars['code_segment']->value == $_smarty_tpl->tpl_vars['v']->value['id']) {?>checked="checked"<?php }?> ><?php echo $_smarty_tpl->tpl_vars['v']->value['name'];?>
...
?>
                    ...
                    <div style="background-color: #F6F7Fb;display: <?php if ($_smarty_tpl->tpl_vars['code_segment']->value == $_smarty_tpl->tpl_vars['k']->value) {?>block;<?php } else { ?>none;<?php }?>" class="size_list size_list_<?php echo $_smarty_tpl->tpl_vars['k']->value;?>
">
                        <ul style="">
                            <?php
...
?>
                            <li class="f-l mr-20 ml-10"  style="" data-order="0" data-text="" data-value="">
                                <label>
                                    <input type="checkbox" data-code="<?php echo $_smarty_tpl->tpl_vars['code_segment']->value;?>
" <?php if (in_array($_smarty_tpl->tpl_vars['vv']->value['size'],$_smarty_tpl->tpl_vars['goods_sizes']->value) !== false && $_smarty_tpl->tpl_vars['k']->value == $_smarty_tpl->tpl_vars['code_segment']->value) {?>checked="true" <?php }?>class="size_val" data-text="<?php echo $_smarty_tpl->tpl_vars['vv']->value['size'];?>
...
?>
            ...
            <dl nc_type="spec_dl" class="spec-bg" style="<?php if ($_smarty_tpl->tpl_vars['size_amount']->value < 1) {?>display:none;<?php }?> overflow: visible;">
                <dt>宝贝销售规格：</dt>
                <dd class="spec-dd">
                    ...
                    <div nctype="spec_div" class="spec-div ps-container">
                        <table border="0" cellpadding="0" cellspacing="0" class="spec_table" style="width:80% !important">
                            ...
                            <tbody nc_type="spec_table">
                                <?php if (!empty($_smarty_tpl->tpl_vars['goods_extend_attr_arr']->value)) {?>
                                    <?php
$_from = $_smarty_tpl->tpl_vars['goods_extend_attr_arr']->value;
if (!is_array($_from) && !is_object($_from)) {
settype($_from, 'array');
}
$__foreach_name_5_saved = isset($_smarty_tpl->tpl_vars['__smarty_foreach_name']) ? $_smarty_tpl->tpl_vars['__smarty_foreach_name'] : false;
$__foreach_name_5_saved_item = isset($_smarty_tpl->tpl_vars['v']) ? $_smarty_tpl->tpl_vars['v'] : false;
$__foreach_name_5_saved_key = isset($_smarty_tpl->tpl_vars['k']) ? $_smarty_tpl->tpl_vars['k'] : false;
$_smarty_tpl->tpl_vars['v'] = new Smarty_Variable();
$_smarty_tpl->tpl_vars['__smarty_foreach_name'] = new Smarty_Variable(array('index' => -1));
$_smarty_tpl->tpl_vars['k'] = new Smarty_Variable();
$_smarty_tpl->tpl_vars['v']->_loop = false;
...
$_smarty_tpl->tpl_vars['v']->_loop = true;
$_smarty_tpl->tpl_vars['__smarty_foreach_name']->value['index']++;
$__foreach_name_5_saved_local_item = $_smarty_tpl->tpl_vars['v'];
?>
                                        <?php
...
$__foreach_vv_6_saved_item = isset($_smarty_tpl->tpl_vars['vv']) ? $_smarty_tpl->tpl_vars['vv'] : false;
$__foreach_vv_6_saved_key = isset($_smarty_tpl->tpl_vars['kk']) ? $_smarty_tpl->tpl_vars['kk'] : false;
$_smarty_tpl->tpl_vars['vv'] = new Smarty_Variable();
$_smarty_tpl->tpl_vars['kk'] = new Smarty_Variable();
$_smarty_tpl->tpl_vars['vv']->_loop = false;
foreach ($_from as $_smarty_tpl->tpl_vars['kk']->value => $_smarty_tpl->tpl_vars['vv']->value) {
$_smarty_tpl->tpl_vars['vv']->_loop = true;
$__foreach_vv_6_saved_local_item = $_smarty_tpl->tpl_vars['vv'];
?>
                                        <tr class="creat_tr_<?php echo (isset($_smarty_tpl->tpl_vars['__smarty_foreach_name']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_foreach_name']->value['index'] : null);?>
 size_tr_<?php echo $_smarty_tpl->tpl_vars['vv']->value['size'];?>
">
                                        <input type="hidden"  class="goods_ea_id" name="size[<?php echo (isset($_smarty_tpl->tpl_vars['__smarty_foreach_name']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_foreach_name']->value['index'] : null);?>
][<?php echo $_smarty_tpl->tpl_vars['kk']->value;?>
][goods_ea_id]" value="<?php echo $_smarty_tpl->tpl_vars['vv']->value['goods_ea_id'];?>
" />
                                        <td><input type="hidden"  class="color" name="size[<?php echo (isset($_smarty_tpl->tpl_vars['__smarty_foreach_name']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_foreach_name']->value['index'] : null);?>
][<?php echo $_smarty_tpl->tpl_vars['kk']->value;?>
][color]" value="<?php echo $_smarty_tpl->tpl_vars['vv']->value['color'];?>
" />
                                            <span class="goods_color"><?php if (!empty($_smarty_tpl->tpl_vars['vv']->value['color_remark'])) {
echo $_smarty_tpl->tpl_vars['vv']->value['color_remark'];
} else {
echo $_smarty_tpl->tpl_vars['vv']->value['color'];
}?></span>
                                        </td>
                                        <td><input type="hidden"  class="size_val" name="size[<?php echo (isset($_smarty_tpl->tpl_vars['__smarty_foreach_name']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_foreach_name']->value['index'] : null);?>
][<?php echo $_smarty_tpl->tpl_vars['kk']->value;?>
][size]" value="<?php echo $_smarty_tpl->tpl_vars['vv']->value['size'];?>
" />
                                            <input type="hidden"  class="code_segment" name="size[<?php echo (isset($_smarty_tpl->tpl_vars['__smarty_foreach_name']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_foreach_name']->value['index'] : null);?>
][<?php echo $_smarty_tpl->tpl_vars['kk']->value;?>
][code_segment]" value="<?php echo $_smarty_tpl->tpl_vars['code_segment']->value;?>
" />
                                            <span class="goods_size"><?php echo $_smarty_tpl->tpl_vars['vv']->value['size'];?>
</span>
                                        </td>
                                        <td><input class="size-note" type="text" name="size[<?php echo (isset($_smarty_tpl->tpl_vars['__smarty_foreach_name']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_foreach_name']->value['index'] : null);?>
][<?php echo $_smarty_tpl->tpl_vars['kk']->value;?>
][size_note]" value="<?php echo $_smarty_tpl->tpl_vars['vv']->value['size_note'];?>
" /></td>
                                        <td><input class="text price sell_price" type="text" name="size[<?php echo (isset($_smarty_tpl->tpl_vars['__smarty_foreach_name']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_foreach_name']->value['index'] : null);?>
][<?php echo $_smarty_tpl->tpl_vars['kk']->value;?>
][stocks_price]" data_type="price" nc_type="price" value="<?php echo $_smarty_tpl->tpl_vars['vv']->value['stocks_price'];?>
" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text price goods_marketprice" type="text" name="size[<?php echo (isset($_smarty_tpl->tpl_vars['__smarty_foreach_name']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_foreach_name']->value['index'] : null);?>
][<?php echo $_smarty_tpl->tpl_vars['kk']->value;?>
][stocks_marketprice]" data_type="marketprice" nc_type="|marketprice" value="<?php echo $_smarty_tpl->tpl_vars['vv']->value['stocks_marketprice'];?>
" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text sku stocks_code" type="text" name="size[<?php echo (isset($_smarty_tpl->tpl_vars['__smarty_foreach_name']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_foreach_name']->value['index'] : null);?>
][<?php echo $_smarty_tpl->tpl_vars['kk']->value;?>
][stocks_sku]" nctype="stocks_code" value="<?php echo $_smarty_tpl->tpl_vars['vv']->value['stocks_sku'];?>
" /><span class="error checkCode" style="display:none;">此货号已有其他颜色占用。</span><span class="error dberr" style="display:none;">此货号已被同品牌的其他商品占用。</span></td>
                                        <td><input class="text bar_code" type="text" name="size[<?php echo (isset($_smarty_tpl->tpl_vars['__smarty_foreach_name']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_foreach_name']->value['index'] : null);?>
][<?php echo $_smarty_tpl->tpl_vars['kk']->value;?>
][stocks_bar_code]" data_type="stocks_bar_code" nc_type="|stocks_bar_code" value="<?php echo $_smarty_tpl->tpl_vars['vv']->value['stocks_bar_code'];?>
" /></td>
                                        </tr>
                                        <?php
$_smarty_tpl->tpl_vars['vv'] = $__foreach_vv_6_saved_local_item;
}
if ($__foreach_vv_6_saved_item) {
$_smarty_tpl->tpl_vars['vv'] = $__foreach_vv_6_saved_item;
}
if ($__foreach_vv_6_saved_key) {
$_smarty_tpl->tpl_vars['kk'] = $__foreach_vv_6_saved_key;
}
?>
                                    <?php
$_smarty_tpl->tpl_vars['v'] = $__foreach_name_5_saved_local_item;
}
if ($__foreach_name_5_saved) {
$_smarty_tpl->tpl_vars['__smarty_foreach_name'] = $__foreach_name_5_saved;
}
if ($__foreach_name_5_saved_item) {
$_smarty_tpl->tpl_vars['v'] = $__foreach_name_5_saved_item;
}
if ($__foreach_name_5_saved_key) {
$_smarty_tpl->tpl_vars['k'] = $__foreach_name_5_saved_key;
}
?>
                                <?php }?>
                            </tbody>
                ...
                <dd>
                    <div class="ncsc-goods-default-pic">
                        <div class="goodspic-uplaod">
                            <div class="upload-thumb"> <img nctype="goods_image" src="<?php echo $_smarty_tpl->tpl_vars['goods_info']->value['img_url'];?>
"> </div>
                            <input type="hidden" name="base_info[goods_image]" id="image_path" nctype="goods_image" value="<?php echo $_smarty_tpl->tpl_vars['goods_info']->value['goods_image'];?>
">
                            <span class="err"></span>
                        ...
                        <div id="tab_demo" class="HuiTab">
                            ...
                            <div class="tabCon mt-10">
                                <div class="" id="baidu_edit">
                                    <!-- 加载编辑器的容器 -->
                                    <textarea id="content" name="content" type="text/plain"><?php echo $_smarty_tpl->tpl_vars['goods_info']->value['pc_desc'];?>
</textarea>
                                    <!-- 实例化编辑器 -->
                                    <?php echo '<script'; ?>
...
">
                                        	...
                                        	<div class="module m-text">
                                                    <div class="tools">
                                                        <a nctype="mp_up" href="javascript:void(0);">上移</a>
                                                        <a nctype="mp_down" href="javascript:void(0);">下移</a>
                                                        <a nctype="mp_edit" href="javascript:void(0);">编辑</a>
                                                        <a nctype="mp_del" href="javascript:void(0);">删除</a>
                                                    </div>
                                                    <div class="content">
                                                        <div class="text-div"><?php echo $_smarty_tpl->tpl_vars['v']->value['value'];?>
</div>
                                                    </div>
                                                    <div class="cover">
                                                    </div>
            ...
            <dl>
                    ...
                    <dd>
                        <select name="base_info[logistics_type]" id="base_info[gc_id]" class="selecte pd-5 mb-10 select2" onchange="">
                            <option value="0" <?php if (isset($_smarty_tpl->tpl_vars['goods_info']->value['logistics_type']) && $_smarty_tpl->tpl_vars['goods_info']->value['logistics_type'] != 0) {
} else { ?>selected<?php }?>>不限制</option>
                            <option value="1"  <?php if ($_smarty_tpl->tpl_vars['goods_info']->value['logistics_type'] == 1) {?>selected<?php }?> >仅限到店提货</option>
                            <option value="2" <?php if ($_smarty_tpl->tpl_vars['goods_info']->value['logistics_type'] == 2) {?>selected<?php }?>>仅限快递</option>
                        </select>
                    </dd>
                </dl>
                <dl>
                    <dt>限购数量：</dt>
                    <dd>
                        <input name="base_info[limit_num]" type="text" class="text w400" value="<?php echo $_smarty_tpl->tpl_vars['goods_info']->value['limit_num'];?>
">
                        <span class="err"></span>
                ...
                <dl class="row">
                    ...
                    <dd class="opt">
                        <div class="onoff">
                            <label for="audit1" class="cb-enable <?php if ($_smarty_tpl->tpl_vars['goods_info']->value['available_coupons'] == 1) {?>selected<?php }?>" id="cb" title="开启">开启</label>
                            <label for="audit2" class="cb-disable <?php if ($_smarty_tpl->tpl_vars['goods_info']->value['available_coupons'] == 0) {?>selected<?php }?>" id="bc" title="关闭">关闭</label>
                            <input type="radio" id="audit1" name="base_info[available_coupons]" value="1" <?php if ($_smarty_tpl->tpl_vars['goods_info']->value['available_coupons'] == 1) {?>checked="checked"<?php }?>>
                            <input type="radio" id="audit2" name="base_info[available_coupons]" value="0" <?php if ($_smarty_tpl->tpl_vars['goods_info']->value['available_coupons'] == 0) {?>checked="checked"<?php }?>>
                        </div>
                        <p class="notic"></p>
                    </dd>
                </dl>
                <dl class="row">
                    ...
                    <dd class="opt">
                        <div class="onoff">
                            <label for="audit3" class="cb-enable <?php if ($_smarty_tpl->tpl_vars['goods_info']->value['available_member_dis'] == 1) {?>selected<?php }?>" id="cb" title="开启">开启</label>
                            <label for="audit4" class="cb-disable <?php if ($_smarty_tpl->tpl_vars['goods_info']->value['available_member_dis'] == 0) {?>selected<?php }?>" id="bc" title="关闭">关闭</label>
                            <input type="radio" id="audit3" name="base_info[available_member_dis]" value="1" <?php if ($_smarty_tpl->tpl_vars['goods_info']->value['available_member_dis'] == 1) {?>checked="checked"<?php }?>>
                            <input type="radio" id="audit4" name="base_info[available_member_dis]" value="0" <?php if ($_smarty_tpl->tpl_vars['goods_info']->value['available_member_dis'] == 0) {?>checked="checked"<?php }?>>
                        </div>
                        <p class="notic"></p>
                    </dd>
                </dl>
        ...
        <input name="m_body" autocomplete="off" type="hidden" value='<?php echo $_smarty_tpl->tpl_vars['goods_info']->value['mobile_desc'];?>
'>
    </form>
<div id="fixedNavBar">
    <h3>页面导航</h3>
...
login_out";
                    	...
                    	goods_attr = <?php echo $_smarty_tpl->tpl_vars['goods_attr_info']->value;?>
;
...
>
        //选中input
        var d = <?php echo $_smarty_tpl->tpl_vars['color_amount']->value+1;?>
;
        var s = <?php echo $_smarty_tpl->tpl_vars['color_amount']->value+1;?>
;
        var i = <?php echo $_smarty_tpl->tpl_vars['size_amount']->value+1;?>
;
        var s_arr = [];
        //info:选中那条的数据
        //type:类型1：颜色 2：尺码
