<?php
/* Smarty version 3.1.29, created on 2017-04-24 09:33:14
  from "E:\www\yunjuke\application\admin\views\login.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_58fd55da5ab901_83857825',
  'file_dependency' => 
  array (
    '0c8817955b369531215c56306e59fa1b1aba7482' => 
    array (
      0 => 'E:\\www\\yunjuke\\application\\admin\\views\\login.html',
      1 => 1492225944,
      2 => 'file',
    ),
  ),
...
function content_58fd55da5ab901_83857825 ($_smarty_tpl) {
$_smarty_tpl->compiled->nocache_hash = '2580158fd55da55c089_87088283';
?>
<!DOCTYPE html>
<html>
<head>
...
>
    <?php echo '<script'; ?>
 src="<?php echo TEMPLE;?>
js/jquery.tscookie.js" type="text/javascript" type="text/javascript"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="<?php echo TEMPLE;?>
...
>
    <?php echo '<script'; ?>
 src="<?php echo TEMPLE;?>
js/jquery.supersized.min.js" ><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="<?php echo TEMPLE;?>
js/jquery.progressBar.js" type="text/javascript"><?php echo '</script'; ?>
>
...
<div class="login-layout">
    ...
    <form method="post" id="form_login">
        ...
        <div class="avatar"><img src="<?php echo TEMPLE;?>
img/login_pic.png" alt=""></div>
        <div class="submit"> <span>
      <div class="code">
          <div class="arrow"></div>
          <div class="code-img">
          <a href="javascript:void(0)" nctype="btn_change_seccode"><img
									src="login/verify_image?t=<?php echo $_smarty_tpl->tpl_vars['random']->value;?>
" name="codeimage"
...
/img/login/5.jpg'}
  ...
  //更换验证码
    function change_seccode() {
        $('#codeimage').attr('src', 'login/verify_image?t=' + Math.random());
        $('#captcha').select();
    }
