...
if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  ...
  'version' => '3.1.29',
  'unifunc' => 'content_5983dd9968c309_85307507',
  'file_dependency' => 
  array (
...
function content_5983dd9968c309_85307507 ($_smarty_tpl) {
$_smarty_tpl->compiled->nocache_hash = '168685983dd994ea320_51488037';
?>
<!DOCTYPE HTML>
<html>
<head>
...
<div class="page-container">
	...
	<img class="avatar size-XXXL l" src=" <?php echo $_smarty_tpl->tpl_vars['result']->value['head_portrait'];?>
">
	<a href="javascript:;" class="change-img" id="head_pic">修改头像</a>
	<dl class="l" style="margin-left:40px;">
		<dt>
			<p><?php echo $_smarty_tpl->tpl_vars['result']->value['spg_name'];?>
</p>
			<p>账号ID：<?php echo $_smarty_tpl->tpl_vars['result']->value['spg_id'];?>
</p>
			<p>当前登录：<?php echo $_smarty_tpl->tpl_vars['result']->value['ip'];?>
</p>
			<p>注册时间：<?php echo $_smarty_tpl->tpl_vars['result']->value['reg_time'];?>
</p>
		</dt>
	</dl>
	</div>
		...
		<table class="table table-border table-lg">
			<tbody>
				...
				<tr>
					...
					<td>多一个密码，多一次保障</td>
					<?php if (!empty($_smarty_tpl->tpl_vars['result']->value['pay_pwd'])) {?>
					<td class="cl-g"><i class="Hui-iconfont f-16 mr-5">&#xe6e1;</i>已设置</td>
					<?php } else { ?>
				...
				<tr>
					...
					<?php if (!empty($_smarty_tpl->tpl_vars['result']->value['spg_tel'])) {?>
					<td>您已绑定了手机<?php echo $_smarty_tpl->tpl_vars['result']->value['spg_phone'];?>
。[您的手机为安全手机，可以找回密码]</td>
					<td class="cl-g"><i class="Hui-iconfont f-16 mr-5">&#xe6e1;</i>已设置</td>
					<?php } else { ?>
				...
				<tr>
					...
					<?php if (!empty($_smarty_tpl->tpl_vars['result']->value['bind_email'])) {?>
					<td>您已绑定了邮箱<?php echo $_smarty_tpl->tpl_vars['result']->value['bind_email'];?>
。[您的邮箱为安全邮箱，可以找回密码，但不能用于登录]</td>
					<td class="cl-g"><i class="Hui-iconfont f-16 mr-5">&#xe6e1;</i>已设置</td>
					<?php } else { ?>
					<td style="color: red">未绑定</td>
					<td class="cl-o"><i class="Hui-iconfont f-16 mr-5">&#xe6e0;</i>未设置</td>
...
<?php echo '<script'; ?>
 src="<?php echo TEMPLE;?>
js/ajaxfileupload.js" type="text/javascript"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 type="text/javascript">
    ...
    $("body").on('click',"#send_code",function(){
        ...
        var tel="<?php echo $_smarty_tpl->tpl_vars['result']->value['spg_tel'];?>
";
        send_code($(this),tel);
    });
...
login_out";
    ...
    var payp="<?php echo $_smarty_tpl->tpl_vars['result']->value['pay_pwd'];?>
";
