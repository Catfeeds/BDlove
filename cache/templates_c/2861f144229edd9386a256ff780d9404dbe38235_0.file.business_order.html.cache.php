...
if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  ...
  'version' => '3.1.29',
  'unifunc' => 'content_59ccadb3adcf51_63560397',
  'file_dependency' => 
  array (
...
function content_59ccadb3adcf51_63560397 ($_smarty_tpl) {
$_smarty_tpl->compiled->nocache_hash = '2765459ccadb37f6ba4_78373034';
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'business_order?role=<?php if (isset($_smarty_tpl->tpl_vars['role']->value)) {
...
//                                    +'<td class="w70"><div class="ncsc-goods-thumb"><a href="<?php echo base_url();?>
...
index.php/goods/goods_details/'+goods.goods_id+'.html">'+goods.goods_name+'</a><a target="_blank" class="blue ml5" href="">[交易快照]</a><br><bl style="color: gray">颜色：'+goods.goods_color+'，尺码：'+goods.goods_size+'<br>货号：'+goods.stock_code+'</bl></dt><dd></dd></dl></td>'
...
//                                    +'<td class="tl"><dl class="goods-name"><dt><a target="_blank" href="<?php echo base_url();?>
index.php/goods/goods_details/'+goods.goods_id+'.html">'+goods.goods_name+'</a><a target="_blank" class="blue ml5" href="">[交易快照]</a><br><bl style="color: gray">颜色：'+goods.goods_color+'，尺码：'+goods.goods_size+'<br>货号：'+goods.stock_code+'</bl></dt>'
...
admin.php/Business/order_cancel",
        data: data,
        type: 'POST',
        dataType: 'json',
