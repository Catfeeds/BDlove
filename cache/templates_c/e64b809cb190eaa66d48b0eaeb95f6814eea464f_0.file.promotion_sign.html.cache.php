...
if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  ...
  'version' => '3.1.29',
  'unifunc' => 'content_59f9640e7ae507_52854198',
  'file_dependency' => 
  array (
...
function content_59f9640e7ae507_52854198 ($_smarty_tpl) {
$_smarty_tpl->compiled->nocache_hash = '2184859f9640e499352_48446519';
...
images/sign_points.png"  width="300px"  height="540px"/>
		</div>
		<div class="ncap-form-default active" id="add_form_op">
			<form id="add_form" method="post" action="store_add" enctype="multipart/form-data">
			  <!--<input type="hidden" class="sign_id" name="sign_id" value="<?php if (isset($_smarty_tpl->tpl_vars['sign']->value['sign_id'])) {
echo $_smarty_tpl->tpl_vars['sign']->value['sign_id'];
}?>">-->
				<input type="hidden" class="sign_id" name="sign_id" value="<?php if (isset($_smarty_tpl->tpl_vars['sign']->value['sign_id'])) {
echo $_smarty_tpl->tpl_vars['sign']->value['sign_id'];
}?>">
			  <dl class="row">
					...
					<dd class="opt">
						<input type="text" id="sign_title" name="sign_title" value="<?php if (isset($_smarty_tpl->tpl_vars['sign']->value['sign_title'])) {
echo $_smarty_tpl->tpl_vars['sign']->value['sign_title'];
}?> " <?php if (isset($_smarty_tpl->tpl_vars['sign']->value['sign_title'])) {?>disabled="disabled"<?php }?> >
						<span class="err"></span>
				...
				<dl class="row">
					...
					<dd class="opt">
						<label class="slideBtn on">
		        					<input type="radio" class="bar" name="status" <?php if (isset($_smarty_tpl->tpl_vars['sign']->value['sign_status'])) {
if ($_smarty_tpl->tpl_vars['sign']->value['sign_status'] == 1) {?>checked<?php }
} else { ?>checked<?php }?> value="1" <?php if (isset($_smarty_tpl->tpl_vars['sign']->value['sign_status'])) {?>disabled="disabled"<?php }?>>
		        					<span class="stateOn">开启</span>
		        					<input type="radio" class="bar"  name="status" <?php if (isset($_smarty_tpl->tpl_vars['sign']->value['sign_status'])) {
if ($_smarty_tpl->tpl_vars['sign']->value['sign_status'] == 2) {?>checked<?php }
}?> value="2" <?php if (isset($_smarty_tpl->tpl_vars['sign']->value['sign_status'])) {?>disabled="disabled"<?php }?>>
				...
				<dl class="row">
					...
					<dd class="opt">
						<textarea name="rule" rows="6" class="tarea" id="statistics_code" <?php if (isset($_smarty_tpl->tpl_vars['sign']->value['sign_rule'])) {?>disabled="disabled"<?php }?>><?php if (isset($_smarty_tpl->tpl_vars['sign']->value['sign_rule'])) {
echo $_smarty_tpl->tpl_vars['sign']->value['sign_rule'];
}?></textarea>
						<span class="err"></span>
                ...
                <dl class="row">
					...
					<dd class="opt">
						<input type="text" id="start_time" onclick="laydate()" value="<?php if (isset($_smarty_tpl->tpl_vars['sign']->value['sign_start_time'])) {
echo $_smarty_tpl->tpl_vars['sign']->value['sign_start_time'];
}?>" name="start_time" style="background-color: #fff" class="data-start" placeholder="起始时间" <?php if (isset($_smarty_tpl->tpl_vars['sign']->value['sign_start_time'])) {?>disabled="disabled"<?php }?>>
						至&nbsp;<input type="text" id="end_time" onclick="laydate()" value="<?php if (isset($_smarty_tpl->tpl_vars['sign']->value['sign_end_time'])) {
echo $_smarty_tpl->tpl_vars['sign']->value['sign_end_time'];
}?>" name="end_time" style="background-color: #fff" class="data-end" placeholder="截止时间" <?php if (isset($_smarty_tpl->tpl_vars['sign']->value['sign_end_time'])) {?>disabled="disabled"<?php }?>><span class="err"></span>
					</dd>
				</dl>
				<?php if (!empty($_smarty_tpl->tpl_vars['rule']->value)) {?>
				<?php
$_from = $_smarty_tpl->tpl_vars['rule']->value;
...
?>
				<dl class="row">
					<dt class="tit">
						<label for="per_integration"><em>*</em><?php if ($_smarty_tpl->tpl_vars['v']->value['sign_day'] == 0) {?>每次签到送：<?php } else { ?>活动期间每累积签到：<?php }?></label>
					</dt>
					<dd class="opt">
					    
						<input type="hidden" class="prize_data" name="prize_data[]" value="<?php echo $_smarty_tpl->tpl_vars['v']->value['data'];?>
" <?php if (isset($_smarty_tpl->tpl_vars['v']->value['data'])) {?>disabled="disabled"<?php }?>>
						<?php if ($_smarty_tpl->tpl_vars['v']->value['sign_day'] == 0) {?>
						<input type="hidden" class="prize_day" name="prize_day[]" value="<?php echo $_smarty_tpl->tpl_vars['v']->value['sign_day'];?>
" <?php if (isset($_smarty_tpl->tpl_vars['v']->value['sign_day'])) {?>disabled="disabled"<?php }?>>
						<?php } else { ?>
						<input class="per_integration" name="prize_day[]" type="number" value="<?php echo $_smarty_tpl->tpl_vars['v']->value['sign_day'];?>
" <?php if (isset($_smarty_tpl->tpl_vars['v']->value['sign_day'])) {?>disabled="disabled"<?php }?> style="width: 40px">天送
						<?php }?>
						<select class="min giveCouponSel" name="prize_type[]" <?php if (isset($_smarty_tpl->tpl_vars['v']->value['sign_prize_type'])) {?>disabled="disabled"<?php }?>>
						<option value="0" >不赠送</option>	
						<option value="3" <?php if ($_smarty_tpl->tpl_vars['v']->value['sign_prize_type'] == 3) {?>selected<?php }?>>赠送积分</option>					
						<option value="5" <?php if ($_smarty_tpl->tpl_vars['v']->value['sign_prize_type'] == 5) {?>selected<?php }?>>赠送红包</option>		
						<option value="1" <?php if ($_smarty_tpl->tpl_vars['v']->value['sign_prize_type'] == 1) {?>selected<?php }?>>赠送优惠券</option>				
						</select>
						<span class="prize_show">
						<!--<span class="prize_show" data=<?php echo $_smarty_tpl->tpl_vars['v']->value['data'];?>
><a href="javascript:;" style="padding-right:10px;color:red;" onclick="edit_prize(<?php echo $_smarty_tpl->tpl_vars['v']->value['data'];?>
)">编辑</a>-->
						<div class="<?php if ($_smarty_tpl->tpl_vars['v']->value['sign_prize_type'] == 1) {?>sale<?php } elseif ($_smarty_tpl->tpl_vars['v']->value['sign_prize_type'] == 3) {?>reduce<?php } elseif ($_smarty_tpl->tpl_vars['v']->value['sign_prize_type'] == 5) {?>money<?php }?>"> <div class="store_name"></div><p class="coupon_text"><span class="all_money"><?php echo $_smarty_tpl->tpl_vars['v']->value['title'];?>
</span>
						<img class="goods_img" src="<?php echo $_smarty_tpl->tpl_vars['v']->value['image'];?>
" alt="">
						</p><div class="coupon_bottom"><p class="coupon_time">有效期：<?php echo $_smarty_tpl->tpl_vars['v']->value['start_time'];?>
...
?>
				...
				<?php }?>
				<?php if (isset($_smarty_tpl->tpl_vars['sign']->value)) {
} else { ?><dl class="row">
	             <dd class="opt">
	             <a class="add_rule" href="javascript:void(0)"><i class="fa fa-plus"></i>新增一个条件</a>
					...
					<div class="bot">
						...
						<?php if (isset($_smarty_tpl->tpl_vars['sign']->value)) {
} else { ?><div class="btn btn-default w-xs saveCreateBtn" id="save">保存</div><?php }?>
            	...
            	//结束时间不能大于开始时间且不能小于现在
          		...
          		$("#form_edit_prize").validate({
       			...
       			if($('#form_edit_prize').valid()){
       	            ...
       	            '<p class="coupon_text"><span class="all_money">'+title+'</span><img class="goods_img" src="<?php echo TEMPLE;?>
images/redmoney.png" alt=""></p>'+ 
...
"></div>'+
            						...
            						'<div class="row search_goods" style="margin-top: 10px;">'+
            							...
            							'</div>'+
            						'</div>';
            					$('#groupbuy_goods_image').attr('src','<?php echo PLUGIN;?>
data/images/<?php echo $_smarty_tpl->tpl_vars['defaultImg']->value;?>
');
            	...
            	//结束时间不能大于开始时间且不能小于现在
          		...
          		$("#form_edit_prize").validate({
       			...
       			if($('#form_edit_prize').valid()){
       	            ...
       	            '<div class="store_name"></div>'+ 
       	            '<p class="coupon_text"><span class="all_money">'+prize_point+'</span>积分劵<img class="goods_img" src="<?php echo TEMPLE;?>
images/integ.png" alt=""></p>'+ 
       	            '<div class="coupon_bottom">'+ 
       	            '<p class="coupon_time">有效期：'+$('#start_sale_time').val()+'~'+$('#end_sale_time').val()+'</p>'+ 
       	            '</div>'+ 
       	            '</div>';
