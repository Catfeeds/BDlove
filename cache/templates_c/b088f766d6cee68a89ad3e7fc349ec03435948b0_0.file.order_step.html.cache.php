...
if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  ...
  'version' => '3.1.29',
  'unifunc' => 'content_59c35cfd272754_46175233',
  'file_dependency' => 
  array (
...
function content_59c35cfd272754_46175233 ($_smarty_tpl) {
$_smarty_tpl->compiled->nocache_hash = '2987859c35cfcaf60b8_64394866';
...
plugins/layer/layui.js"><?php echo '</script'; ?>
>
<link rel="stylesheet" type="text/css" src="<?php echo PLUGIN;?>
plugins/layer/layui.css">
<style>
.new-store-select{
	    line-height: 16px;
    color: #FFF;
...
.weui-uploader__input-box:before {
    ...
    height: 39.5px;
    background: url(<?php echo TEMPLE;?>
images/addprice.png) no-repeat center;
...
//                            goods.goods_type = (goods.goods_type == 2) ? '<span class="sale-type">团购</span>' : ((goods.goods_type == 3) ? '<span class="sale-type">限时折扣</span>' : ((goods.goods_type == 4) ? '<span class="sale-type">组合套装</span>' : ((goods.goods_type == 5) ? '<span class="sale-type">赠品</span>' : '')));
                            ...
                            bind_ecstore = '<span class="ml-5 radius" style="background:#ccc">'+data_null(order.bind_ecstore_name,'<?php echo $_smarty_tpl->tpl_vars['bind_ecstore_name']->value;?>
')+'</span>';
