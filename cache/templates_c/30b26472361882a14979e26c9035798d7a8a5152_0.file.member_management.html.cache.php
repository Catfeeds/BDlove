...
if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  ...
  'version' => '3.1.29',
  'unifunc' => 'content_59ccadb2d614d6_68872493',
  'file_dependency' => 
  array (
...
function content_59ccadb2d614d6_68872493 ($_smarty_tpl) {
$_smarty_tpl->compiled->nocache_hash = '89159ccadb2988de0_53426961';
...
?>
							<option value="<?php echo $_smarty_tpl->tpl_vars['val']->value['store_id'];?>
"  class="understore">-<?php echo $_smarty_tpl->tpl_vars['val']->value['store_name'];?>
-</option>
							<?php
				...
				<dd class="opt">
					<div class="area-region-select">
						<select class="valid select2" name="underguide" id="area_region_select_guide">
                            ...
                            <?php if (!empty($_smarty_tpl->tpl_vars['guide']->value)) {?>
                            <?php
$_from = $_smarty_tpl->tpl_vars['guide']->value;
if (!is_array($_from) && !is_object($_from)) {
settype($_from, 'array');
}
...
<?php echo '<script'; ?>
 type="text/javascript">
    ...
    $(function(){
        ...
        $("#flexigrid").flexigrid({
            url: 'member_list?role=<?php if (isset($_smarty_tpl->tpl_vars['role']->value)) {
echo $_smarty_tpl->tpl_vars['role']->value;
        ...
        $('#submit').click(function(){
            ...
            $("#flexigrid").flexOptions({url: 'member_list?role=<?php if (isset($_smarty_tpl->tpl_vars['role']->value)) {
echo $_smarty_tpl->tpl_vars['role']->value;
}?>&'+$("#formSearch").serialize(),query:'',qtype:''}).flexReload();
        })
    ...
    function fg_operate(name, grid) {
        if (name == 'delete') {
            ...
            window.location.href="user_management_add?role=<?php if (isset($_smarty_tpl->tpl_vars['role']->value)) {
echo $_smarty_tpl->tpl_vars['role']->value;
}?>";
        }else if (name == 'csv'){
            var itemlist = new Array();
    ...
    function fg_csv(ids){
        ...
        id = ids.join(',');
        window.location.href = 'code_excel?role=<?php if (isset($_smarty_tpl->tpl_vars['role']->value)) {
echo $_smarty_tpl->tpl_vars['role']->value;
}?>&id=' + id;
