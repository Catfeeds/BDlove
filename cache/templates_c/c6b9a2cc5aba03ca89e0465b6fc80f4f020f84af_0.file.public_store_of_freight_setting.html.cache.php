...
if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  ...
  'version' => '3.1.29',
  'unifunc' => 'content_598eb68ca8fd70_29551944',
  'file_dependency' => 
  array (
...
function content_598eb68ca8fd70_29551944 ($_smarty_tpl) {
$_smarty_tpl->compiled->nocache_hash = '16001598eb68c7b5555_36828592';
?>
            ...
            <div class="item-title">
               <a class="back" href="javascript:history.back(-1)" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
					<div class="subject">
						...
						<h5><?php if (isset($_smarty_tpl->tpl_vars['role']->value) && $_smarty_tpl->tpl_vars['role']->value == 'w') {?>微商城<?php } elseif ($_smarty_tpl->tpl_vars['role']->value == 'd') {?>电商<?php } elseif ($_smarty_tpl->tpl_vars['role']->value == 'g') {?>供应仓库<?php } else { ?>平台<?php }?>中的运费设置</h5>
					</div>
...
">其他</a></li>
	...
	<span class="l">
	 <a href="mall_express_area_add?role=<?php if (isset($_smarty_tpl->tpl_vars['role']->value)) {
echo $_smarty_tpl->tpl_vars['role']->value;
}?>&store_id=<?php echo $_smarty_tpl->tpl_vars['store_data']->value['store_id'];?>
"  class="btn btn-add radius ncap-btn-green"><span><i class="fa fa-plus"></i>新增配送区域</span></a>
...
function del_info(transport_id){
	layer.confirm('确认删除这条数据吗?', {
    	...
    	$.ajax({
    		type: "post",
            url: "mall_express_tools_del?role=<?php if (isset($_smarty_tpl->tpl_vars['role']->value)) {
echo $_smarty_tpl->tpl_vars['role']->value;
}?>",
...
function page_to(rp_val,cur_page,search_data){
	$.ajax({
		type: "post",
        url: "mall_express_tools?role=<?php if (isset($_smarty_tpl->tpl_vars['role']->value)) {
echo $_smarty_tpl->tpl_vars['role']->value;
}?>&op=change&"+search_data,
...
function edit_info(obj){
	...
	var form = $("<form></form>");
    form.attr('action','mall_express_area_add?role=<?php if (isset($_smarty_tpl->tpl_vars['role']->value)) {
echo $_smarty_tpl->tpl_vars['role']->value;
}?>&store_id=<?php echo $_smarty_tpl->tpl_vars['store_data']->value['store_id'];?>
');
...
/write_import/excel_upload";
	var content_url='express_fee_import?role=<?php if (isset($_smarty_tpl->tpl_vars['role']->value)) {
echo $_smarty_tpl->tpl_vars['role']->value;
}?>';
	layer.open({
        type: 1,
