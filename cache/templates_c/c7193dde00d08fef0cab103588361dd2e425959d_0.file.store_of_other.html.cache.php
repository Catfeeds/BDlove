...
if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  ...
  'version' => '3.1.29',
  'unifunc' => 'content_595de80521bba5_19314056',
  'file_dependency' => 
  array (
...
function content_595de80521bba5_19314056 ($_smarty_tpl) {
$_smarty_tpl->compiled->nocache_hash = '21936595de805008725_37051611';
?>
            ...
            <div class="ncap-form-default">
                ...
                <dl class="row">
                    ...
                    <label for="class_name">订单抽成比例</label>
						...
						<dd class="opt">
							<div class="percent">线下订单：<input type="number" value="<?php if (isset($_smarty_tpl->tpl_vars['store_data']->value['order_take_percentage']['offline'])) {
echo $_smarty_tpl->tpl_vars['store_data']->value['order_take_percentage']['offline'];
							...
							<div class="percent">平台订单：<input type="number" value="<?php if (isset($_smarty_tpl->tpl_vars['store_data']->value['order_take_percentage']['system'])) {
