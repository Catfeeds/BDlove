...
if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  ...
  'version' => '3.1.29',
  'unifunc' => 'content_5979a3258e1173_07791831',
  'file_dependency' => 
  array (
...
function content_5979a3258e1173_07791831 ($_smarty_tpl) {
$_smarty_tpl->compiled->nocache_hash = '314435979a32545cc67_40260134';
...
.ui_mask_wrapper{
  ...
  .openblock{
	...
	<body style="background-color: #FFF; overflow: auto;">
	   ...
	   <input  id ="TEMPLEimg" type="hidden" value="<?php echo TEMPLE;?>
" >
	   <input  id ="defaultMid" type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['defaultMid']->value;?>
" >
	...
	<div class="col-md-12">
		<div class="panel panel-default" id="decWrap">
			<div class="panel-heading">
				<h5><span id="currStoreName" style="visibility: visible;">当前门店：<?php echo $_smarty_tpl->tpl_vars['storeInfo']->value['store_name'];?>
</span> <a href="https://qiakr.kf5.com/posts/view/81524" target="_blank" class="r f14"><span class="text-primary"><i class="Hui-iconfont f18 rel" style="top:1px;">&#xe633;</i> 微商城装修帮助教程</span></a></h5>
			</div>
			<div class="panel-body">
				<div class="ovh mb20">
					<div class="form-inline dib l mr10">
						<label>模板名称：</label>
						<input type="text" class="form-control w180" id="tplName" placeholder="请输入模板名称" style="height: 30px;" value="<?php echo $_smarty_tpl->tpl_vars['temples_name']->value;?>
">
					</div>
        ...
        <div class="phone_wrapper l mr10" id="phoneWrap">
            <div class="phone_simulator">
                <div class="phone_container" id="phoneContainer">
                    ...
                    <?php if (!empty($_smarty_tpl->tpl_vars['str']->value)) {
echo $_smarty_tpl->tpl_vars['str']->value;
						   ...
						   <div class="wx_mod" modid="1000" id="m1000" >
						    ...
						    <div class="wx_mod" modid="1011" id="m1011">
						        <div class="title" style="padding: 10px; display: none;">店招模块</div>
						        <div class="bd" style="display: block;">
						            <a href="javascript:;" class="db"><img src="<?php echo TEMPLE;?>
images/home_banner.jpg" class="wx-top-banner"></a>
						        </div>
						    </div>
						    ...
						    <div class="wx_mod" modid="1012" id="m1012" >
						        <div class="title" style="padding: 10px; display: none;">店铺信息模块</div>
						        <div class="bd" style="display: block;">
						           <div class="wx-shop-info">
						            <div class="info-l">
						                <img class="shop-logo" src="<?php echo TEMPLE;?>
images/iconfont-stroe.png">
						                <h2>射洪  品牌店 </h2>
						                <p>导购 某某某 正在为您服务</p>
						            </div>
						            <div class="info-r">
            ...
            <div>
                ...
                <div class="form-group form-inline" id="chkViewBox">
                    <div class="checkbox checkbox-info dib mr10">
                        <input type="checkbox" name="show" id="chkIptSearch" value="m1000" <?php if ($_smarty_tpl->tpl_vars['topinfo']->value['m1000'] == 1) {?>checked=""<?php }?> >
                        <label for="chkIptSearch">搜索</label>
                    </div>
                    <div class="checkbox checkbox-info dib mr10">
                        <input type="checkbox" name="show" id="chkIptBanner" value="m1011" <?php if ($_smarty_tpl->tpl_vars['topinfo']->value['m1011'] == 1) {?>checked=""<?php }?>>
                        <label for="chkIptBanner">店招</label>
                    </div>
                    <div class="checkbox checkbox-info dib mr10">
                        <input type="checkbox" name="show" id="chkIptInfo" value="m1012" <?php if ($_smarty_tpl->tpl_vars['topinfo']->value['m1012'] == 1) {?>checked=""<?php }?>>
...
echo $_smarty_tpl->tpl_vars['cate_option']->value;
                                        ...
                                        <select name="brandSlt" class="form-control input-sm hide w200" id="sltBrandme1004-70cc">
                                            <?php if (!empty($_smarty_tpl->tpl_vars['brands_info']->value)) {
echo $_smarty_tpl->tpl_vars['brands_info']->value;
}?>
                                        </select>
...
>
        ...
        <div id="shopPreView" class="l ml20" style="padding-left: 61.5px;">
            ...
            <div class="qrcode" id="qrcodeImg">
                <div class="tc fix">
                    <div id="QrCodeImg" ><canvas width="120" height="120" style="display: none;"></canvas><img alt="Scan me!" src="<?php echo PLUGIN;
...
js/juke-decoration.js"><?php echo '</script'; ?>
>
	<?php echo '<script'; ?>
 type="text/javascript">
