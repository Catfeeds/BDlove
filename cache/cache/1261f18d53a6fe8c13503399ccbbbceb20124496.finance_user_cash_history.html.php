...
function content_5980487314f238_22258255 ($_smarty_tpl) {
?>
<!doctype html>
<html>
<head>
...
<script type="text/javascript">
    $(function(){
        $("#flexigrid").flexigrid({
            url: '../get_user_cash_history?id=94',
            dataType: 'xml',
            colModel : [
