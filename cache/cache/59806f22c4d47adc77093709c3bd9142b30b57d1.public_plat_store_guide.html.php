...
if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  ...
  'version' => '3.1.29',
  'unifunc' => 'content_59a8d9b0c1d7f7_47652667',
  'file_dependency' => 
  array (
...
function content_59a8d9b0c1d7f7_47652667 ($_smarty_tpl) {
?>
<!doctype html>
<html>
<head>
...
<style type="text/css">
			...
			<div class="fixed-bar">
				<div class="item-title">
					...
					<ul class="tab-base nc-row">
						...
						<li>
							<a href="store_shopping_guide_content?role=d">导购评价</a>
						</li>
					</ul>
				</div>
			</div>
	...
	$(function(){
		...
		$("#flexigrid").flexigrid({
			url: 'get_store_shopping_guide?role=d&id=',
			colModel : [
	    ...
	    if (name == 'delete') {
	    	...
	    	window.location.href="store_shopping_guide_edit?role=d&id=";
	    }else if (name == 'del') {
	    	if($('.trSelected',grid).length>0){
	            var itemlist = new Array();
	            $('.trSelected',grid).each(function(){
	...
	/*编辑*/
	function fg_edit(id){
		window.location.href="store_shopping_guide_edit?role=d&id="+id;
	}
