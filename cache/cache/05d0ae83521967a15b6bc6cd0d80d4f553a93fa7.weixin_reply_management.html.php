...
if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  ...
  'version' => '3.1.29',
  'unifunc' => 'content_5980204a1ef9c5_47938052',
  'file_dependency' => 
  array (
...
function content_5980204a1ef9c5_47938052 ($_smarty_tpl) {
?>
<!doctype html>
<html>
<head>
...
function login_ajax(demo,data){
	...
	<script src="http://[::1]/yunjuke/application/admin/views/js/H-ui.min.js"></script>
  	<script src="http://[::1]/yunjuke/application/admin/views/js/jquery-ui.js"></script>
<style>
	.addtext{
		position: fixed;
		top: 30%;
  ...
  <form method="post" id="form_email-public" action="setting" name="settingForm">
    ...
    <div class="ncap-form-default">
       <div class="msgBox" style="height:320px;">
				...
				<div class="supplierMsg"><div class="cont"><a href="http://www.jukeyunduan.com/vmall.php/index">▶▶逛商城◀◀</a></div><i class="iconfont"></i></div>
			</div>
			<div class="msgTipBox">
				<div class="tip">
					<b>回复场景:</b>
    	...
    	<div class="ncap-form-default">
       		<div class="msgBox draggable ui-widget-content" style="min-height:300px;margin-left: 10px;margin-bottom: 400px;">
				<ul class="show cont ui-sortable" id="msgList" style="font-size: 14px;">
					...
					<li class="msg-item" id="strnum1">
						<a href="javascript:;" class="mainMsg">
							<img id="strnum1img"src="http://www.jukeyunduan.com/application/admin/views/images/20170606140005593644e58a831_weixin.jpg" class="mainImg image">
							<input type="text" style="display:none" value="欢迎来到 BE童装城" id = "strnum1Title" name="strnum1Title">
							<input type="text" style="display:none" value="http://www.jukeyunduan.com/application/admin/views/images/20170606140005593644e58a831_weixin.jpg" id = "strnum1PicUrl" name="strnum1PicUrl">
							<input type="text" style="display:none" value="http://www.jukeyunduan.com/vmall.php/index" id = "strnum1Url" name="strnum1Url">
							...
							<input type="text" style="display:none" value="衷心的感谢你对 BE童装城的关注" id = "strnum1Description" name="strnum1Description">
							<div class="mainTitle fn-left" style="padding: 0" id = "strnum1divTitle">欢迎来到 BE童装城</div>
							<div class="actionCover" style="line-height: 134px;"><i class="Hui-iconfont-feedback2"><img src="http://[::1]/yunjuke/application/admin/views/images/write.png"/></i></div>
						</a>
					</li>
					...
					<li class="msg-item" id="strnum2">
						<a href="javascript:;">
							...
							<img id="strnum2img" src="http://[::1]/yunjuke/application/admin/views/images/defaultStoreImg.jpg" alt="" class="simage image fn-right">
				...
				<a href="javascript:;" class="newMsg" id="addNewMsg">
					<i class="Hui-iconfont-add"><img src="http://[::1]/yunjuke/application/admin/views/images/add.png"/></i>
				</a>
			...
			<div class="row c1" id="loadpic" style="display: none">\
				<div class="formControls col-xs-10 col-xs-offset-2">\
					<span class="btn-upload form-group" style="height: 100px;width: 100px;position: relative">\
						<span class="upload-btn"><img id="loadpicimg" src="http://[::1]/yunjuke/application/admin/views/images/defaultImg.png" style="width: 80px;height: 80px;"></span>\
		...
		var form = document.getElementById("btn-uploadform");
		 ...
		 $.ajax({
		        ...
		        success: function(data){
		        	    if(data.state){
		        	    	$("#"+ids+"PicUrl").attr("value","http://[::1]/yunjuke/application/admin/views/images/"+data.msg);
		        	    	$("#"+ids+"img").attr("src","http://[::1]/yunjuke/application/admin/views/images/"+data.msg);
		        	    }else{
		        	    	layer.msg(data.msg);
		        	    }
		        }
	...
	$("#addNewMsg").click(function(){
		...
		'<li class="msg-item" id="strnum'+m+'">\
			<a href="javascript:;">\
				...
				<img id="strnum'+m+'img" src="http://[::1]/yunjuke/application/admin/views/images/defaultImg.png" alt="" class="simage image fn-right">\
				<div class="actionCover">\
					<i class="Hui-iconfont-feedback2"><img src="http://[::1]/yunjuke/application/admin/views/images/write.png"/></i>\
					<i class="Hui-iconfont-del3"><img src="http://[::1]/yunjuke/application/admin/views/images/delete.png"/></i>\
					<i class="Hui-iconfont-menu move"><img src="http://[::1]/yunjuke/application/admin/views/images/drag.png"/></i>\
				</div>\
			</a>\
		</li>'
		)
