...
if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  ...
  'version' => '3.1.29',
  'unifunc' => 'content_59f95eba456bb7_70098294',
  'file_dependency' => 
  array (
...
function content_59f95eba456bb7_70098294 ($_smarty_tpl) {
?>
<!doctype html>
<html>
<head>
    ...
    <form method="post" enctype="multipart/form-data" name="form1">
        <div class="ncap-form-default">
            <dl class="row" style="display:none">
                ...
                <dd class="opt">
                    <div class="input-file-show"><span class="show">
                        ...
                        <i class="fa fa-picture-o"  id="" data-geo='<img src="http://[::1]/yunjuke/data/images/site_logo.png" width=100px height=50px>'></i></a>
            ...
            <dl class="row" style="border-top: none;">
                ...
                <dd class="opt">
                    <div class="input-file-show">
                        <span class="show">
                            <a class="nyroModal" rel="gal" href="javascript:void();">
                                <i class="fa fa-picture-o"  id="" data-geo='<img src="http://[::1]/yunjuke/data/images/member_logo.png" width=100px height=50px>'></i>
                            </a>
                        </span>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <div class="input-file-show"><span class="show"><a class="nyroModal" rel="gal" href="javascript:void();">
                        <i class="fa fa-picture-o"  id="" data-geo='<img src="http://[::1]/yunjuke/data/images/seller_center_logo.jpg" width=100px height=50px>'></i>
                    </a>
                    </span><span class="type-file-box">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input id="site_phone" name="site_phone" value="87650517,2014882889,20161088" class="input-txt" type="text">
                    <span class="err"></span>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input id="site_email" name="site_email" value="1553641475@qq.com" class="input-txt" type="text">
                    <span class="err"></span>
