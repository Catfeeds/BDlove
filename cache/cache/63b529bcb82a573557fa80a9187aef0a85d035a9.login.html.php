...
if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  ...
  'version' => '3.1.29',
  'unifunc' => 'content_59f6eca74d62f2_63629498',
  'file_dependency' => 
  array (
...
function content_59f6eca74d62f2_63629498 ($_smarty_tpl) {
?>
<!doctype html>
<html>
...
<link href="http://[::1]/yunjuke/application/pay/views/css/login.css" rel="stylesheet" type="text/css">
<link href="http://[::1]/yunjuke/application/pay/views/css/font-awesome.min.css" rel="stylesheet" type="text/css">
<link href="http://[::1]/yunjuke/plugins/sweetAlert/sweetalert.css" type="text/css" rel="stylesheet">
<style type="text/css">
    body{
        background: #ff8f36;
    }
...
<div id="loginBG01" class="ncsc-login-bg" style="display: block;">
    <div class="login-content">
        <div class="logo"><img src="http://[::1]/yunjuke/application/pay/views/images/logo.png" alt=""></div>
        <div class="left-banner">
            <div class="people"><img src="http://[::1]/yunjuke/application/pay/views/images/smallpeople.png" alt=""></div>
            <div class="rocket"></div>
            <div class="banner-content1">
                <span>网店</span>助手
                <img src="http://[::1]/yunjuke/application/pay/views/images/storehelp.png" alt="" class="bann-img">
            </div>
            <div class="banner-content2">
                <span>微</span>分销
                <img src="http://[::1]/yunjuke/application/pay/views/images/pay.png" alt="" class="bann-img">
            </div>
            <div class="banner-content3">
                <span>流量</span>导入
                <img src="http://[::1]/yunjuke/application/pay/views/images/stock.png" alt="" class="bann-img">
            </div>
            <div class="banner-content4">
                <img src="http://[::1]/yunjuke/application/pay/views/images/wechat.png" alt="" class="bann-img">
                <span>微</span>商城
            </div>
            <div class="banner-content5">
                <img src="http://[::1]/yunjuke/application/pay/views/images/service.png" alt="" class="bann-img">
                <span>会员</span>营销
            </div>
        </div>
            ...
            <form id="chain_login" method="post" action="" onsubmit="return false;">
                ...
                <div class="input-container">
                    ...
                    <div class="input">
                        ...
                        <div class="code">
                            <div class="arrow"></div>
                            <div class="code-img"><a href="javascript:void(0)" nctype="btn_change_seccode"><img src="verify_image?t=428885638" name="codeimage" border="0" id="codeimage"></a></div>
...
<script type="text/javascript" charset="utf-8"  src="http://[::1]/yunjuke/application/pay/views/js/jquery.js"></script>
<script type="text/javascript" charset="utf-8"  src="http://[::1]/yunjuke/application/pay/views/js/jquery.validation.min.js"></script>
<script type="text/javascript" charset="utf-8"  src="http://[::1]/yunjuke/plugins/sweetAlert/sweetalert.min.js"></script>
