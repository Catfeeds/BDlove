...
if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  ...
  'version' => '3.1.29',
  'unifunc' => 'content_5957382e1dca97_69169226',
  'file_dependency' => 
  array (
...
function content_5957382e1dca97_69169226 ($_smarty_tpl) {
?>
<!doctype html>
<html>
<head>
	...
	<body style="background-color: #FFF; overflow: auto;">
		...
		<div class="page">
			<div class="fixed-bar">
				<div class="item-title">
		               <a class="back" href="javascript:history.back(-1)" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
							<div class="subject">
								<h3>门店管理 - 门店(大本营)商品管理</h3>
								<h5>平台中的门店商品的管理</h5>
							</div>
									                <ul class="tab-base nc-row">
						        <li><a href="store_edit?op=edit&id=1">基本信息</a></li>
						        <li><a href="JavaScript:void(0);" class="current">商品</a></li>
						        <li><a href="store_of_shopping_guide?op=edit&id=1">导购</a></li>
						        <li><a href="store_of_freight_setting?op=edit&id=1">运费</a></li>
						        <!-- <li><a href="store_of_notice_setting?op=edit&id=1">通知</a></li> -->
						        <li><a href="store_of_other?op=edit&id=1">其他</a></li>
					      </ul>
					      		            </div>
			</div>
			<!-- 操作说明 -->
			<div class="explanation" id="explanation">
				...
				<ul>
					...
					<li>1：按货号和尺码导入 <a target="_blank" href="http://[::1]/yunjuke//data/excel_tp/images/storeGoods.png">查看导入格式示例</a>或<a href="javascript:window.location.href = 'storeGoods_tp'">下载格式文件</a>。
					<li>2：按款号、颜色和尺码导入 <a target="_blank" href="http://[::1]/yunjuke//data/excel_tp/images/storeGoodsSku.png">查看导入格式示例</a>或<a href="javascript:window.location.href = 'storeGoodsSku_tp'">下载格式文件</a>。
					<li>3：按条形码导入 <a target="_blank" href="http://[::1]/yunjuke//data/excel_tp/images/storeGoodsBarcode.png">查看导入格式示例</a>或<a href="javascript:window.location.href = 'storeGoodsBarcode_tp'">下载格式文件</a>。
					</li>
				</ul>
		     </div>
     ...
     <form method="post" name="formSearch" id="formSearch" action=""> 
      ...
      品牌<select name="brand_code[]" class="selecte pd-5 m_w_120 mr-10 select2" placeholder="-请选择-" multiple="multiple">
                                			...
                                			<option value="84">阿迪达斯</option> 
					            			<option value="100">宝姿</option> 
					            			<option value="101">爱帝</option> 
					            			<option value="184">华硕</option> 
								        </select>  
...
$(function(){
	...
	$('#search_button').click(function(){
        ...
        $("#flexigrid").flexOptions({url: 'get_storeGoods_list?store_id=1&'+search, method: 'post', qtype:'', query:'',}).flexReload();
    });
	$("#flexigrid").flexigrid({
		url: 'get_storeGoods_list?store_id=1',
		colModel : [
	...
	function import_amount(url){
	    ...
	    layer.open({
			...
			yes: function(index){
				...
				data_import('门店商品库存',"http://[::1]/yunjuke/admin.php/write_import/excel_upload",url+'?store_id=1&'+type+'&name=');
			}, no: function(){
			}
		})
	}
			...
			yes: function(index){
				...
				if($("#form_edit").valid()){
						   ...
						   $.ajax({
						        type: "post",
						        dataType: "json",
						        url: "update_goodsAmount?store_id=1",
