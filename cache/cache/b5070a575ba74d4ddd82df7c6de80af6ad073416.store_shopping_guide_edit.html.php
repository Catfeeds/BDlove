<?php
/* Smarty version 3.1.29, created on 2017-04-22 16:54:24
  from "E:\www\yunjuke\application\admin\views\store_shopping_guide_edit.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_58fb1a409fe245_21326239',
  'file_dependency' => 
  array (
    'b5070a575ba74d4ddd82df7c6de80af6ad073416' => 
    array (
      0 => 'E:\\www\\yunjuke\\application\\admin\\views\\store_shopping_guide_edit.html',
      1 => 1492685734,
      2 => 'file',
    ),
...
function content_58fb1a409fe245_21326239 ($_smarty_tpl) {
?>
<!doctype html>
<html>
<head>
	...
	<body style="background-color: #FFF; overflow: auto;">
		...
		<div class="page">
			...
			<form id="add_form" method="post" action="store_guide_add" enctype="multipart/form-data">
			     <input type="hidden" id="spguide_id" name="spg_id" value="3">
							...
							<div class="area-region-select">
								<select class="valid" name="spg_store_id">
									<option value="">-请选择-</option>
																		<option value="1" selected>qeqe</option>
																	</select>
                    ...
                    <label for="class_name"><em>*</em>名字：</label>
						...
						<dd class="opt">
							<input type="text" value="123" name="spg_name" id="class_name" class="input-txt">
							<span class="err"></span>
                    ...
                    <label for="class_name"><em>*</em>呢称：</label>
						...
						<dd class="opt">
							<input type="text" value="123" name="spg_nike_name" id="class_nike" class="input-txt">
							<span class="err"></span>
                    ...
                    <label for="class_sort">生日：</label>
						...
						<dd class="opt">
						<input type="text" id="birth" onclick="laydate()" value="2017-04-05" name="birth" style="background-color: #fff" class="input-txt">
							<!-- <div class="area-region-select">
                    ...
                    <label for="class_sort"><em>*</em>联系电话：</label>
						...
						<dd class="opt">
							<input id="spguide_tel" name="spg_tel" placeholder="登录账号" type="text" class="input-txt" value="13333333334">
							<span class="err"></span>
						...
						<dd class="opt">
							<div class="area-region-select">
								<select class=""role_type"" name="role_type">
									<option value="">-请选择-</option>
									<option value="1" selected>店员</option>
