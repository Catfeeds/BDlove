...
if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  ...
  'version' => '3.1.29',
  'unifunc' => 'content_59801e9a5c9c42_76230720',
  'file_dependency' => 
  array (
...
function content_59801e9a5c9c42_76230720 ($_smarty_tpl) {
?>
	...
	<form method="post" id="form_" name="settingForm">
		...
		<div class="ncap-form-default">
			<dl class="row">
				...
				<dd class="opt">
					<div class="onoff">
						...
						<input type="radio" id="qq_isuse_1" name="qq_isuse" value="1"  checked >
			...
			<dl class="row">
				...
				<dd class="opt">
					<input id="qq_appid" name="qq_appid" value="2522" class="input-txt" type="text"><span class="err"></span>
			...
			<dl class="row">
				...
				<dd class="opt">
					<input id="qq_appkey" name="qq_appkey" value="2365" class="input-txt" type="text"><span class="err"></span>
					<p class="notic">&nbsp;</p>
				</dd>
			</dl>
