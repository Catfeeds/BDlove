...
if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  ...
  'version' => '3.1.29',
  'unifunc' => 'content_597fdb2da82bd5_46594692',
  'file_dependency' => 
  array (
...
function content_597fdb2da82bd5_46594692 ($_smarty_tpl) {
?>
...
<div class="page">
  ...
  <form id="add_form" method="post"  action="admin?op=insert_admin&admin_id=14">
	<!---管理员的账户信息，新增和修改都在在这个页面---->
    <input type="hidden" name="admin_id" value=" 14 " />
    <div class="ncap-form-default">
      <dl class="row">
        ...
        <dd class="opt">
          <input type="text" id="admin_name" name="admin_name" value=" lixinze " class="input-txt">
          <span class="err"></span>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <select name="role_id">
						<option   value=" 1 " > 线下运营组(主管)</option>
						<option   value=" 6 " > 线上运营组</option>
						<option   value=" 7 " > 线下运营组</option>
						<option   value=" 12 " > 软件开发组</option>
						<option   value=" 13 " > 软件开发组（主管）</option>
						<option   value=" 14 " > 公司负责人</option>
						<option   selected  value=" 15 " > 线上运营组(主管)</option>
					  </select>
          <span class="err"></span>
