...
if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  ...
  'version' => '3.1.29',
  'unifunc' => 'content_599a7a94473bc0_59871820',
  'file_dependency' => 
  array (
...
function content_599a7a94473bc0_59871820 ($_smarty_tpl) {
?>
<!doctype html>
<html>
<head>
		...
		<div class="page">
			<div class="fixed-bar">
				<div class="item-title">
					...
					<div class="subject">
						<h3>店铺管理 - 编辑BE18品牌童装</h3>
						<h5>电商中的所有门店管理</h5>
					</div>
										<ul class="tab-base nc-row">
				        <li><a href="JavaScript:void(0);" class="current">基本信息</a></li>
				        <li><a href="store_of_goods?role=d&op=edit&id=61">商品</a></li>
				        <li><a href="store_of_shopping_guide?role=d&op=edit&id=61">导购</a></li>
				        <li><a href="mall_express_tools?role=d&op=edit&id=61">运费</a></li>
				       <!--  <li><a href="store_of_notice_setting?op=edit&id=61">通知</a></li> -->
				        <li><a href="store_of_other?role=d&op=edit&id=61">其他</a></li>
			      </ul>
			      				</div>
			</div>
			<!-- 操作说明 -->
			...
			<form id="add_form" method="post" action="store_add?role=d" enctype="multipart/form-data">
			     <input type="hidden" name="store_id" id="store_id" value="61">
				<div class="ncap-form-default">
					<dl class="row">
						...
						<dd class="opt">
							<input type="text" value="成都云聚客科技有限公司" name="company_name" id="company_name" class="input-txt">
							<span class="err"></span>
				...
				<dl class="row">
                    ...
                    <label for="class_name"><em>*</em>门店名称</label>
						...
						<dd class="opt storename" style="width:400px;">
							<input type="text" value="BE18品牌童装" name="class_name" id="class_name" class="input-txt  class_name">
							<span class="err"></span>
                    ...
                    <label for="short_store_name"><em>*</em>简称</label>
						...
						<dd class="opt" style="width: 450px;">
							<input type="text" value="BE18C店" name="short_store_name" id="short_store_name" class="short_store_name input-txt">
							<span class="err"></span>
                    ...
                    <label for="class_sort"><em>*</em>外部编码</label>
						...
						<dd class="opt">
							<input id="class_sort" name="class_code" id="class_code" type="text" class="input-txt" value="ABCTBD" placeholder="每个门店的编码是唯一的">
							<span class="err"></span>
                    ...
                    <label for="class_sort"><em>*</em>联系地址</label>
						...
						<dd class="opt">
							<div class="area-region-select">
								...
								<input type="text" value="金泉路5号" name="class_address" id="class_address" style="margin-top:-8px;padding:2px 0;" class="input-txt"> <span class="err"></span></div>
                    ...
                    <label for="class_sort"><em>*</em>联系电话</label>
						...
						<dd class="opt">
							<input id="class_mobile" name="class_mobile" type="text" class="input-txt" value="18200380228">
							<span class="err"></span>
							<p class="notic"></p>
						</dd>
					</dl>
					...
					<dl class="row" id="row_brand_ids" style="display:block">
						<dt class="tit">
						...
						<dd class="opt nobg nopd nobd nobs" style="max-height: 300px;overflow: auto;">
							      	<div class="ncap-account-container ncap-title">
										...
										<h4><input checked class="checkbox va-b" type="checkbox" nctype="groupAll" name="brand_ids[0][]"class="va-b" value="376"> 植木西</h4>
										
										<ul class="ncap-account-container-list" style="width: 40%;    padding-left: 2%;">
										     						      															    		<li><input  checked class="checkbox va-m" type="checkbox" value="47" name="store_ids[0][]"><span class="err"></span>BE18 鹭州里 童装集合店</li>
										    											    										</ul>
										
										<ul class="ncap-account-container-list" style="width: 40%; padding-left: 2%;">
										     						      															    		<li><input checked class="checkbox va-m" type="checkbox" value="68" name="store_ids[0][]"><span class="err"></span>BE18供货仓</li>
										    											    		<li><input  class="checkbox va-m" type="checkbox" value="70" name="store_ids[0][]"><span class="err"></span>云聚客拍摄室</li>
										    											    										</ul>
									</div>
																	<div class="ncap-account-container">
										<h4><input checked class="checkbox va-b" type="checkbox" nctype="groupAll" name="brand_ids[1][]"class="va-b" value="377"> 公主安娜</h4>
										...
										<ul class="ncap-account-container-list" style="width: 40%; padding-left: 2%;">
										     						      															    		<li><input  class="checkbox va-m" type="checkbox" value="70" name="store_ids[1][]"><span class="err"></span>云聚客拍摄室</li>
										    											    		<li><input  class="checkbox va-m" type="checkbox" value="73" name="store_ids[1][]"><span class="err"></span>久思微测试仓</li>
										    											    										</ul>
									</div>
																	<div class="ncap-account-container">
										<h4><input checked class="checkbox va-b" type="checkbox" nctype="groupAll" name="brand_ids[2][]"class="va-b" value="378"> ABC KIDS</h4>
										
										<ul class="ncap-account-container-list" style="width: 40%;    padding-left: 2%;">
										     						      															    		<li><input   class="checkbox va-m" type="checkbox" value="74" name="store_ids[2][]"><span class="err"></span>ABC旗舰店</li>
										    											    										</ul>
										
										<ul class="ncap-account-container-list" style="width: 40%; padding-left: 2%;">
										     						      															    		<li><input checked class="checkbox va-m" type="checkbox" value="65" name="store_ids[2][]"><span class="err"></span>ABC成都仓</li>
										    											    		<li><input checked class="checkbox va-m" type="checkbox" value="70" name="store_ids[2][]"><span class="err"></span>云聚客拍摄室</li>
										    											    		<li><input  class="checkbox va-m" type="checkbox" value="73" name="store_ids[2][]"><span class="err"></span>久思微测试仓</li>
										    											    										</ul>
									</div>
																	<div class="ncap-account-container">
										<h4><input checked class="checkbox va-b" type="checkbox" nctype="groupAll" name="brand_ids[3][]"class="va-b" value="380"> 妮可贝贝</h4>
										
										<ul class="ncap-account-container-list" style="width: 40%;    padding-left: 2%;">
										     						      															    		<li><input   class="checkbox va-m" type="checkbox" value="47" name="store_ids[3][]"><span class="err"></span>BE18 鹭州里 童装集合店</li>
										    											    										</ul>
										
										<ul class="ncap-account-container-list" style="width: 40%; padding-left: 2%;">
										     						      															    		<li><input checked class="checkbox va-m" type="checkbox" value="68" name="store_ids[3][]"><span class="err"></span>BE18供货仓</li>
										    											    		<li><input  class="checkbox va-m" type="checkbox" value="70" name="store_ids[3][]"><span class="err"></span>云聚客拍摄室</li>
										    											    		<li><input  class="checkbox va-m" type="checkbox" value="73" name="store_ids[3][]"><span class="err"></span>久思微测试仓</li>
										    											    										</ul>
									</div>
																	<div class="ncap-account-container">
										<h4><input  class="checkbox va-b" type="checkbox" nctype="groupAll" name="brand_ids[4][]"class="va-b" value="385"> 企鹅仔仔</h4>
										...
										<ul class="ncap-account-container-list" style="width: 40%; padding-left: 2%;">
										     						      															    		<li><input  class="checkbox va-m" type="checkbox" value="68" name="store_ids[4][]"><span class="err"></span>BE18供货仓</li>
										    											    		<li><input  class="checkbox va-m" type="checkbox" value="70" name="store_ids[4][]"><span class="err"></span>云聚客拍摄室</li>
										    											    										</ul>
									</div>
																	<div class="ncap-account-container">
										<h4><input  class="checkbox va-b" type="checkbox" nctype="groupAll" name="brand_ids[5][]"class="va-b" value="386"> 雅鹿</h4>
										...
										<ul class="ncap-account-container-list" style="width: 40%; padding-left: 2%;">
										     						      															    		<li><input  class="checkbox va-m" type="checkbox" value="67" name="store_ids[5][]"><span class="err"></span>雅鹿成都仓</li>
										    											    		<li><input  class="checkbox va-m" type="checkbox" value="70" name="store_ids[5][]"><span class="err"></span>云聚客拍摄室</li>
										    											    		<li><input  class="checkbox va-m" type="checkbox" value="73" name="store_ids[5][]"><span class="err"></span>久思微测试仓</li>
										    											    										</ul>
									</div>
																	<div class="ncap-account-container">
										<h4><input  class="checkbox va-b" type="checkbox" nctype="groupAll" name="brand_ids[6][]"class="va-b" value="387"> 米朵贝尔</h4>
										...
										<ul class="ncap-account-container-list" style="width: 40%; padding-left: 2%;">
										     						      															    		<li><input  class="checkbox va-m" type="checkbox" value="68" name="store_ids[6][]"><span class="err"></span>BE18供货仓</li>
										    											    										</ul>
									</div>
																	<div class="ncap-account-container">
										<h4><input  class="checkbox va-b" type="checkbox" nctype="groupAll" name="brand_ids[7][]"class="va-b" value="388"> 伊诺艾儿</h4>
										...
										<ul class="ncap-account-container-list" style="width: 40%; padding-left: 2%;">
										     						      															    		<li><input  class="checkbox va-m" type="checkbox" value="68" name="store_ids[7][]"><span class="err"></span>BE18供货仓</li>
										    											    										</ul>
									</div>
																	<div class="ncap-account-container">
										<h4><input  class="checkbox va-b" type="checkbox" nctype="groupAll" name="brand_ids[8][]"class="va-b" value="389"> 艾勒蓓力</h4>
										...
										<ul class="ncap-account-container-list" style="width: 40%; padding-left: 2%;">
										     						      															    		<li><input  class="checkbox va-m" type="checkbox" value="68" name="store_ids[8][]"><span class="err"></span>BE18供货仓</li>
										    											    										</ul>
									</div>
																						<script type="text/javascript">
					...
					<dl class="row" id="row_class_brand_auth" style="display:none">
						<dt class="tit">
						...
						<dd class="opt">
							<div class="area-region-select">
								<select class="valid selecte pd-5 mb-10 select2" multiple="multiple"  name="class_brand_auth[]">
																		<option value="376" selected>植木西</option>
																		<option value="377" selected>公主安娜</option>
																		<option value="378" selected>ABC KIDS</option>
																		<option value="380" selected>妮可贝贝</option>
																		<option value="385" >企鹅仔仔</option>
																		<option value="386" >雅鹿</option>
																		<option value="387" >米朵贝尔</option>
																		<option value="388" >伊诺艾儿</option>
					...
					<dl class="row"  id="row_is_share_store" style="display:none">
						<dt class="tit"><label>是否开放兼职导购</label></dt>
						<dd class="opt">
							<div class="area-region-select">
								<input type="radio" name="is_share_store" id="store_share1" value="1" > <label>是</label>
								<input type="radio" name="is_share_store" id="store_share0" value="0" checked> <label>否</label>
							</div>
						</dd>
					</dl>
					...
					<dl class="row" id="num" style="display: none;">
						...
						<dd class="opt">
							<input id="store_share_num" name="partime_jobs_limit" type="text" class="input-txt" value="0" >
							<span class="err"></span>
							<p class="notic"></p>
						</dd>
					</dl>
					...
					<dl class="row" id="row_ous_cate" style="display:none">
						<dt class="tit">
                    <label for="class_sort">门店形式</label>
                </dt>
						<dd class="opt">
							<div class="area-region-select">
								<input type="radio" id="store_cate_1" name="store_cate" value="1" ><label for="store_cate_1">线上</label>
								<input type="radio" id="store_cate_2" name="store_cate" value="2" ><label for="store_cate_2">线下</label>
								<input type="radio" id="store_cate_3" name="store_cate" value="3" checked><label for="store_cate_3">线上线下</label>
								<span class="err"></span></div>
				...
				<dl class="row" id="row_ous_tag" style="display:none">
						<dt class="tit">
                    <label for="class_ous_tag">店铺类型</label>
                </dt>
						<dd class="opt">
							<div class="area-region-select">
								<input type="radio" id="ous_tag_1" name="ous_tag" value="1" ><label for="ous_tag_1">加盟店</label>
								<input type="radio" id="ous_tag_2" name="ous_tag" value="2" ><label for="ous_tag_2">旗舰店</label>
								<input type="radio" id="ous_tag_3" name="ous_tag" value="3" ><label for="ous_tag_3">直营店</label>
								<input type="radio" id="ous_tag_4" name="ous_tag" value="4" ><label for="ous_tag_4">商场超市</label>
								<span class="err"></span></div>
					...
					<dl class="row">
						<dt class="tit">
							...
							<a class="nyroModal" rel="gal" >
								<i class="fa fa-picture-o" id="img-data" data-geo="<img src=&quot;http://[::1]/yunjuke/./data/store/ous_logo_52.jpg&quot; width=100px height=50px>"></i>
							</a>
							</span>
                    ...
                    <label for="">门店店招</label>
						...
						<dd class="opt">
							<div class="input-file-show"><span class="show">
                        <a class="nyroModal" rel="gal" >
                            <i class="fa fa-picture-o" id="img-data2" data-geo="<img src=&quot;http://[::1]/yunjuke/./data/store/ous_shop_signs_52.jpg&quot; width=100px height=50px>"></i>
                        </a>
                    </span>
								<span class="type-file-box">
                    ...
                    <label for="class_sort">营业时间	</label>
						...
						<dd class="opt">
							<input id="class_sort" name="class_time" type="text" placeholder="08:00-24:00" class="input-txt" value="">
							<span class="err"></span>
                    ...
                    <label for="class_sort">简单介绍</label>
						...
						<dd class="opt">
							<textarea id="class_detail" name="class_detail" type="text" style="width: 500px;height: 100px;padding: 5px;"></textarea>
							<span class="err"></span>
						...
						<dd class="opt">
							...
							<script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=VjyztFQmLt7QVmbB7i760SHTar7DB6hD"></script>
                             ...
                             <script type="text/javascript">
								...
								var point = new BMap.Point('105.38824500','30.908079');
							...
							<input type="hidden" id="lngX" name="longitude" value="105.38824500">
							<input type="hidden" id="latY" name="latitude" value="30.908079">
						</dd>
					</dl>
					<div class="bot">
