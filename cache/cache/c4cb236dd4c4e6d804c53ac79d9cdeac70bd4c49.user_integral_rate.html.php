...
if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  ...
  'version' => '3.1.29',
  'unifunc' => 'content_598022c62c6355_91728690',
  'file_dependency' => 
  array (
...
function content_598022c62c6355_91728690 ($_smarty_tpl) {
?>
<!doctype html>
<html>
<head>
  ...
  <form method="post" name="settingForm" id="settingForm">
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <input id="points_orderrate" name="integral_rate" value="10000" class="input-txt" type="text">
    ...
    $("#submitBtn").click(function(){
        if($("#settingForm").valid()){
            ...
            $.ajax({
                ...
                type:'post',
                dataType:'json',
                url:"http://[::1]/yunjuke/admin.php/User/user_integral_rate_set",
