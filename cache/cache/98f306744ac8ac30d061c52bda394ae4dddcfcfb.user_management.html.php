<?php
/* Smarty version 3.1.29, created on 2017-08-01 14:41:46
  from "D:\www\yunjuke\application\admin\views\user_management.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_598022aa5580d7_21290461',
  'file_dependency' => 
  array (
    '98f306744ac8ac30d061c52bda394ae4dddcfcfb' => 
    array (
      0 => 'D:\\www\\yunjuke\\application\\admin\\views\\user_management.html',
      1 => 1496219103,
      2 => 'file',
    ),
...
function content_598022aa5580d7_21290461 ($_smarty_tpl) {
?>
<!doctype html>
<html>
<head>
...
<div class="page">
  ...
  <form id="formSearch" method="post" action="store_guide_add" enctype="multipart/form-data">
						...
						<dd class="opt opt1">
							<div class="area-region-select">
								...
								<span class="check_box  check_boxtime">
								 ...
								 <span class="check time" data-start="2017-08-01 00:00:00" data-end="2017-08-01 23:59:59">今日</span>
								 <span class="check time" data-start="2017-07-31 00:00:00" data-end="2017-07-31 23:59:59">昨日</span>
								 <span class="check time" data-start="2017-07-25 00:00:00" data-end="2017-08-01 23:59:59">最近7天</span>
								 <span class="check time" data-start="2017-07-01 00:00:00" data-end="2017-08-01 23:59:59">最近30天</span>
						        </span>
						      </div>   
						</dd>
                    </dl>
...
<!-- 					<dl class="row row1">
                    ...
                    <label for="class_sort">所属门店：</label>
						...
						<dd class="opt">
							<div class="area-region-select">
								<select class="valid" name="understore" id="area_region_select_store">
								    <option value="" >-请选择-</option>
								    								      								       <option value="47"  class="understore">-BE18 鹭州里 童装集合店-</option>
								      								       <option value="61"  class="understore">-BE18品牌童装-</option>
								      								       <option value="65"  class="understore">-ABC成都仓-</option>
								      								       <option value="66"  class="understore">-雅鹿 淘宝C店-</option>
								      								       <option value="67"  class="understore">-雅鹿成都仓-</option>
								      								       <option value="68"  class="understore">-BE18供货仓-</option>
								      								       <option value="70"  class="understore">-云聚客拍摄室-</option>
								      								       <option value="73"  class="understore">-久思微测试仓-</option>
								      								       <option value="74"  class="understore">-ABC旗舰店-</option>
								      								    								</select>
								<span class="err"></span></div>
							<span class="err"></span>
    ...
    $("#flexigrid").flexigrid({
      ...
      colModel : [
       ...
       /*  {display: '公众号', name : 'member_time', width : 100, sortable : true, align: 'center'}, */
        {display: '剩余积分', name : 'member_login_time', width : 100, sortable : true, align: 'center'},
