...
if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  ...
  'version' => '3.1.29',
  'unifunc' => 'content_59ddb312a0fa47_58553680',
  'file_dependency' => 
  array (
...
function content_59ddb312a0fa47_58553680 ($_smarty_tpl) {
?>
<!doctype html>
<html>
<head>
...
<div class="page">
	...
	<div class="mb-special-layout">
		<div class="mb-item-box" style="padding-left: 25px;padding-top: 50px;">
			<img src="http://[::1]/yunjuke/application/admin/views/images/gameLottery.jpg"  width="300px"  height="540px"/>
		</div>
			...
			<form id="add_form" method="post" action="store_add" enctype="multipart/form-data">
					...
					<dd class="opt">
						...
						<select class="valid select2" id="store_id" name="store_id">
							<option value="">请选择</option>
														<option value="47" >BE18 鹭州里 童装集合店</option>
														<option value="74" >ABC旗舰店</option>
														<option value="81" >探路者旗舰店铺</option>
													</select>
						<!-- </div> -->
						<span class="err"></span>
                ...
                <dl class="row" >
                    ...
                    <dd class="opt">
                        ...
                        <img src="http://[::1]/yunjuke//data/images/default_goods_image.jpg" width="50" height="50" data-geo="<img src=http://[::1]/yunjuke//data/images/default_goods_image.jpg width=300px>" class="f-l" alt="">
				...
				<div class="bot">
					<input name="wheels_id" id="wheels_id" type="hidden" value="">
...
<p>Severity: Notice</p>
<p>Message:  Undefined index: start_time</p>
<p>Filename: templates_c/2434624f729106c16fc59df26d3980fbe6ed79ff_0.file.promotion_wheel_edit.html.cache.php</p>
<p>Line Number: 700</p>
	...
	<p>Backtrace:</p>
			...
			File: D:\www\yunjuke\cache\templates_c\2434624f729106c16fc59df26d3980fbe6ed79ff_0.file.promotion_wheel_edit.html.cache.php<br />
			Line: 700<br />
			...
			<p style="margin-left:10px">
			File: D:\www\yunjuke\application\admin\controllers\Promotion.php<br />
			Line: 988<br />
			Function: display			</p>
...
<p>Severity: Notice</p>
<p>Message:  Undefined index: end_time</p>
<p>Filename: templates_c/2434624f729106c16fc59df26d3980fbe6ed79ff_0.file.promotion_wheel_edit.html.cache.php</p>
<p>Line Number: 702</p>
	...
	<p>Backtrace:</p>
	      ...
	      $("#per_integration").val("");
	      $("#statistics_code").val("");
	        $("#groupbuy_goods_image").attr("src", "");
	        $('#store_id option[value=""]').attr("selected", true);
	         $("#groupbuy_goods_price").html("");
