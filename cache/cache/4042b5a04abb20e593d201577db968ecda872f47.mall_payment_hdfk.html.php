...
if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  ...
  'version' => '3.1.29',
  'unifunc' => 'content_5981a6e4c44b81_84683457',
  'file_dependency' => 
  array (
...
function content_5981a6e4c44b81_84683457 ($_smarty_tpl) {
?>
<!doctype html>
<html>
<head>
    ...
    <form id="post_form" action="mall_payment_submit" method="post" name="form1">
        ...
        <div class="ncap-form-default">
            <dl class="row">
                ...
                <dd class="opt">
                    <div class="onoff">
                        <label for="payment_state1" class="cb-enable ">是</label>
                        <label for="payment_state2" class="cb-disable selected">否</label>
                        <input type="radio"  value="1" name="payment_state" id="payment_state1">
                        <input type="radio" checked value="0" name="payment_state" id="payment_state2">
                    </div>
                    <p class="notic"></p>
                </dd>
            </dl>
