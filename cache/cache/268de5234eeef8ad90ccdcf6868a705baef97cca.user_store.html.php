...
if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  ...
  'version' => '3.1.29',
  'unifunc' => 'content_59db116206e330_88896225',
  'file_dependency' => 
  array (
...
function content_59db116206e330_88896225 ($_smarty_tpl) {
?>
...
<link href="http://[::1]/yunjuke/application/vmall/views/css/example.css" rel="stylesheet" type="text/css">
	...
	$.ajax({
		type: "post",
	       ...
	       success: function(data){
		       	if(data.state1){
		       		var list = data.data1;
		       		    store_head_portrait = "http://[::1]/yunjuke/data/images/"+"default_store_avatar.jpg";
	        			str ='';
