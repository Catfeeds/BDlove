<?php
/* Smarty version 3.1.29, created on 2017-10-17 11:16:53
  from "D:\www\yunjuke\application\index\views\index.php" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_59e5762546ab24_93983260',
  'file_dependency' => 
  array (
    '0a85b98041d012ddcc97f8f180cc39cc5585e794' => 
    array (
      0 => 'D:\\www\\yunjuke\\application\\index\\views\\index.php',
      1 => 1504168084,
      2 => 'file',
    ),
  ),
...
function content_59e5762546ab24_93983260 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
	<head>
		...
		<script src="http://[::1]/yunjuke/application/index/views//js/L_slide.js"></script>
		<style>
			.contain{
				width: 1200px;
				margin: 0 auto;
	...
	<body>
		<div class="contain h_100" style="position: relative;">
			...
			<div class="login">
				<a href="http://[::1]/yunjuke/admin.php/index/index" class="admin">后台登录</a><a href="http://[::1]/yunjuke/pay.php/index/index" class="pay" style="padding-right: 0;">商家登录</a>
			</div>
		...
		<div class="head">
			...
			<div class="contain">
				<ul class="list-inline">
					...
					<li><a href="http://[::1]/yunjuke/index.php/index/allChannel.html">全渠道运营</a></li>
					<li><a href="http://[::1]/yunjuke/index.php/index/memberService.html">会员服务</a></li>
					<li><a href="http://[::1]/yunjuke/index.php/index/programm.html">软件开发</a></li>
					<li><a href="http://[::1]/yunjuke/index.php/index/addUs.html">加入我们</a></li>
				</ul>
			</div>
		</div>
		<!-- 把要轮播的地方写上来 -->
				...
				<li class="figure1">
		        	<div class="contain" style="position:relative">
			        	<div class="brief">
			        		...
			        		<a href="http://[::1]/yunjuke/index.php/index/allChannel.html" class="btn-look">查看详情</a>
			        	</div>
			        	...
			        	<div class="figure1-bag">
                        	...
                        	<div class="people"><img src="http://[::1]/yunjuke/application/index/views//imges/figure1_3.png"/></div>
                        </div>
			        </div>
		        ...
		        <li class="figure2">
		        	<div class="contain" style="position:relative">
			        	<div class="brief">
			        		<p class="brief-title">
			        			会员服务
			        			<span class="brief-small">Membership service</span>
			        		</p>
			        		<p class="brief-content">
			        			精准营销，数据管理，会员培养<br>
			        			管理好会员，复购成为一种常态，与会员高频互动流量难题轻松击破。<br><br>
			        		</p>
			        		<a href="http://[::1]/yunjuke/index.php/index/memberService.html" class="btn-look">查看详情</a>
			        	</div>
			        	<div style="clear:both"></div>
			        	<div class="figure2-bag">
                        	<div class="service"><img src="http://[::1]/yunjuke/application/index/views//imges/figure2_2.png" alt="" /></div>
                        </div>
			        </div>
		        ...
		        <li class="figure3">
		        	<div class="contain" style="position:relative">
			        	<div class="brief">
			        		<p class="brief-title">
			        			软件开发
			        			<span class="brief-small">Software development</span>
			        		</p>
			        		<p class="brief-content">
			        		...
			        		<a href="http://[::1]/yunjuke/index.php/index/programm.html" class="btn-look">查看详情</a>
			        	</div>
			        	<div style="clear:both"></div>
		...
		<div class="contain" style="margin-top: 70px;position: relative;">
			...
			<div class="action">
				<div class="action-banner">
					<div class="new-img"><img src="http://[::1]/yunjuke/application/index/views//imges/news.png" alt="" /></div>
					<p class="action-title">【行业动态】企业应用变革 基础产品交流会</p>
					<a href="javascript:;" class="more">查看更多<span style="padding: 0">></span>></a>
				</div>
			...
			<div class="action">
				<div class="action-banner">
					<div class="new-img"><img src="http://[::1]/yunjuke/application/index/views//imges/custom.png" alt=""/></div>
			...
			<div class="action" style="margin-right: 0;">
				<div class="action-banner">
					<div class="new-img"><img src="http://[::1]/yunjuke/application/index/views//imges/skill.png" alt=""/></div>
