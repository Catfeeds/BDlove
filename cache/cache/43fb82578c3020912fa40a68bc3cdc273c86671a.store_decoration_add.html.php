...
if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  ...
  'version' => '3.1.29',
  'unifunc' => 'content_59841f4fc51cc5_77363985',
  'file_dependency' => 
  array (
...
function content_59841f4fc51cc5_77363985 ($_smarty_tpl) {
?>
<!DOCTYPE HTML>
<html>
<head>
  ...
  .openblock{
	...
	<body style="background-color: #FFF; overflow: auto;">
	   ...
	   <input  id ="TEMPLEimg" type="hidden" value="http://[::1]/yunjuke/application/pay/views/" >
	    <input  id ="defaultMid" type="hidden" value="" >
	...
	<div class="col-md-12">
		<div class="panel panel-default" id="decWrap">
			<div class="panel-heading">
				<h5><span id="currStoreName" style="visibility: visible;">当前门店：ABC旗舰店</span> <a href="https://qiakr.kf5.com/posts/view/81524" target="_blank" class="r f14"><span class="text-primary"><i class="Hui-iconfont f18 rel" style="top:1px;">&#xe633;</i> 微商城装修帮助教程</span></a></h5>
			</div>
   ...
   <div class="wx_mod" modid="1000" id="m1000" >
    ...
    <div class="wx_mod" modid="1011" id="m1011">
        ...
        <div class="bd" style="display: block;">
            <a href="javascript:;" class="db"><img src="http://[::1]/yunjuke/application/pay/views/images/home_banner.jpg" class="wx-top-banner"></a>
        </div>
    </div>
    ...
    <div class="wx_mod" modid="1012" id="m1012" >
        ...
        <div class="bd" style="display: block;">
           <div class="wx-shop-info">
            <div class="info-l">
                <img class="shop-logo" src="http://[::1]/yunjuke/application/pay/views/images/iconfont-stroe.png">
                <h2>射洪  品牌店 </h2>
                <p>导购 某某某 正在为您服务</p>
            </div>
            <div class="info-r">
...
<!-- 	    <div class="ui_dialog_wrapper activitynavigation trans" id="me1006">
        ...
        <div id="shopPreView" class="l ml20" style="padding-left: 61.5px;">
            ...
            <div class="qrcode" id="qrcodeImg">
                <div class="tc fix">
                    <div id="QrCodeImg"><canvas width="120" height="120" style="display: none;"></canvas><img alt="Scan me!" src="http://[::1]/yunjuke/./data/two_code/qrcode_74.png" style="display: block;"></div>
                </div>
            </div>
        </div>
    </div>
