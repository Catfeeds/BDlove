<?php
/* Smarty version 3.1.29, created on 2017-06-01 17:03:38
  from "D:\www\yunjuke\application\admin\views\goods_add_goods_second.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_592fd86a09bef2_00695067',
  'file_dependency' => 
  array (
    '4bcb88d49eac16fac0341c8ac53bbda14cde3a09' => 
    array (
      0 => 'D:\\www\\yunjuke\\application\\admin\\views\\goods_add_goods_second.html',
      1 => 1496219103,
      2 => 'file',
    ),
...
function content_592fd86a09bef2_00695067 ($_smarty_tpl) {
?>
<!doctype html>
<html>
<head>
...
<body style="background-color: #FFF; overflow: auto;">
    <div class="page wrapper_search">
        ...
        <form action="goods_add_goods_third" id="form_2" method="post">
            ...
            <input name="base_info[goods_pos]" value='0' type="hidden">
            <div class="ncsc-form-goods">
                ...
                <dl>
                    <dt>商品卖点：</dt>
                    <dd>
                        <textarea name="base_info[goods_jingle]" class="textarea h60 w400"></textarea>
                        <span></span>
                    ...
                    <dd nctype="" class="pos-r">
                        <div class="choose_color_box">
                            <div class="choose_color_box_list mb-10" id="creat_tr_0">
                                ...
                                <input type="text" name="color[0][color_remark]" class="picker-remark" placeholder="备注（如偏深偏浅等）" value="" maxlength="30">
                    ...
                    <dd>
                        <div class="ncsc-goods-default-pic">
                            <div class="goodspic-uplaod">
                                <div class="upload-thumb"> <img nctype="goods_image" src="http://[::1]/yunjuke/application/admin/views/img/default_goods_image_60.gif"> </div>
                                    ...
                                    <span class="r">
                                        <select name="jumpMenu_default"  style="width:100px;" data-function="insert_img" onchange="get_pic(this, 1)">
                                            <option value="" style="width:80px;">请选择...</option>
                                                                                        ...
                                                                                        <option value="33" style="width:80px;">3453</option>
                                                                                                                                </select>
                                    </span>
                                </div>
...
//                    console.log(e);
                    ...
                    if (type == 'default_img') {
                        if (param.state == false) {
                            ...
                            $('input[nctype="' + nctype_image + '"]').val(param.pic_info.apic_cover);
                            $('img[nctype="' + nctype_image + '"]').attr('src', param.pic_info.pic_url);
                        }
            ...
            if($('tbody[nc_type="spec_table"] tr').length<=0){ //还没有一行数据时
                ...
                $.each(color_arr,function(){
                    ...
                    $.each(size_arr,function(){
                        ...
                        l +='<td><input class="text price sell_price" type="text" name="size[' + s + ']['+i+'][stocks_price]" data_type="price" nc_type="price" value="" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>' +
                            '<td><input class="text price goods_marketprice" type="text" name="size[' + s + ']['+i+'][stocks_marketprice]" data_type="marketprice" nc_type="|marketprice" value="" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>' +
            ...
            $(".choose_color_list li.choose_color_list_info").click(function () {
                ...
                if($(obj).parents('.choose_color_box_list').next('.choose_color_box_list').length<=0){  //增加一行颜色选择行（最后一行）
                    var color_div = '<div class="choose_color_box_list mb-10" id="creat_tr_' + d + '"> ' +
                        ...
                        '<input type="text" name="color['+d+'][color_remark]" class="picker-remark" placeholder="备注（如偏深偏浅等）" value="" maxlength="30"> ' +
    ...
    <script>
       ...
       function batch_set(){  //批量设置信息
        ...
        function become_color_select(){  //组装颜色选项卡
            //组装颜色选项卡开始
            var color_arr = {"1":{"cl_id":"1","cl_parent_id":"0","cl_name":"\u767d\u8272\u7cfb","cl_sort":"127","cl_value":"#ffffff","son_color":{"2":{"cl_id":"2","cl_parent_id":"1","cl_name":"\u4e73\u767d\u8272","cl_sort":null,"cl_value":"#fffbf0","son_color":[]},"3":{"cl_id":"3","cl_parent_id":"1","cl_name":"\u7c73\u767d\u8272","cl_sort":null,"cl_value":"#eedeb0","son_color":[]}}},"12":{"cl_id":"12","cl_parent_id":"0","cl_name":"\u82b1\u8272\u7cfb","cl_sort":null,"cl_value":"huasebg.png","son_color":{"58":{"cl_id":"58","cl_parent_id":"12","cl_name":"\u82b1\u8272","cl_sort":null,"cl_value":"huasebg.png","son_color":[]}}},"11":{"cl_id":"11","cl_parent_id":"0","cl_name":"\u68d5\u8272\u7cfb","cl_sort":null,"cl_value":"#7c4b00","son_color":{"50":{"cl_id":"50","cl_parent_id":"11","cl_name":"\u5496\u5561\u8272","cl_sort":null,"cl_value":"#603912","son_color":[]},"51":{"cl_id":"51","cl_parent_id":"11","cl_name":"\u5de7\u514b\u529b\u8272","cl_sort":null,"cl_value":"#d2691e","son_color":[]},"52":{"cl_id":"52","cl_parent_id":"11","cl_name":"\u6817\u8272","cl_sort":null,"cl_value":"#60281e","son_color":[]},"53":{"cl_id":"53","cl_parent_id":"11","cl_name":"\u6d45\u68d5\u8272","cl_sort":null,"cl_value":"#b35c44","son_color":[]},"54":{"cl_id":"54","cl_parent_id":"11","cl_name":"\u6df1\u5361\u5176\u5e03\u8272","cl_sort":null,"cl_value":"#bdb76b","son_color":[]},"55":{"cl_id":"55","cl_parent_id":"11","cl_name":"\u6df1\u68d5\u8272","cl_sort":null,"cl_value":"#7c4b00","son_color":[]},"56":{"cl_id":"56","cl_parent_id":"11","cl_name":"\u8910\u8272","cl_sort":null,"cl_value":"#855b00","son_color":[]},"57":{"cl_id":"57","cl_parent_id":"11","cl_name":"\u9a7c\u8272","cl_sort":null,"cl_value":"#a88462","son_color":[]}}},"10":{"cl_id":"10","cl_parent_id":"0","cl_name":"\u7d2b\u8272\u7cfb","cl_sort":null,"cl_value":"#800080","son_color":{"46":{"cl_id":"46","cl_parent_id":"10","cl_name":"\u6d45\u7d2b\u8272","cl_sort":null,"cl_value":"#ede0e6","son_color":[]},"47":{"cl_id":"47","cl_parent_id":"10","cl_name":"\u6df1\u7d2b\u8272","cl_sort":null,"cl_value":"#430653","son_color":[]},"48":{"cl_id":"48","cl_parent_id":"10","cl_name":"\u7d2b\u7ea2\u8272","cl_sort":null,"cl_value":"#8b0062","son_color":[]},"49":{"cl_id":"49","cl_parent_id":"10","cl_name":"\u7d2b\u7f57\u5170","cl_sort":null,"cl_value":"#b7ace4","son_color":[]}}},"9":{"cl_id":"9","cl_parent_id":"0","cl_name":"\u84dd\u8272\u7cfb","cl_sort":null,"cl_value":"#0000fe","son_color":{"39":{"cl_id":"39","cl_parent_id":"9","cl_name":"\u85cf\u9752\u8272","cl_sort":null,"cl_value":"#2e4e7e","son_color":[]},"40":{"cl_id":"40","cl_parent_id":"9","cl_name":"\u6e56\u84dd\u8272","cl_sort":null,"cl_value":"#30dff3","son_color":[]},"41":{"cl_id":"41","cl_parent_id":"9","cl_name":"\u6df1\u84dd\u8272","cl_sort":null,"cl_value":"#041690","son_color":[]},"42":{"cl_id":"42","cl_parent_id":"9","cl_name":"\u6d45\u84dd\u8272","cl_sort":null,"cl_value":"#d2f0f4","son_color":[]},"43":{"cl_id":"43","cl_parent_id":"9","cl_name":"\u5b9d\u84dd\u8272","cl_sort":null,"cl_value":"#4b5cc4","son_color":[]},"44":{"cl_id":"44","cl_parent_id":"9","cl_name":"\u5b54\u96c0\u84dd","cl_sort":null,"cl_value":"#00a4c5","son_color":[]},"45":{"cl_id":"45","cl_parent_id":"9","cl_name":"\u5929\u84dd\u8272","cl_sort":null,"cl_value":"#44cef6","son_color":[]}}},"8":{"cl_id":"8","cl_parent_id":"0","cl_name":"\u7eff\u8272\u7cfb","cl_sort":null,"cl_value":"#008000","son_color":{"33":{"cl_id":"33","cl_parent_id":"8","cl_name":"\u519b\u7eff\u8272","cl_sort":null,"cl_value":"#5d762a","son_color":[]},"34":{"cl_id":"34","cl_parent_id":"8","cl_name":"\u58a8\u7eff\u8272","cl_sort":null,"cl_value":"#057748","son_color":[]},"35":{"cl_id":"35","cl_parent_id":"8","cl_name":"\u6d45\u7eff\u8272","cl_sort":null,"cl_value":"#98fb98","son_color":[]},"36":{"cl_id":"36","cl_parent_id":"8","cl_name":"\u7fe0\u7eff\u8272","cl_sort":null,"cl_value":"#0aa344","son_color":[]},"37":{"cl_id":"37","cl_parent_id":"8","cl_name":"\u8367\u5149\u7eff","cl_sort":null,"cl_value":"#23fa07","son_color":[]},"38":{"cl_id":"38","cl_parent_id":"8","cl_name":"\u9752\u8272","cl_sort":null,"cl_value":"#00e09e","son_color":[]}}},"7":{"cl_id":"7","cl_parent_id":"0","cl_name":"\u9ec4\u8272\u7cfb","cl_sort":null,"cl_value":"#ffff00","son_color":{"23":{"cl_id":"23","cl_parent_id":"7","cl_name":"\u5361\u5176\u8272","cl_sort":null,"cl_value":"#c3b091","son_color":[]},"31":{"cl_id":"31","cl_parent_id":"7","cl_name":"\u91d1\u8272","cl_sort":null,"cl_value":"#ffd700","son_color":[]},"30":{"cl_id":"30","cl_parent_id":"7","cl_name":"\u8367\u5149\u9ec4","cl_sort":null,"cl_value":"#eaff56","son_color":[]},"29":{"cl_id":"29","cl_parent_id":"7","cl_name":"\u6d45\u9ec4\u8272","cl_sort":null,"cl_value":"#faff72","son_color":[]},"28":{"cl_id":"28","cl_parent_id":"7","cl_name":"\u6854\u8272","cl_sort":null,"cl_value":"#ffa500","son_color":[]},"27":{"cl_id":"27","cl_parent_id":"7","cl_name":"\u67e0\u6aac\u9ec4","cl_sort":null,"cl_value":"#ffec43","son_color":[]},"26":{"cl_id":"26","cl_parent_id":"7","cl_name":"\u674f\u8272","cl_sort":null,"cl_value":"#f7eed6","son_color":[]},"25":{"cl_id":"25","cl_parent_id":"7","cl_name":"\u660e\u9ec4\u8272","cl_sort":null,"cl_value":"#ffff01","son_color":[]},"24":{"cl_id":"24","cl_parent_id":"7","cl_name":"\u59dc\u9ec4\u8272","cl_sort":null,"cl_value":"#ffc773","son_color":[]},"32":{"cl_id":"32","cl_parent_id":"7","cl_name":"\u9999\u69df\u8272","cl_sort":null,"cl_value":"toumingbg.png","son_color":[]}}},"6":{"cl_id":"6","cl_parent_id":"0","cl_name":"\u7ea2\u8272\u7cfb","cl_sort":null,"cl_value":"#ff0000","son_color":{"17":{"cl_id":"17","cl_parent_id":"6","cl_name":"\u9152\u7ea2\u8272","cl_sort":null,"cl_value":"#990000","son_color":[]},"18":{"cl_id":"18","cl_parent_id":"6","cl_name":"\u897f\u74dc\u7ea2","cl_sort":null,"cl_value":"#f05654","son_color":[]},"19":{"cl_id":"19","cl_parent_id":"6","cl_name":"\u85d5\u8272","cl_sort":null,"cl_value":"#eed0d8","son_color":[]},"20":{"cl_id":"20","cl_parent_id":"6","cl_name":"\u7c89\u7ea2\u8272","cl_sort":null,"cl_value":"#ffb6c1","son_color":[]},"21":{"cl_id":"21","cl_parent_id":"6","cl_name":"\u73ab\u7ea2\u8272","cl_sort":null,"cl_value":"#df1b76","son_color":[]},"22":{"cl_id":"22","cl_parent_id":"6","cl_name":"\u6854\u7ea2\u8272","cl_sort":null,"cl_value":"#ff7500","son_color":[]}}},"5":{"cl_id":"5","cl_parent_id":"0","cl_name":"\u9ed1\u8272\u7cfb","cl_sort":null,"cl_value":"#000000","son_color":{"60":{"cl_id":"60","cl_parent_id":"5","cl_name":"\u9ed1\u8272","cl_sort":null,"cl_value":"#000000","son_color":[]}}},"4":{"cl_id":"4","cl_parent_id":"0","cl_name":"\u7070\u8272\u7cfb","cl_sort":null,"cl_value":"#808080","son_color":{"14":{"cl_id":"14","cl_parent_id":"4","cl_name":"\u94f6\u8272","cl_sort":null,"cl_value":"#c0c0c0","son_color":[]},"15":{"cl_id":"15","cl_parent_id":"4","cl_name":"\u6df1\u7070\u8272","cl_sort":null,"cl_value":"#666666","son_color":[]},"16":{"cl_id":"16","cl_parent_id":"4","cl_name":"\u6d45\u7070\u8272","cl_sort":null,"cl_value":"#e4e4e4","son_color":[]}}},"13":{"cl_id":"13","cl_parent_id":"0","cl_name":"\u900f\u660e\u7cfb","cl_sort":null,"cl_value":"toumingbg.png","son_color":{"59":{"cl_id":"59","cl_parent_id":"13","cl_name":"\u900f\u660e","cl_sort":null,"cl_value":"toumingbg.png","son_color":[]}}}};
            ...
            if ($(obj).attr("checked")){
                if($(obj).parent("div.choose_color_box_list").next('div.choose_color_box_list').length<=0){
                    var color_div = '<div class="choose_color_box_list mb-10" id="creat_tr_' + d + '"> ' +
                        ...
                        '<input type="text" name="color_remark[]" class="picker-remark" placeholder="备注（如偏深偏浅等）" value="" maxlength="30"> ' +
                        '<div class="pos-a choose_color_box_hide hide mt-10 c-333"></div></div>';
                    $(".choose_color_box").append(color_div);
                    d++;
                }
