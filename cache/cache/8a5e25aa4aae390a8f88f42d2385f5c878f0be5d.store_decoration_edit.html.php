<?php
/* Smarty version 3.1.29, created on 2017-07-27 16:24:05
  from "D:\www\yunjuke\application\pay\views\store_decoration_edit.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5979a325ab5de2_61969160',
  'file_dependency' => 
  array (
    '8a5e25aa4aae390a8f88f42d2385f5c878f0be5d' => 
    array (
      0 => 'D:\\www\\yunjuke\\application\\pay\\views\\store_decoration_edit.html',
      1 => 1501143816,
      2 => 'file',
    ),
...
function content_5979a325ab5de2_61969160 ($_smarty_tpl) {
?>
<!DOCTYPE HTML>
<html>
<head>
...
<link rel="stylesheet" href="http://[::1]/yunjuke/application/pay/views/css/module-page.css" />
<link rel="stylesheet" href="http://[::1]/yunjuke/application/pay/views/css/common.new.min.css" />
	<style type="text/css">
		@font-face {
...
.ui_mask_wrapper{
  ...
  .openblock{
	...
	<body style="background-color: #FFF; overflow: auto;">
		<nav class="breadcrumb-x">
		    <i class="Hui-iconfont">&#xe67f;</i> 店铺管理 <span class="c-gray en p-lr">&gt;</span><a href="store_decoration_template" style="display: inline-block;color: #333;">装修模板列表</a><span class="c-gray en p-lr">&gt;</span>编辑模板
		    &nbsp;<a href="javascript:;" id="goback"><i class="iconfont" style="font-size: 13px;">&#xe670;</i>返回</a>
		    <a class="btn btn-success radius r" style="line-height:1.6em;margin-top: 3px;" href="javascript:location.replace(location.href);" title="刷新" >
		        <i class="Hui-iconfont">&#xe68f;</i></a>
		</nav>
	   <input  id ="TEMPLEimg" type="hidden" value="http://[::1]/yunjuke/application/pay/views/" >
	   <input  id ="defaultMid" type="hidden" value="10" >
	...
	<div class="col-md-12">
		<div class="panel panel-default" id="decWrap">
			<div class="panel-heading">
				<h5><span id="currStoreName" style="visibility: visible;">当前门店：</span> <a href="https://qiakr.kf5.com/posts/view/81524" target="_blank" class="r f14"><span class="text-primary"><i class="Hui-iconfont f18 rel" style="top:1px;">&#xe633;</i> 微商城装修帮助教程</span></a></h5>
			</div>
			<div class="panel-body">
				<div class="ovh mb20">
					<div class="form-inline dib l mr10">
						<label>模板名称：</label>
						<input type="text" class="form-control w180" id="tplName" placeholder="请输入模板名称" style="height: 30px;" value="fdsd">
					</div>
<!-- 					<div class="form-inline dib l dn" id="tplTypeChkBox">
					...
					<div class="text-left dib r">
						<span class="btn btn-default btn-md ml10 r" id="btnSaveConf" style="height: auto;"><i class="Hui-iconfont">&#xe632;</i> 保存装修</span>
					</div>
				</div>
            ...
            <div class="phone_simulator">
                <div class="phone_container" id="phoneContainer">
                    ...
                    <div class="wx_mod ui-sortable-handle" modid="1000" id="m1000">
        	               ...
        	               <span class="icon-yun shop-qrcode" style="display: block;"></span>
        	               ...
        	               </div><div class="wx_mod sortable-item sortable-item m1001-d844" modtitle="图片轮播" modid="1001" id="m1001">
                                ...
                                <div class="bd">
                                    ...
                                    <a href="http://www.jukeyunduan.com/vmall.php/index" class="swiper-slide">
                                      <div class="shop_slider_img" style="height:320px; background-image:url(http://[::1]/yunjuke/application/vmall/views/images/201707271621445979a29817e1b_storeDecoration.jpg)"></div>
                                    </a>
                                        </div>
    ...
    <div id="wx_mod_replace">请拖拽模块到此处</div>
                        ...
                        <div class="row_content" id="carouselUploaderBoxme1001-4f6e">
                            <div class="mb10">
                                <a class="btn btn-primary btn-sm file_picker webuploader-container" href="javascript:;">
	                                <div class="webuploader-pick"><i class="fa fa-plus"></i> 添加广告</div>
     ...
     <!--                <div class="ui_form_row ">
            ...
            <div class="ui_dialog_footer hide mt20 text-center">
                <a href="javascript:;" class="btn btn-primary" data-tag="save" data-id="me1001-4f6e">暂存</a>
            </div>
        </div>
	    </div>
        ...
        <div class="ui_dialog">
            ...
            <div class="ui_dialog_footer hide mt20 text-center">
                <a href="javascript:;" class="btn btn-primary" data-tag="save" data-id="me1002-8ded">暂存</a>
            </div>
        </div>
    </div>
        ...
        <div class="ui_dialog" id="me1003-3545">
            ...
            <div class="ui_dialog_footer hide mt20 text-center">
                <a href="javascript:;" class="btn btn-primary" data-tag="save" data-id="me1003-3545">暂存</a>
            </div>
        </div>
    </div>
        ...
        <div class="ui_dialog">
                                ...
                                <label class="w100 text-right">商品类别：</label>
                                    ...
                                    <div class="mt10  div_select" style="margin-left: 104px;">
                                        ...
                                        <select name="brandSlt" class="form-control input-sm hide w200" id="sltBrandme1004-70cc">
                                            <option value='378' >ABC KIDS</option><option value='377' >公主安娜</option><option value='380' >妮可贝贝</option><option value='385' >企鹅仔仔</option><option value='386' >雅鹿</option><option value='376' >植木西</option>                                        </select>
                                ...
                                <div class="actions">
                                    <div class="form-group form-inline mb0">
                                        ...
                                        <div class="input-group w180">
                                          ...
                                          <span class="input-group-addon btn btn-primary btn-sm radius ml-5" id="searchProsme1004-70cc" style="padding: 0 8px;height: 29px;">搜索</span>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="ui_dialog_footer hide mt20 text-center">
                <a href="javascript:;" class="btn btn-primary" data-tag="save" data-id="me1004-70cc">暂存</a>
            </div>
        </div>
    </div>
	    ...
	    <div class="ui_dialog_wrapper text trans" id="me1005">
	        <div class="ui_dialog">
	            ...
	            <div class="ui_dialog_footer hide mt20 text-center">
	                <a href="javascript:;" class="btn btn-primary" data-tag="save" data-id="me1005-f105">暂存</a>
	            </div>
	        </div>
	    </div>
...
<!-- 	    <div class="ui_dialog_wrapper activitynavigation trans" id="me1006">
	    ...
	    <div class="ui_dialog_wrapper brandnavigation trans " id="me1007">
	        <div class="ui_dialog">
	            ...
	            <div class="ui_dialog_footer hide mt20 text-center">
	                <a href="javascript:;" class="btn btn-primary" data-tag="save" data-id="me1007-09d5">暂存</a>
	            </div>
	        </div>
	    </div>
		        ...
		        <div class="ui_dialog">
		            ...
		            <div class="ui_dialog_container">
		                <div class="ui_form">
		                    ...
		                    <div class="ui_form_row" style="width: 570px;">
		                        <div class="row_title">图片设置</div>
		                        <div class="row_content" id="categoryNavUploaderme1009-1485">
		                            <div class="mb10">
		                                <a class="btn btn-info btn-sm file_picker webuploader-container" href="javascript:;">
			                                <div class="webuploader-pick"><i class="fa fa-plus"></i> 添加图片</div>
		            ...
		            <div class="ui_dialog_footer hide mt20 text-center">
		                <a href="javascript:;" class="btn btn-primary" data-tag="save" data-id="me1009-1485">暂存</a>
		            </div>
		        </div>
		    </div>
	    ...
	    <div class="ui_dialog_wrapper groupNav trans " id="me1010">
	        <div class="ui_dialog">
	            ...
	            <div class="ui_dialog_footer hide mt20 text-center">
	                <a href="javascript:;" class="btn btn-primary" data-tag="save" data-id="me1010-58c9">暂存</a>
	            </div>
	        </div>
	    </div>
	    ...
	    <div class="ui_dialog_wrapper custom_module trans " id="me1008">
	        <div class="ui_dialog">
	            ...
	            <div class="ui_dialog_container">
	                <div class="ui_form">
	                    <div class="ui_form_row">
	                        ...
	                        <div class="row_content">
                            	<textarea type="text/plain" class="ui_form_text" id="customEditorme1008" style="height:450px; width:95%;"></textarea>
                                    <!-- 实例化编辑器 -->
	            ...
	            <div class="ui_dialog_footer mt20 text-center">
	                <a href="javascript:;" class="btn btn-primary" id="btn-primaryme1008"data-tag="save" data-id="me1008-ddd5">暂存</a>
	            </div>
	        </div>
	    </div>
        ...
        <div id="shopPreView" class="l ml20" style="padding-left: 61.5px;">
            ...
            <div class="qrcode" id="qrcodeImg">
                <div class="tc fix">
                    <div id="QrCodeImg" ><canvas width="120" height="120" style="display: none;"></canvas><img alt="Scan me!" src="http://[::1]/yunjuke/./data/two_code/qrcode_52.png" style="display: block;"></div>
                </div>
            </div>
        </div>
    </div>
...
<!--S 操作区-->
	...
	<script type="text/javascript" src="http://[::1]/yunjuke/application/pay/views/js/juke-decoration.js"></script>
	<script type="text/javascript">
