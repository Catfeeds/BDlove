...
if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  ...
  'version' => '3.1.29',
  'unifunc' => 'content_5992bcb925b0b2_85803280',
  'file_dependency' => 
  array (
...
function content_5992bcb925b0b2_85803280 ($_smarty_tpl) {
?>
<!doctype html>
<html>
<head>
...
<div class="page">
<!-- <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i>管理与运维<span class="c-gray en">&gt;</span>仓库管理 <span class="c-gray en">&gt;</span><span id="nav-title">配送区域新增</span></nav>
 -->
 <div class="fixed-bar">
    ...
    <div class="ncap-form-default">
        <form method="post" id="tpl_form" name="tpl_form" action="">
           <input type="hidden" name="transport_id" id="transport_id" value="顺丰快递">           <input type="hidden" name="ept_id" id="ept_id" value="4">           <input type="hidden" name="store_id" id="store_id" value="">
           <!-- <input type="hidden" name="fee_data" id="fee_data" value="
...
<p>Filename: templates_c/0d9975a4486f4fa1dbc5ca8cf7b8cce419c824bb_0.file.mall_express_area_add.html.cache.php</p>
<p>Line Number: 56</p>
	...
	<p>Backtrace:</p>
			...
			File: D:\www\yunjuke\cache\templates_c\0d9975a4486f4fa1dbc5ca8cf7b8cce419c824bb_0.file.mall_express_area_add.html.cache.php<br />
			Line: 56<br />
			...
			<p style="margin-left:10px">
			File: D:\www\yunjuke\application\admin\controllers\Mall.php<br />
			Line: 1518<br />
			Function: display			</p>
	...
	<p>Backtrace:</p>
           ...
           <!--  <dl class="row">
            ...
            <dl class="row">
                        ...
                        <div class="entity ">
                            <div class="tbl-except vali_err">
                                <table cellspacing="0" class="ncsc-table-style table ">
                                    ...
                                    <input type="hidden" class="epa_id" name="epa_id[10]" value="10">
                ...
                <p style="display:inline-block">北京,天津,河北省,山西省,内蒙古区,上海,浙江省,江苏省,山东省,安徽省,福建省,江西省,重庆,四川省,贵州省,云南省,西藏区,广东省,海南省,广西区,河南省,湖北省,湖南省,辽宁省,吉林省,黑龙江省,陕西省,甘肃省</p> </span><input type="hidden" value="北京,天津,河北省,山西省,内蒙古区,上海,浙江省,江苏省,山东省,安徽省,福建省,江西省,重庆,四川省,贵州省,云南省,西藏区,广东省,海南省,广西区,河南省,湖北省,湖南省,辽宁省,吉林省,黑龙江省,陕西省,甘肃省" class="select_area_name" name="area_name[10]"> <input type="hidden" value="1000,1368,1002,1370,1007,1120,1121,1122,1123,1124,1125,1126,1127,1128,1129,1130,1008,1276,1277,1278,1279,1280,1281,1282,1283,1284,1285,1286,1030,1235,1236,1237,1238,1239,1240,1241,1242,1243,1244,1245,1246,1001,1369,1004,1353,1354,1355,1356,1357,1358,1359,1360,1361,1362,1363,1006,1197,1198,1199,1200,1201,1202,1203,1204,1205,1206,1207,1208,1209,4314,4315,1014,1259,1260,1261,1262,1263,1264,1265,1266,1267,1268,1269,1270,1271,1272,1273,1274,1275,1015,1034,1035,1036,1037,1038,1039,1040,1041,1042,1043,1045,1046,1047,1048,1049,1050,4313,1016,1051,1052,1053,1054,1055,1056,1057,1058,1059,1020,1210,1211,1212,1213,1214,1215,1216,1217,1218,1219,1220,4324,1003,1371,1009,1297,1298,1299,1300,1301,1302,1303,1304,1305,1306,1307,1308,1309,1310,1311,1312,1313,1314,1315,1316,1317,1021,1109,1110,1111,1112,1113,1114,1115,1116,1117,1022,1337,1338,1339,1340,1341,1342,1343,1344,1345,1346,1347,1348,1349,1350,1351,1352,4334,4336,4337,4339,1029,1318,1319,1320,1321,1322,1323,1324,1005,1074,1075,1076,1077,1078,1079,1080,1081,1082,1083,1084,1085,1086,1087,1088,1089,1090,1091,1092,1093,1094,1019,1118,1119,1375,1376,1377,1378,1379,1380,1381,1382,1383,1384,1385,1386,1387,1388,1389,1390,3306,4335,1025,1095,1096,1097,1098,1099,1100,1101,1102,1103,1104,1105,1106,1107,1108,1010,1131,1132,1133,1134,1135,1136,1137,1138,1139,1140,1141,1142,1143,1144,1145,1146,1147,1391,1017,1161,1162,1163,1164,1165,1166,1167,1168,1169,1170,1171,1172,1173,1392,1393,1394,1395,4310,1018,1174,1175,1176,1177,1178,1179,1180,1181,1182,1183,1184,1185,1186,1187,1011,1221,1222,1223,1224,1225,1226,1227,1228,1229,1230,1231,1232,1233,1234,1012,1188,1189,1190,1191,1192,1193,1194,1195,1196,1013,1148,1149,1150,1151,1152,1153,1154,1155,1156,1157,1158,1159,1160,1023,1288,1289,1290,1291,1292,1293,1294,1295,1296,4291,4340,1024,1060,1061,1062,1063,1064,1065,1066,1067,1068,1069,1070,1071,1072,1073,4012,4013" class="select_area_id" name="area[10]"> </td>
                <td> <input class="w50 text" type="number" maxlength="4" autocomplete="off" value="1"  name="first_w[10]" onblur="valid()" data-field="postage"> </td> 
                <td> <input class="w50 mr5 text" type="number" maxlength="6" autocomplete="off" value="10.00" name="first_f[10]" onblur="valid()" data-field="postage"> 
                <em class="add-on"><i class="fa fa-rmb"></i></em> </td> <td> <input class="w50 text" type="number" maxlength="4"  autocomplete="off" value="1"  name="last_w[10]" onblur="valid()" data-field="postage"> </td> 
                <td> <input class="w50 mr5 text" type="number" maxlength="6" autocomplete="off" value="5.00"  name="last_f[10]" onblur="valid()" data-field="postage"> <em class="add-on"> <i class="fa fa-rmb"></i> </em> </td> 
                <td> <input class="w50 text" type="number" maxlength="4" autocomplete="off" value="0.00"  name="no_fee[10]" onblur="valid()" data-null="no_fee" data-field="postage"> </td>
                <td class="nscs-table-handle"> 
                 <a class=" btn red btn-del btn-grapefruit J_DeleteRule_10" title="删除" onclick="del_area(this)" href="JavaScript:void(0);"> <i class="fa fa-trash"></i> </a> 
                  <a class=" btn green btn-bluejeans_10" title="编辑" onclick="edit_area(this)"  title="编辑运送区域" href="JavaScript:void(0);"> <i class="fa fa-edit"></i></a>
                    </td> </tr>
                                                                        <tr class="bd-line text-c">
                                    <input type="hidden" class="epa_id" name="epa_id[11]" value="11">
                <td class="cell-area" style="padding-left:5px">
                <span class="area-group"><input class="J_BatchField" style="width:15px; display:none" type="checkbox" value="" name="kd_n1">
                <p style="display:inline-block">宁夏区,青海省,新疆区</p> </span><input type="hidden" value="宁夏区,青海省,新疆区" class="select_area_name" name="area_name[11]"> <input type="hidden" value="1026,1247,1248,1249,1250,4268,1027,1251,1252,1253,1254,1255,1256,1257,1258,1028,1325,1326,1327,1328,1329,1330,1331,1332,1333,1334,1335,1336,1364,1365,1366,1367,4302,4338" class="select_area_id" name="area[11]"> </td>
                <td> <input class="w50 text" type="number" maxlength="4" autocomplete="off" value="1"  name="first_w[11]" onblur="valid()" data-field="postage"> </td> 
                <td> <input class="w50 mr5 text" type="number" maxlength="6" autocomplete="off" value="15.00" name="first_f[11]" onblur="valid()" data-field="postage"> 
                <em class="add-on"><i class="fa fa-rmb"></i></em> </td> <td> <input class="w50 text" type="number" maxlength="4"  autocomplete="off" value="1"  name="last_w[11]" onblur="valid()" data-field="postage"> </td> 
                <td> <input class="w50 mr5 text" type="number" maxlength="6" autocomplete="off" value="5.00"  name="last_f[11]" onblur="valid()" data-field="postage"> <em class="add-on"> <i class="fa fa-rmb"></i> </em> </td> 
                <td> <input class="w50 text" type="number" maxlength="4" autocomplete="off" value="0.00"  name="no_fee[11]" onblur="valid()" data-null="no_fee" data-field="postage"> </td>
                <td class="nscs-table-handle"> 
                 <a class=" btn red btn-del btn-grapefruit J_DeleteRule_11" title="删除" onclick="del_area(this)" href="JavaScript:void(0);"> <i class="fa fa-trash"></i> </a> 
                  <a class=" btn green btn-bluejeans_11" title="编辑" onclick="edit_area(this)"  title="编辑运送区域" href="JavaScript:void(0);"> <i class="fa fa-edit"></i></a>
                    </td> </tr>
                                                                        <tr class="bd-line text-c">
                                    <input type="hidden" class="epa_id" name="epa_id[12]" value="12">
                <td class="cell-area" style="padding-left:5px">
                <span class="area-group"><input class="J_BatchField" style="width:15px; display:none" type="checkbox" value="" name="kd_n1">
                <p style="display:inline-block">香港,澳门,台湾</p> </span><input type="hidden" value="香港,澳门,台湾" class="select_area_name" name="area_name[12]"> <input type="hidden" value="1031,1372,1032,1373,1033,4277,4278,4279,4280,4281,4282" class="select_area_id" name="area[12]"> </td>
                <td> <input class="w50 text" type="number" maxlength="4" autocomplete="off" value="1"  name="first_w[12]" onblur="valid()" data-field="postage"> </td> 
                <td> <input class="w50 mr5 text" type="number" maxlength="6" autocomplete="off" value="50.00" name="first_f[12]" onblur="valid()" data-field="postage"> 
                <em class="add-on"><i class="fa fa-rmb"></i></em> </td> <td> <input class="w50 text" type="number" maxlength="4"  autocomplete="off" value="1"  name="last_w[12]" onblur="valid()" data-field="postage"> </td> 
                <td> <input class="w50 mr5 text" type="number" maxlength="6" autocomplete="off" value="5.00"  name="last_f[12]" onblur="valid()" data-field="postage"> <em class="add-on"> <i class="fa fa-rmb"></i> </em> </td> 
                <td> <input class="w50 text" type="number" maxlength="4" autocomplete="off" value="0.00"  name="no_fee[12]" onblur="valid()" data-null="no_fee" data-field="postage"> </td>
                <td class="nscs-table-handle"> 
                 <a class=" btn red btn-del btn-grapefruit J_DeleteRule_12" title="删除" onclick="del_area(this)" href="JavaScript:void(0);"> <i class="fa fa-trash"></i> </a> 
                  <a class=" btn green btn-bluejeans_12" title="编辑" onclick="edit_area(this)"  title="编辑运送区域" href="JavaScript:void(0);"> <i class="fa fa-edit"></i></a>
                    </td> </tr>
                                                                                                        </table>
                            </div>
...
$('#submit_tpl').click(function(){
	...
	if (isSubmit == true){
		...
		$("#submit_tpl").css("background-color","#ccc");
		 $.ajax({
				type: "post",
		        url: "mall_express_area_submit?role=&store_id=",
		        data: form_data,
		        dataType: "json",
		        beforeSend:function(){
				...
				login_ajax('agent',data);
		        		...
		        		if(data.state){
		        			window.location.href = "mall_express_tools?op=&role=&id=";
