<?php
/* Smarty version 3.1.29, created on 2017-08-12 16:04:28
  from "D:\www\yunjuke\application\admin\views\public_store_of_freight_setting.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_598eb68ccf5281_58519613',
  'file_dependency' => 
  array (
    'c6b9a2cc5aba03ca89e0465b6fc80f4f020f84af' => 
    array (
      0 => 'D:\\www\\yunjuke\\application\\admin\\views\\public_store_of_freight_setting.html',
      1 => 1501668868,
      2 => 'file',
    ),
...
function content_598eb68ccf5281_58519613 ($_smarty_tpl) {
?>
...
<body style="background-color: #FFF; overflow: auto;">
        ...
        <div class="fixed-bar">
            <div class="item-title">
               <a class="back" href="javascript:history.back(-1)" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
					<div class="subject">
						<h3>店铺管理 - 门店(射洪 大头儿子)运费设置</h3>
						<h5>电商中的运费设置</h5>
					</div>
					                <ul class="tab-base nc-row">
				        <li><a href="store_edit?role=d&op=edit&id=52">基本信息</a></li>
				        <li><a href="store_of_goods?role=d&op=edit&id=52">商品</a></li>
				        <li><a href="store_of_shopping_guide?role=d&op=edit&id=52">导购</a></li>
				        <li><a href="JavaScript:void(0);" class="current">运费</a></li>
				        <li><a href="store_of_other?role=d&op=edit&id=52">其他</a></li>
			      </ul>
			                  </div>
        </div>
        <!-- 操作说明 -->
	...
	<span class="l">
	 <a href="mall_express_area_add?role=d&store_id=52"  class="btn btn-add radius ncap-btn-green"><span><i class="fa fa-plus"></i>新增配送区域</span></a>
	 <!-- <a href="javascript:;" onclick="fg_operate()"  class="btn btn-download radius "><span><i class="fa fa-cloud-download"></i>数据导入(未完成))</span></a>
	   --></span> <span class="r">共有数据：<strong id="data-total-num">1</strong> 条</span> 
...
function del_info(transport_id){
	layer.confirm('确认删除这条数据吗?', {
    	...
    	$.ajax({
    		type: "post",
            url: "mall_express_tools_del?role=d",
...
function page_to(rp_val,cur_page,search_data){
	$.ajax({
		type: "post",
        url: "mall_express_tools?role=d&op=change&"+search_data,
...
function edit_info(obj){
	...
	var form = $("<form></form>");
    form.attr('action','mall_express_area_add?role=d&store_id=52');
...
function fg_operate(){
	...
	var content_url='express_fee_import?role=d';
	layer.open({
        type: 1,
        btn: ['确认', '取消'],
        title: '<b>运费导入</b>',
