...
if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  ...
  'version' => '3.1.29',
  'unifunc' => 'content_59801eb493aa01_93212275',
  'file_dependency' => 
  array (
...
function content_59801eb493aa01_93212275 ($_smarty_tpl) {
?>
	...
	<form method="post" name="settingForm" id="settingForm">
		...
		<div class="ncap-form-default">
			<dl class="row">
				...
				<dd class="opt">
					<div class="onoff">
						<label for="weixin_isuse_1" class="cb-enable  selected " title="开启"><span>开启</span></label>
						<label for="weixin_isuse_0" class="cb-disable " title="关闭"><span>关闭</span></label>
						<input type="radio" id="weixin_isuse_1" name="weixin_isuse" value="1"  checked="checked" >
						<input type="radio" id="weixin_isuse_0" name="weixin_isuse" value="0" >
					</div>
			...
			<dl class="row">
				...
				<dd class="opt">
					<input id="weixin_appid" name="weixin_appid" value="wew" class="input-txt" type="text"><span class="err"></span>
			...
			<dl class="row">
				...
				<dd class="opt">
					<input id="weixin_appkey" name="weixin_secret" value="wefwe" class="input-txt" type="text"><span class="err"></span>
					<p class="notic">&nbsp;</p>
				</dd>
			</dl>
