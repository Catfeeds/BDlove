...
if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  ...
  'version' => '3.1.29',
  'unifunc' => 'content_59c35cbfba5742_07278846',
  'file_dependency' => 
  array (
...
function content_59c35cbfba5742_07278846 ($_smarty_tpl) {
?>
<!DOCTYPE HTML>
<html>
<head>
	...
	'</div>';
		...
		if(pic_info&&typeof(pic_info)=='object'){
			$.each(pic_info,function(k,v){
				pic_img += '<div class="uploadimg" id="uploadimg2" imgname="'+v+'"><img src=http://[::1]/yunjuke/data/shop/refund_pic/'+v+'></div>';
			})
		}
