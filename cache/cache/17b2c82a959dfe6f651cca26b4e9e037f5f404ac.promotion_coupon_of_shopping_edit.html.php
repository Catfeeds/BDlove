...
if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  ...
  'version' => '3.1.29',
  'unifunc' => 'content_598035bf7d0e79_04406222',
  'file_dependency' => 
  array (
...
function content_598035bf7d0e79_04406222 ($_smarty_tpl) {
?>
<!doctype html>
<html>
<head>
    ...
    <div class="page">
        ...
        <form id="add_form" method="post" action="store_add" enctype="multipart/form-data">
                        ...
                        <div class="couponBox">
                            <div class="couponWrap" style="background-color: rgb(244, 67, 54);">
                                <div class="top">
                                    ...
                                    <div class="type">
                                        <span class="couponValue">0.00</span>元优惠券,满<span class="orderLimitValue">0.00</span>元可用
                                    </div>
                                </div>
                                <div class="bottom">
                                    <span class="r" id="couponDateLimit">
                                        <span class="couponstart"></span> - <span class="couponend"></span>
                                    </span>
                                </div>
                            </div>
                ...
                <dl class="row">
                    ...
                    <dd class="opt">
                        <div class="area-region-select">
                            <input type="text" id="start_time" onclick="laydate()" value="" name="activit[cpaos_start_time]" placeholder="开始时间">至
                            <input type="text" id="end_time" onclick="laydate()" value="" name="activit[cpaos_end_time]" placeholder="结束时间">
                            <span class="err"></span></div>
                        <span class="err"></span>
                    </dd>
                </dl>
                    ...
                    <dd class="opt">
                        <div class="area-region-select">
                            ...
                            <input type="text" name="activit[cpaos_amount]" 
                                   style="display: none;" value="0" placeholder="不可修改" id="cpaos_amount" class="input-text input_text " maxlength="8"   >
                        </div>
                    </dd>
                </dl>
                <dl class="row" id="coupon_to_store_limit">
                    ...
                    <dd class="opt">
                        <div class="area-region-select">
                            ...
                            <input type="text" name="activit[cpaos_day_amount]"  
                                   style="display: none;" value="0"  placeholder="不可修改" id="cpaos_day_amount" class="input-text input_text" maxlength="8">
                        </div>
                    </dd>
                </dl>
                    ...
                    <dd class="opt">
                        <div class="area-region-select">
                            ...
                            <input type="text" name="activit[cpapos_peru_amount]"  
                                   style="display: none;" value="0" placeholder="不可修改" id="cpapos_peru_amount" class="input-text input_text" maxlength="8">
                        </div>
                    </dd>
                </dl>
                <div class="title">
                    ...
                    <dd class="opt">
                        <div class="area-region-select">
                            <select class="valid input-text input_text limit_state" id="coupon_limit_type" name="activit[limit_goods_type]">
                                ...
                                <option value="1" >类目限制</option>
                                <option value="2" >商品限制</option>
                                <option value="3" >品牌限制</option>
                            </select>
                            <input name="activit[limit_goods]" type="hidden" id="limit_goods" value="">
                            <input class="btn btn-link radius" type="button" id="BtnLimitGoods" style="display:none" name="BtnLimitStore" value="编辑"></br>
                            <div id="limitResBox" class="limit-res-box mt-5" style="display:none">
                                                            </div>
                    ...
                    <dd class="opt">
                        <div class="area-region-select">
                            <select class="valid input-text input_text" id="limit_stores_type" name="activit[limit_stores_type]">
                                ...
                                <option value="1" >限制部分门店</option>
                            </select>
                            <input type="hidden" id="limit_store" name="activit[limit_stores]" value="">
                            <input class="btn btn-link radius" style="display:none" type="button" id="BtnLimitStore" name="BtnLimitStore" value="编辑"></br>
                            <div id="LimitStoreResBox" class="limit-res-box mt-5" style="display:none">
                                                             </div>
                    ...
                    <dd class="opt">
                        <div class="area-region-select">
                            <select class="valid  input-text input_text limit_state" id="limit_order_type" name="activit[limit_order_type]">
                                <option value="0" selected>不限金额</option>
                                <option value="1" >限金额</option>
                            </select>
                            <input type="text" name="activit[limit_order_fee]"  
                                   style="display: none;" value="0" placeholder="不可修改" id="limit_order_fee" class="input-text input_text" maxlength="8">
                        </div>
