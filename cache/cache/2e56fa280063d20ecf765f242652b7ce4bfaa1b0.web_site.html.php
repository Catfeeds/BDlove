<?php
/* Smarty version 3.1.29, created on 2017-11-01 13:42:11
  from "D:\www\yunjuke\application\admin\views\web_site.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_59f95eb39f6a88_83354017',
  'file_dependency' => 
  array (
    '2e56fa280063d20ecf765f242652b7ce4bfaa1b0' => 
    array (
      0 => 'D:\\www\\yunjuke\\application\\admin\\views\\web_site.html',
      1 => 1492225943,
      2 => 'file',
    ),
...
function content_59f95eb39f6a88_83354017 ($_smarty_tpl) {
?>
<!doctype html>
<html>
<head>
...
<div class="page">
  ...
  <form method="post"  action="" name="form" id="form_data">
    ...
    <div class="ncap-form-default">
        ...
        <dd class="opt">
                    <input id="site_name" name="website_name" value="童装一站式购物平台" class="input-txt site_name" type="text" />
        ...
        <dd class="opt">
                    <input id="site_name" name="icp_number" value="蜀ICP备14014320号-4a" class="input-txt site_name" type="text" />
        ...
        <dd class="opt">
                    <input id="site_name" name="website_keywords" value="童装一站式购物平台" class="input-txt site_name" type="text" />
        ...
        <dd class="opt">
                    <input id="site_name" name="service_tel" value="400-365-001" class="input-txt site_name" type="text" />
        ...
        <dd class="opt">
                    <input id="site_name" name="address" value="四川省成都市金牛区金泉路5号" class="input-txt site_name" type="text" />
        ...
        <dd class="opt">
                    <textarea name="website_desc" rows="6" class="tarea" id="discrimination">全渠道管理平台</textarea>
