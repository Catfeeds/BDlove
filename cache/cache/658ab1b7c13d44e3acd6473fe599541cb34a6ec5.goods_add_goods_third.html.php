...
if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  ...
  'version' => '3.1.29',
  'unifunc' => 'content_59a5123e8fcd49_15335729',
  'file_dependency' => 
  array (
...
function content_59a5123e8fcd49_15335729 ($_smarty_tpl) {
?>
<!DOCTYPE HTML>
<html>
<head>
...
<div class="wrapper_search page-container">
  ...
  <!--</div>-->
    <!--<div class="explanation" id="explanation">-->
        ...
        <!--</ul>-->
    <!--</div>-->
    <form action="goods_add_goods_fourth?op=edit" class="mt-20" id="goods_image" method="post">
    	<input name="goods_id" type="hidden" value="20437">
            ...
            <div class="container">
             ...
             <div class="ncsc-goodspic-list">
                        ...
                        <h3>颜色：桔红色</h3>
                                        ...
                                        <ul class="goods-pic-list" nctype="ul_40704">
                        <li class="ncsc-goodspic-upload">
                        	<input type="hidden" name="img[0][0][color_id]" value="40704">
                            <input type="hidden" name="img[0][0][goods_id]" value="20437">
                            <div class="upload-thumb"><img src="http://[::1]/yunjuke/data/shop/album_pic/1_201708291449510.png" nctype="file_00">
                                <input type="hidden" name="img[0][0][goods_image]" value="1_201708291449510.png" nctype="file_00">
                            </div>
                            ...
                            <span><input type="file" hidefocus="true" size="1" class="input-file" name="file_00" id="file_00">
                                                  ...
                                                  <li class="ncsc-goodspic-upload">
                        	<input type="hidden" name="img[0][1][color_id]" value="40704">
                            <input type="hidden" name="img[0][1][goods_id]" value="20437">
                            <div class="upload-thumb"><img src="http://[::1]/yunjuke/application/pay/views/img/default_goods_image_240.gif" nctype="file_01">
                            ...
                            <span><input type="file" hidefocus="true" size="1" class="input-file" name="file_01" id="file_01">
                                                 ...
                                                 <li class="ncsc-goodspic-upload">
                        	<input type="hidden" name="img[0][2][color_id]" value="40704">
                            <input type="hidden" name="img[0][2][goods_id]" value="20437">
                            <div class="upload-thumb"><img src="http://[::1]/yunjuke/application/pay/views/img/default_goods_image_240.gif" nctype="file_02">
                            ...
                            <span><input type="file" hidefocus="true" size="1" class="input-file" name="file_02" id="file_02">
                                                 ...
                                                 <li class="ncsc-goodspic-upload">
                        	<input type="hidden" name="img[0][3][color_id]" value="40704">
                            <input type="hidden" name="img[0][3][goods_id]" value="20437">
                            <div class="upload-thumb"><img src="http://[::1]/yunjuke/application/pay/views/img/default_goods_image_240.gif" nctype="file_03">
                            ...
                            <span><input type="file" hidefocus="true" size="1" class="input-file" name="file_03" id="file_03">
                                                 ...
                                                 <li class="ncsc-goodspic-upload">
                        	<input type="hidden" name="img[0][4][color_id]" value="40704">
                            <input type="hidden" name="img[0][4][goods_id]" value="20437">
                            <div class="upload-thumb"><img src="http://[::1]/yunjuke/application/pay/views/img/default_goods_image_240.gif" nctype="file_04">
                    ...
                    <div nctype="album-0 " class="hide demo">
                        <div class="goods-gallery" nctype="gallery-0"><!--<a class="sample_demo" href="">提交</a>-->
                            ...
                            <span class="r">
                                <select name="jumpMenu_default" style="width:100px;" data-function="insert_img" data-id="40704" onchange="get_pic(this,1)">
...
<script type="text/javascript">
        ...
        $.ajaxFileUpload({
            ...
            success : function (data, status) {
                if(data.state == '403'){
                    ...
                    $('img[nctype="' + id + '"]').attr('src','http://[::1]/yunjuke/application/pay/views/img/default_goods_image_240.gif');
                } else {
    ...
    function selectDefaultImage($this) {
        ...
        $this.parents('li:first').find('a[nctype="del"]').click(function(){
            ...
            $this.prev().find('input').val('').end().find('img').attr('src', 'http://[::1]/yunjuke/application/pay/views/img/default_goods_image_240.gif');
