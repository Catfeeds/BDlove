...
if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  ...
  'version' => '3.1.29',
  'unifunc' => 'content_59d9845077a616_42486571',
  'file_dependency' => 
  array (
...
function content_59d9845077a616_42486571 ($_smarty_tpl) {
?>
<!doctype html>
<html>
<head>
                ...
                <dd class="opt">
                    <div class="input-file-show"><span class="show">
                        <a class="nyroModal" rel="gal" href="javascript:void();">
                            <i class="fa fa-picture-o"  id="" data-geo='<img src="http://[::1]/yunjuke/data/images/default_goods_image.jpg" width=100px height=50px>'></i>
                        </a>
                    </span>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <div class="input-file-show">
                        <span class="show">
                            <a class="nyroModal" rel="gal" href="javascript:void();">
                                <i class="fa fa-picture-o"  id="" data-geo='<img src="http://[::1]/yunjuke/data/images/default_store_logo.jpg" width=100px height=50px>'></i>
                            </a>
                        </span>
                        <span class="type-file-box">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <div class="input-file-show">
                        <span class="show">
                            <a class="nyroModal" rel="gal" href="javascript:void();">
                                <i class="fa fa-picture-o"  id="" data-geo='<img src="http://[::1]/yunjuke/data/images/default_store_avatar.jpg" width=100px height=50px>'></i>
                           </a>
                        </span>
                        <span class="type-file-box">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <div class="input-file-show">
                        <span class="show">
                            <a class="nyroModal" rel="gal" href="javascript:void();">
                                <i class="fa fa-picture-o"  id="" data-geo='<img src="http://[::1]/yunjuke/data/images/" width=100px height=50px>'></i>
                           </a>
                        </span>
                        <span class="type-file-box">
