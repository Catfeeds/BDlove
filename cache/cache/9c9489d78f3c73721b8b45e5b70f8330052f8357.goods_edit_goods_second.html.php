<?php
/* Smarty version 3.1.29, created on 2017-09-09 15:14:18
  from "D:\www\yunjuke\application\pay\views\goods_edit_goods_second.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_59b394caf402a9_07159648',
  'file_dependency' => 
  array (
    '9c9489d78f3c73721b8b45e5b70f8330052f8357' => 
    array (
      0 => 'D:\\www\\yunjuke\\application\\pay\\views\\goods_edit_goods_second.html',
      1 => 1504591335,
      2 => 'file',
    ),
...
function content_59b394caf402a9_07159648 ($_smarty_tpl) {
?>
<!DOCTYPE HTML>
<html>
<head>
...
<script type="text/javascript" src="http://[::1]/yunjuke/application/pay/views/js/jquery.charCount.js"></script>
<script type="text/javascript" src="http://[::1]/yunjuke/application/pay/views/js/jquery.fileupload.js"></script>
<script type="text/javascript" src="http://[::1]/yunjuke/application/pay/views/js/jquery.iframe-transport.js"></script>
<script type="text/javascript" src="http://[::1]/yunjuke/application/pay/views/js/jquery.ui.widget.js"></script>
<script type="text/javascript" src="http://[::1]/yunjuke/application/pay/views/js/ajaxfileupload.js"></script>
<script type="text/javascript" src="http://[::1]/yunjuke/plugins/select2/js/select2.min.js"></script>
<style>
...
<nav class="breadcrumb">
    <i class="Hui-iconfont">&#xe67f;</i> 店铺管理 <span class="c-gray en p-lr">&gt;</span>商品管理<span class="c-gray en p-lr">&gt;</span><a href="goods_management?op=shop_goods" style="color: #666;">自建门店</a><span class="c-gray en p-lr">&gt;</span>编辑商品
...
<div class="page-container wrapper_search">
    ...
    <form action="goods_add_goods_third?op=edit&goods_id=25700" id="form_2" method="post">
    <input type="hidden" name="editGoodsId" id="editGoodsId" value="25700">
        <input type="hidden" name="single_stocks_code_flag" value="multiple">
        ...
        <div class="ncsc-form-goods">
            ...
            <dl>
                ...
                <dd>
                    <input name="base_info[goods_name]" type="text" class="text w400" value="abckids童鞋2017秋新款男孩宝宝轻便防滑透气儿童运动鞋">
                    <span class="err"></span>
            ...
            <dl>
                ...
                <dd id="gcategory">
                    <input type="hidden" name="base_info[gc_name]" id="gc_name" value="其他">
                    <select name="base_info[gc_id]" id="gc_id" data-ids="99999" class="selecte pd-5 mb-10 select2" onchange="get_info_by_class(this)">
                        <option value="99999" selected>其他</option>
                    </select>
                    <span class="err"></span>
                ...
                <dd>
                    <div class="ncsc-brand-select">
                        <div class="selection">
                            ...
                            <input type="hidden" name="base_info[brand_id]" id="b_id" value=""><em class="add-on">
                ...
                <dl>
                    ...
                    <dd>
                        <input name="base_info[year_to_market]" type="text" class="text" value="2017">
                        <span class="err"></span>
            ...
            <dl>
                <dt>商品自定义标签分类：</dt>
                <dd>
                    <select name="gstn[]" class="selecte pd-5 mb-10 select2" id="gstn_id" data-ids="" multiple="multiple" >
                    </select>
                    <span class="err"></span>
            ...
            <dl>
                ...
                <dd nc_type="no_spec">
                    <input name="base_info[goods_price]" value="219.00" data-old="0.00" type="text" class="text w60"><em class="add-on"><i class="fa fa-rmb"></i></em> <span class="price"></span><span class="err"></span>
            ...
            <dl>
                ...
                <dd>
                    <input name="base_info[goods_marketprice]" value="219.00" type="text" class="text w60"><em class="add-on"><i class="fa fa-rmb"></i></em> <span class="err"></span>
            ...
            <dl>
                ...
                <dd nc_type="no_spec">
                    <p>
                        <input name="base_info[goods_spu]" id="stocks_code" class="stocks_code" value="Y73215239" type="text" class="text" nctype="stocks_code"><span class="err"></span>
                    </p>
            ...
            <dl>
                ...
                <dd nc_type="no_spec">
                    <p>
                        <input name="base_info[weight]" id="weight" class="weight" value="0.000" type="number" class="text" nctype="weight"><span>克</span><span class="err"></span>
                    </p>
                    <p class="hint"></p>
                </dd>
            </dl>
            <dl nctype="spec_group_dl" style="overflow: visible" spec_img="t">
                ...
                <dd nctype="" class="pos-r">
                    <div class="choose_color_box">
                            ...
                            <input type="hidden" name="color[0][goods_a_id]" class="color_value color_a_id"  value="59526">
                            <input type="checkbox"checked="checked"  nctype="input_checkbox" onchange="color_check_click(this)" class="color-select mr-5" name="color-select[]">
                            <input type="text" name="color[0][color]" nctype="pv_name" class="picker-text w300 mr-5" onfocus="f1(this)"  value="花色" readonly placeholder="选择主色" maxlength="30" data-old="">
                            <input type="hidden" name="color[0][color_value]" class="color_value"  value="">
                            <input type="text" name="color[0][color_remark]" class="picker-remark" placeholder="备注（如丁香紫,宝石蓝等）" value="红+荧光绿" maxlength="30">
                            <div class="pos-a choose_color_box_hide hide mt-10 c-333">
                            </div>
                        </div>	
                                                <div class="choose_color_box_list mb-10" id="creat_tr_1">
                            <input type="hidden" name="color[1][goods_a_id]" class="color_value color_a_id"  value="59527">
                            <input type="checkbox"checked="checked"  nctype="input_checkbox" onchange="color_check_click(this)" class="color-select mr-5" name="color-select[]">
                            <input type="text" name="color[1][color]" nctype="pv_name" class="picker-text w300 mr-5" onfocus="f1(this)"  value="花色" readonly placeholder="选择主色" maxlength="30" data-old="">
                            <input type="hidden" name="color[1][color_value]" class="color_value"  value="">
                            <input type="text" name="color[1][color_remark]" class="picker-remark" placeholder="备注（如丁香紫,宝石蓝等）" value="湖兰+纯蓝" maxlength="30">
                            <div class="pos-a choose_color_box_hide hide mt-10 c-333">
                            </div>
                        </div>	
                                                <div class="choose_color_box_list mb-10" id="creat_tr_2">
                            <input type="hidden" name="color[2][goods_a_id]" class="color_value color_a_id"  value="59528">
                            <input type="checkbox"checked="checked"  nctype="input_checkbox" onchange="color_check_click(this)" class="color-select mr-5" name="color-select[]">
                            <input type="text" name="color[2][color]" nctype="pv_name" class="picker-text w300 mr-5" onfocus="f1(this)"  value="花色" readonly placeholder="选择主色" maxlength="30" data-old="">
                            <input type="hidden" name="color[2][color_value]" class="color_value"  value="">
                            <input type="text" name="color[2][color_remark]" class="picker-remark" placeholder="备注（如丁香紫,宝石蓝等）" value="黑+湖兰" maxlength="30">
                            <div class="pos-a choose_color_box_hide hide mt-10 c-333">
                            </div>
                        </div>	
                                                <div class="choose_color_box_list mb-10" id="creat_tr_3">
                            <input type="hidden" name="color[3][goods_a_id]" class="color_value color_a_id"  value="59529">
                            <input type="checkbox"checked="checked"  nctype="input_checkbox" onchange="color_check_click(this)" class="color-select mr-5" name="color-select[]">
                            <input type="text" name="color[3][color]" nctype="pv_name" class="picker-text w300 mr-5" onfocus="f1(this)"  value="花色" readonly placeholder="选择主色" maxlength="30" data-old="">
                            <input type="hidden" name="color[3][color_value]" class="color_value"  value="">
                            <input type="text" name="color[3][color_remark]" class="picker-remark" placeholder="备注（如丁香紫,宝石蓝等）" value="奥运蓝+荧光绿" maxlength="30">
                            <div class="pos-a choose_color_box_hide hide mt-10 c-333">
                            </div>
                        </div>	
                                                <div class="choose_color_box_list mb-10" id="creat_tr_4">
                            <input type="hidden" name="color[4][goods_a_id]" class="color_value color_a_id"  value="59530">
                            <input type="checkbox"checked="checked"  nctype="input_checkbox" onchange="color_check_click(this)" class="color-select mr-5" name="color-select[]">
                            <input type="text" name="color[4][color]" nctype="pv_name" class="picker-text w300 mr-5" onfocus="f1(this)"  value="花色" readonly placeholder="选择主色" maxlength="30" data-old="">
                            <input type="hidden" name="color[4][color_value]" class="color_value"  value="">
                            <input type="text" name="color[4][color_remark]" class="picker-remark" placeholder="备注（如丁香紫,宝石蓝等）" value="红+宝蓝" maxlength="30">
                            <div class="pos-a choose_color_box_hide hide mt-10 c-333">
                            </div>
                        </div>	
                                                <div class="choose_color_box_list mb-10" id="creat_tr_5">
                            <input type="checkbox" nctype="input_checkbox" onchange="color_check_click(this)" class="color-select mr-5" name="color-select[]">
                            <input type="text" name="color[5][color]s" nctype="pv_name" class="picker-text w300 mr-5" onfocus="f1(this)" readonly  value="" placeholder="选择主色" maxlength="30" data-old="">
                            <input type="hidden" name="color[5][color_value]" class="color_value"  value="">
                            <input type="text" name="color[5][color_remark]" class="picker-remark" placeholder="备注（如丁香紫,宝石蓝等）" value="" maxlength="30">
                            <div class="pos-a choose_color_box_hide hide mt-10 c-333">
                            </div>
                        </div>
                                            </div>
                    ...
                    <div nctype="spec_div" class="spec-div ps-container">
                        <table border="0" cellpadding="0" cellspacing="0" class="spec_table" style="width:80% !important">
                            ...
                            <tbody nc_type="spec_table">
                                                                                                                                                    <tr class="creat_tr_0 size_tr_22">
                                        <input type="hidden"  class="goods_ea_id" name="size[0][0][goods_ea_id]" value="117773" />
                                        <td><input type="hidden"  class="color" name="size[0][0][color]" value="花色" />
                                            <span class="goods_color">红+荧光绿</span>
                                        </td>
                                        <td><input type="hidden"  class="size_val" name="size[0][0][size]" value="22" />
                                            <input type="hidden"  class="code_segment" name="size[0][0][code_segment]" value="1" />
                                            <span class="goods_size">22</span>
                                        </td>
                                        <td><input class="size-note" type="text" name="size[0][0][size_note]" value="16cm（内长13." /></td>
                                        <td><input class="text price sell_price" type="text" name="size[0][0][stocks_price]" data_type="price" nc_type="price" value="219.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text price goods_marketprice" type="text" name="size[0][0][stocks_marketprice]" data_type="marketprice" nc_type="|marketprice" value="219.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text sku stocks_code" type="text" name="size[0][0][stocks_sku]" nctype="stocks_code" value="" /><span class="error checkCode" style="display:none;">此货号已有其他颜色占用。</span><span class="error dberr" style="display:none;">此货号已被同品牌的其他商品占用。</span></td>
                                        <td><input class="text bar_code" type="text" name="size[0][0][stocks_bar_code]" data_type="stocks_bar_code" nc_type="|stocks_bar_code" value="" /></td>
                                                                                ...
                                                                                <tr class="creat_tr_0 size_tr_23">
                                        <input type="hidden"  class="goods_ea_id" name="size[0][1][goods_ea_id]" value="117774" />
                                        <td><input type="hidden"  class="color" name="size[0][1][color]" value="花色" />
                                            <span class="goods_color">红+荧光绿</span>
                                        </td>
                                        <td><input type="hidden"  class="size_val" name="size[0][1][size]" value="23" />
                                            <input type="hidden"  class="code_segment" name="size[0][1][code_segment]" value="1" />
                                            <span class="goods_size">23</span>
                                        </td>
                                        <td><input class="size-note" type="text" name="size[0][1][size_note]" value="16.5cm（内长1" /></td>
                                        <td><input class="text price sell_price" type="text" name="size[0][1][stocks_price]" data_type="price" nc_type="price" value="219.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text price goods_marketprice" type="text" name="size[0][1][stocks_marketprice]" data_type="marketprice" nc_type="|marketprice" value="219.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text sku stocks_code" type="text" name="size[0][1][stocks_sku]" nctype="stocks_code" value="" /><span class="error checkCode" style="display:none;">此货号已有其他颜色占用。</span><span class="error dberr" style="display:none;">此货号已被同品牌的其他商品占用。</span></td>
                                        <td><input class="text bar_code" type="text" name="size[0][1][stocks_bar_code]" data_type="stocks_bar_code" nc_type="|stocks_bar_code" value="" /></td>
                                        </tr>
                                                                                <tr class="creat_tr_0 size_tr_24">
                                        <input type="hidden"  class="goods_ea_id" name="size[0][2][goods_ea_id]" value="117775" />
                                        <td><input type="hidden"  class="color" name="size[0][2][color]" value="花色" />
                                            <span class="goods_color">红+荧光绿</span>
                                        </td>
                                        <td><input type="hidden"  class="size_val" name="size[0][2][size]" value="24" />
                                            <input type="hidden"  class="code_segment" name="size[0][2][code_segment]" value="1" />
                                            <span class="goods_size">24</span>
                                        </td>
                                        <td><input class="size-note" type="text" name="size[0][2][size_note]" value="17cm（内长14." /></td>
                                        <td><input class="text price sell_price" type="text" name="size[0][2][stocks_price]" data_type="price" nc_type="price" value="219.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text price goods_marketprice" type="text" name="size[0][2][stocks_marketprice]" data_type="marketprice" nc_type="|marketprice" value="219.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text sku stocks_code" type="text" name="size[0][2][stocks_sku]" nctype="stocks_code" value="" /><span class="error checkCode" style="display:none;">此货号已有其他颜色占用。</span><span class="error dberr" style="display:none;">此货号已被同品牌的其他商品占用。</span></td>
                                        <td><input class="text bar_code" type="text" name="size[0][2][stocks_bar_code]" data_type="stocks_bar_code" nc_type="|stocks_bar_code" value="" /></td>
                                        </tr>
                                                                                <tr class="creat_tr_0 size_tr_25">
                                        <input type="hidden"  class="goods_ea_id" name="size[0][3][goods_ea_id]" value="117776" />
                                        <td><input type="hidden"  class="color" name="size[0][3][color]" value="花色" />
                                            <span class="goods_color">红+荧光绿</span>
                                        </td>
                                        <td><input type="hidden"  class="size_val" name="size[0][3][size]" value="25" />
                                            <input type="hidden"  class="code_segment" name="size[0][3][code_segment]" value="1" />
                                            <span class="goods_size">25</span>
                                        </td>
                                        <td><input class="size-note" type="text" name="size[0][3][size_note]" value="17.5cm（内长1" /></td>
                                        <td><input class="text price sell_price" type="text" name="size[0][3][stocks_price]" data_type="price" nc_type="price" value="219.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text price goods_marketprice" type="text" name="size[0][3][stocks_marketprice]" data_type="marketprice" nc_type="|marketprice" value="219.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text sku stocks_code" type="text" name="size[0][3][stocks_sku]" nctype="stocks_code" value="" /><span class="error checkCode" style="display:none;">此货号已有其他颜色占用。</span><span class="error dberr" style="display:none;">此货号已被同品牌的其他商品占用。</span></td>
                                        <td><input class="text bar_code" type="text" name="size[0][3][stocks_bar_code]" data_type="stocks_bar_code" nc_type="|stocks_bar_code" value="" /></td>
                                        </tr>
                                                                                <tr class="creat_tr_0 size_tr_26">
                                        <input type="hidden"  class="goods_ea_id" name="size[0][4][goods_ea_id]" value="117777" />
                                        <td><input type="hidden"  class="color" name="size[0][4][color]" value="花色" />
                                            <span class="goods_color">红+荧光绿</span>
                                        </td>
                                        <td><input type="hidden"  class="size_val" name="size[0][4][size]" value="26" />
                                            <input type="hidden"  class="code_segment" name="size[0][4][code_segment]" value="1" />
                                            <span class="goods_size">26</span>
                                        </td>
                                        <td><input class="size-note" type="text" name="size[0][4][size_note]" value="18cm（内长16c" /></td>
                                        <td><input class="text price sell_price" type="text" name="size[0][4][stocks_price]" data_type="price" nc_type="price" value="219.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text price goods_marketprice" type="text" name="size[0][4][stocks_marketprice]" data_type="marketprice" nc_type="|marketprice" value="219.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text sku stocks_code" type="text" name="size[0][4][stocks_sku]" nctype="stocks_code" value="" /><span class="error checkCode" style="display:none;">此货号已有其他颜色占用。</span><span class="error dberr" style="display:none;">此货号已被同品牌的其他商品占用。</span></td>
                                        <td><input class="text bar_code" type="text" name="size[0][4][stocks_bar_code]" data_type="stocks_bar_code" nc_type="|stocks_bar_code" value="" /></td>
                                        </tr>
                                                                                                                                                            <tr class="creat_tr_1 size_tr_22">
                                        <input type="hidden"  class="goods_ea_id" name="size[1][0][goods_ea_id]" value="117778" />
                                        <td><input type="hidden"  class="color" name="size[1][0][color]" value="花色" />
                                            <span class="goods_color">湖兰+纯蓝</span>
                                        </td>
                                        <td><input type="hidden"  class="size_val" name="size[1][0][size]" value="22" />
                                            <input type="hidden"  class="code_segment" name="size[1][0][code_segment]" value="1" />
                                            <span class="goods_size">22</span>
                                        </td>
                                        <td><input class="size-note" type="text" name="size[1][0][size_note]" value="16cm（内长13." /></td>
                                        <td><input class="text price sell_price" type="text" name="size[1][0][stocks_price]" data_type="price" nc_type="price" value="219.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text price goods_marketprice" type="text" name="size[1][0][stocks_marketprice]" data_type="marketprice" nc_type="|marketprice" value="219.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text sku stocks_code" type="text" name="size[1][0][stocks_sku]" nctype="stocks_code" value="" /><span class="error checkCode" style="display:none;">此货号已有其他颜色占用。</span><span class="error dberr" style="display:none;">此货号已被同品牌的其他商品占用。</span></td>
                                        <td><input class="text bar_code" type="text" name="size[1][0][stocks_bar_code]" data_type="stocks_bar_code" nc_type="|stocks_bar_code" value="" /></td>
                                        </tr>
                                                                                <tr class="creat_tr_1 size_tr_23">
                                        <input type="hidden"  class="goods_ea_id" name="size[1][1][goods_ea_id]" value="117779" />
                                        <td><input type="hidden"  class="color" name="size[1][1][color]" value="花色" />
                                            <span class="goods_color">湖兰+纯蓝</span>
                                        </td>
                                        <td><input type="hidden"  class="size_val" name="size[1][1][size]" value="23" />
                                            <input type="hidden"  class="code_segment" name="size[1][1][code_segment]" value="1" />
                                            <span class="goods_size">23</span>
                                        </td>
                                        <td><input class="size-note" type="text" name="size[1][1][size_note]" value="16.5cm（内长1" /></td>
                                        <td><input class="text price sell_price" type="text" name="size[1][1][stocks_price]" data_type="price" nc_type="price" value="219.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text price goods_marketprice" type="text" name="size[1][1][stocks_marketprice]" data_type="marketprice" nc_type="|marketprice" value="219.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text sku stocks_code" type="text" name="size[1][1][stocks_sku]" nctype="stocks_code" value="" /><span class="error checkCode" style="display:none;">此货号已有其他颜色占用。</span><span class="error dberr" style="display:none;">此货号已被同品牌的其他商品占用。</span></td>
                                        <td><input class="text bar_code" type="text" name="size[1][1][stocks_bar_code]" data_type="stocks_bar_code" nc_type="|stocks_bar_code" value="" /></td>
                                        </tr>
                                                                                <tr class="creat_tr_1 size_tr_24">
                                        <input type="hidden"  class="goods_ea_id" name="size[1][2][goods_ea_id]" value="117780" />
                                        <td><input type="hidden"  class="color" name="size[1][2][color]" value="花色" />
                                            <span class="goods_color">湖兰+纯蓝</span>
                                        </td>
                                        <td><input type="hidden"  class="size_val" name="size[1][2][size]" value="24" />
                                            <input type="hidden"  class="code_segment" name="size[1][2][code_segment]" value="1" />
                                            <span class="goods_size">24</span>
                                        </td>
                                        <td><input class="size-note" type="text" name="size[1][2][size_note]" value="17cm（内长14." /></td>
                                        <td><input class="text price sell_price" type="text" name="size[1][2][stocks_price]" data_type="price" nc_type="price" value="219.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text price goods_marketprice" type="text" name="size[1][2][stocks_marketprice]" data_type="marketprice" nc_type="|marketprice" value="219.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text sku stocks_code" type="text" name="size[1][2][stocks_sku]" nctype="stocks_code" value="" /><span class="error checkCode" style="display:none;">此货号已有其他颜色占用。</span><span class="error dberr" style="display:none;">此货号已被同品牌的其他商品占用。</span></td>
                                        <td><input class="text bar_code" type="text" name="size[1][2][stocks_bar_code]" data_type="stocks_bar_code" nc_type="|stocks_bar_code" value="" /></td>
                                        </tr>
                                                                                <tr class="creat_tr_1 size_tr_25">
                                        <input type="hidden"  class="goods_ea_id" name="size[1][3][goods_ea_id]" value="117781" />
                                        <td><input type="hidden"  class="color" name="size[1][3][color]" value="花色" />
                                            <span class="goods_color">湖兰+纯蓝</span>
                                        </td>
                                        <td><input type="hidden"  class="size_val" name="size[1][3][size]" value="25" />
                                            <input type="hidden"  class="code_segment" name="size[1][3][code_segment]" value="1" />
                                            <span class="goods_size">25</span>
                                        </td>
                                        <td><input class="size-note" type="text" name="size[1][3][size_note]" value="17.5cm（内长1" /></td>
                                        <td><input class="text price sell_price" type="text" name="size[1][3][stocks_price]" data_type="price" nc_type="price" value="219.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text price goods_marketprice" type="text" name="size[1][3][stocks_marketprice]" data_type="marketprice" nc_type="|marketprice" value="219.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text sku stocks_code" type="text" name="size[1][3][stocks_sku]" nctype="stocks_code" value="" /><span class="error checkCode" style="display:none;">此货号已有其他颜色占用。</span><span class="error dberr" style="display:none;">此货号已被同品牌的其他商品占用。</span></td>
                                        <td><input class="text bar_code" type="text" name="size[1][3][stocks_bar_code]" data_type="stocks_bar_code" nc_type="|stocks_bar_code" value="" /></td>
                                        </tr>
                                                                                <tr class="creat_tr_1 size_tr_26">
                                        <input type="hidden"  class="goods_ea_id" name="size[1][4][goods_ea_id]" value="117782" />
                                        <td><input type="hidden"  class="color" name="size[1][4][color]" value="花色" />
                                            <span class="goods_color">湖兰+纯蓝</span>
                                        </td>
                                        <td><input type="hidden"  class="size_val" name="size[1][4][size]" value="26" />
                                            <input type="hidden"  class="code_segment" name="size[1][4][code_segment]" value="1" />
                                            <span class="goods_size">26</span>
                                        </td>
                                        <td><input class="size-note" type="text" name="size[1][4][size_note]" value="18cm（内长16c" /></td>
                                        <td><input class="text price sell_price" type="text" name="size[1][4][stocks_price]" data_type="price" nc_type="price" value="219.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text price goods_marketprice" type="text" name="size[1][4][stocks_marketprice]" data_type="marketprice" nc_type="|marketprice" value="219.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text sku stocks_code" type="text" name="size[1][4][stocks_sku]" nctype="stocks_code" value="" /><span class="error checkCode" style="display:none;">此货号已有其他颜色占用。</span><span class="error dberr" style="display:none;">此货号已被同品牌的其他商品占用。</span></td>
                                        <td><input class="text bar_code" type="text" name="size[1][4][stocks_bar_code]" data_type="stocks_bar_code" nc_type="|stocks_bar_code" value="" /></td>
                                        </tr>
                                                                                                                                                            <tr class="creat_tr_2 size_tr_22">
                                        <input type="hidden"  class="goods_ea_id" name="size[2][0][goods_ea_id]" value="117783" />
                                        <td><input type="hidden"  class="color" name="size[2][0][color]" value="花色" />
                                            <span class="goods_color">黑+湖兰</span>
                                        </td>
                                        <td><input type="hidden"  class="size_val" name="size[2][0][size]" value="22" />
                                            <input type="hidden"  class="code_segment" name="size[2][0][code_segment]" value="1" />
                                            <span class="goods_size">22</span>
                                        </td>
                                        <td><input class="size-note" type="text" name="size[2][0][size_note]" value="16cm（内长13." /></td>
                                        <td><input class="text price sell_price" type="text" name="size[2][0][stocks_price]" data_type="price" nc_type="price" value="239.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text price goods_marketprice" type="text" name="size[2][0][stocks_marketprice]" data_type="marketprice" nc_type="|marketprice" value="239.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text sku stocks_code" type="text" name="size[2][0][stocks_sku]" nctype="stocks_code" value="" /><span class="error checkCode" style="display:none;">此货号已有其他颜色占用。</span><span class="error dberr" style="display:none;">此货号已被同品牌的其他商品占用。</span></td>
                                        <td><input class="text bar_code" type="text" name="size[2][0][stocks_bar_code]" data_type="stocks_bar_code" nc_type="|stocks_bar_code" value="" /></td>
                                        </tr>
                                                                                <tr class="creat_tr_2 size_tr_23">
                                        <input type="hidden"  class="goods_ea_id" name="size[2][1][goods_ea_id]" value="117784" />
                                        <td><input type="hidden"  class="color" name="size[2][1][color]" value="花色" />
                                            <span class="goods_color">黑+湖兰</span>
                                        </td>
                                        <td><input type="hidden"  class="size_val" name="size[2][1][size]" value="23" />
                                            <input type="hidden"  class="code_segment" name="size[2][1][code_segment]" value="1" />
                                            <span class="goods_size">23</span>
                                        </td>
                                        <td><input class="size-note" type="text" name="size[2][1][size_note]" value="16.5cm（内长1" /></td>
                                        <td><input class="text price sell_price" type="text" name="size[2][1][stocks_price]" data_type="price" nc_type="price" value="239.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text price goods_marketprice" type="text" name="size[2][1][stocks_marketprice]" data_type="marketprice" nc_type="|marketprice" value="239.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text sku stocks_code" type="text" name="size[2][1][stocks_sku]" nctype="stocks_code" value="" /><span class="error checkCode" style="display:none;">此货号已有其他颜色占用。</span><span class="error dberr" style="display:none;">此货号已被同品牌的其他商品占用。</span></td>
                                        <td><input class="text bar_code" type="text" name="size[2][1][stocks_bar_code]" data_type="stocks_bar_code" nc_type="|stocks_bar_code" value="" /></td>
                                        </tr>
                                                                                <tr class="creat_tr_2 size_tr_24">
                                        <input type="hidden"  class="goods_ea_id" name="size[2][2][goods_ea_id]" value="117785" />
                                        <td><input type="hidden"  class="color" name="size[2][2][color]" value="花色" />
                                            <span class="goods_color">黑+湖兰</span>
                                        </td>
                                        <td><input type="hidden"  class="size_val" name="size[2][2][size]" value="24" />
                                            <input type="hidden"  class="code_segment" name="size[2][2][code_segment]" value="1" />
                                            <span class="goods_size">24</span>
                                        </td>
                                        <td><input class="size-note" type="text" name="size[2][2][size_note]" value="17cm（内长14." /></td>
                                        <td><input class="text price sell_price" type="text" name="size[2][2][stocks_price]" data_type="price" nc_type="price" value="239.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text price goods_marketprice" type="text" name="size[2][2][stocks_marketprice]" data_type="marketprice" nc_type="|marketprice" value="239.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text sku stocks_code" type="text" name="size[2][2][stocks_sku]" nctype="stocks_code" value="" /><span class="error checkCode" style="display:none;">此货号已有其他颜色占用。</span><span class="error dberr" style="display:none;">此货号已被同品牌的其他商品占用。</span></td>
                                        <td><input class="text bar_code" type="text" name="size[2][2][stocks_bar_code]" data_type="stocks_bar_code" nc_type="|stocks_bar_code" value="" /></td>
                                        </tr>
                                                                                <tr class="creat_tr_2 size_tr_25">
                                        <input type="hidden"  class="goods_ea_id" name="size[2][3][goods_ea_id]" value="117786" />
                                        <td><input type="hidden"  class="color" name="size[2][3][color]" value="花色" />
                                            <span class="goods_color">黑+湖兰</span>
                                        </td>
                                        <td><input type="hidden"  class="size_val" name="size[2][3][size]" value="25" />
                                            <input type="hidden"  class="code_segment" name="size[2][3][code_segment]" value="1" />
                                            <span class="goods_size">25</span>
                                        </td>
                                        <td><input class="size-note" type="text" name="size[2][3][size_note]" value="17.5cm（内长1" /></td>
                                        <td><input class="text price sell_price" type="text" name="size[2][3][stocks_price]" data_type="price" nc_type="price" value="239.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text price goods_marketprice" type="text" name="size[2][3][stocks_marketprice]" data_type="marketprice" nc_type="|marketprice" value="239.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text sku stocks_code" type="text" name="size[2][3][stocks_sku]" nctype="stocks_code" value="" /><span class="error checkCode" style="display:none;">此货号已有其他颜色占用。</span><span class="error dberr" style="display:none;">此货号已被同品牌的其他商品占用。</span></td>
                                        <td><input class="text bar_code" type="text" name="size[2][3][stocks_bar_code]" data_type="stocks_bar_code" nc_type="|stocks_bar_code" value="" /></td>
                                        </tr>
                                                                                <tr class="creat_tr_2 size_tr_26">
                                        <input type="hidden"  class="goods_ea_id" name="size[2][4][goods_ea_id]" value="117787" />
                                        <td><input type="hidden"  class="color" name="size[2][4][color]" value="花色" />
                                            <span class="goods_color">黑+湖兰</span>
                                        </td>
                                        <td><input type="hidden"  class="size_val" name="size[2][4][size]" value="26" />
                                            <input type="hidden"  class="code_segment" name="size[2][4][code_segment]" value="1" />
                                            <span class="goods_size">26</span>
                                        </td>
                                        <td><input class="size-note" type="text" name="size[2][4][size_note]" value="18cm（内长16c" /></td>
                                        <td><input class="text price sell_price" type="text" name="size[2][4][stocks_price]" data_type="price" nc_type="price" value="239.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text price goods_marketprice" type="text" name="size[2][4][stocks_marketprice]" data_type="marketprice" nc_type="|marketprice" value="239.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text sku stocks_code" type="text" name="size[2][4][stocks_sku]" nctype="stocks_code" value="" /><span class="error checkCode" style="display:none;">此货号已有其他颜色占用。</span><span class="error dberr" style="display:none;">此货号已被同品牌的其他商品占用。</span></td>
                                        <td><input class="text bar_code" type="text" name="size[2][4][stocks_bar_code]" data_type="stocks_bar_code" nc_type="|stocks_bar_code" value="" /></td>
                                        </tr>
                                                                                                                                                            <tr class="creat_tr_3 size_tr_22">
                                        <input type="hidden"  class="goods_ea_id" name="size[3][0][goods_ea_id]" value="117788" />
                                        <td><input type="hidden"  class="color" name="size[3][0][color]" value="花色" />
                                            <span class="goods_color">奥运蓝+荧光绿</span>
                                        </td>
                                        <td><input type="hidden"  class="size_val" name="size[3][0][size]" value="22" />
                                            <input type="hidden"  class="code_segment" name="size[3][0][code_segment]" value="1" />
                                            <span class="goods_size">22</span>
                                        </td>
                                        <td><input class="size-note" type="text" name="size[3][0][size_note]" value="16cm（内长13." /></td>
                                        <td><input class="text price sell_price" type="text" name="size[3][0][stocks_price]" data_type="price" nc_type="price" value="239.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text price goods_marketprice" type="text" name="size[3][0][stocks_marketprice]" data_type="marketprice" nc_type="|marketprice" value="239.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text sku stocks_code" type="text" name="size[3][0][stocks_sku]" nctype="stocks_code" value="" /><span class="error checkCode" style="display:none;">此货号已有其他颜色占用。</span><span class="error dberr" style="display:none;">此货号已被同品牌的其他商品占用。</span></td>
                                        <td><input class="text bar_code" type="text" name="size[3][0][stocks_bar_code]" data_type="stocks_bar_code" nc_type="|stocks_bar_code" value="" /></td>
                                        </tr>
                                                                                <tr class="creat_tr_3 size_tr_23">
                                        <input type="hidden"  class="goods_ea_id" name="size[3][1][goods_ea_id]" value="117789" />
                                        <td><input type="hidden"  class="color" name="size[3][1][color]" value="花色" />
                                            <span class="goods_color">奥运蓝+荧光绿</span>
                                        </td>
                                        <td><input type="hidden"  class="size_val" name="size[3][1][size]" value="23" />
                                            <input type="hidden"  class="code_segment" name="size[3][1][code_segment]" value="1" />
                                            <span class="goods_size">23</span>
                                        </td>
                                        <td><input class="size-note" type="text" name="size[3][1][size_note]" value="16.5cm（内长1" /></td>
                                        <td><input class="text price sell_price" type="text" name="size[3][1][stocks_price]" data_type="price" nc_type="price" value="239.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text price goods_marketprice" type="text" name="size[3][1][stocks_marketprice]" data_type="marketprice" nc_type="|marketprice" value="239.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text sku stocks_code" type="text" name="size[3][1][stocks_sku]" nctype="stocks_code" value="" /><span class="error checkCode" style="display:none;">此货号已有其他颜色占用。</span><span class="error dberr" style="display:none;">此货号已被同品牌的其他商品占用。</span></td>
                                        <td><input class="text bar_code" type="text" name="size[3][1][stocks_bar_code]" data_type="stocks_bar_code" nc_type="|stocks_bar_code" value="" /></td>
                                        </tr>
                                                                                <tr class="creat_tr_3 size_tr_24">
                                        <input type="hidden"  class="goods_ea_id" name="size[3][2][goods_ea_id]" value="117790" />
                                        <td><input type="hidden"  class="color" name="size[3][2][color]" value="花色" />
                                            <span class="goods_color">奥运蓝+荧光绿</span>
                                        </td>
                                        <td><input type="hidden"  class="size_val" name="size[3][2][size]" value="24" />
                                            <input type="hidden"  class="code_segment" name="size[3][2][code_segment]" value="1" />
                                            <span class="goods_size">24</span>
                                        </td>
                                        <td><input class="size-note" type="text" name="size[3][2][size_note]" value="17cm（内长14." /></td>
                                        <td><input class="text price sell_price" type="text" name="size[3][2][stocks_price]" data_type="price" nc_type="price" value="239.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text price goods_marketprice" type="text" name="size[3][2][stocks_marketprice]" data_type="marketprice" nc_type="|marketprice" value="239.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text sku stocks_code" type="text" name="size[3][2][stocks_sku]" nctype="stocks_code" value="" /><span class="error checkCode" style="display:none;">此货号已有其他颜色占用。</span><span class="error dberr" style="display:none;">此货号已被同品牌的其他商品占用。</span></td>
                                        <td><input class="text bar_code" type="text" name="size[3][2][stocks_bar_code]" data_type="stocks_bar_code" nc_type="|stocks_bar_code" value="" /></td>
                                        </tr>
                                                                                <tr class="creat_tr_3 size_tr_25">
                                        <input type="hidden"  class="goods_ea_id" name="size[3][3][goods_ea_id]" value="117791" />
                                        <td><input type="hidden"  class="color" name="size[3][3][color]" value="花色" />
                                            <span class="goods_color">奥运蓝+荧光绿</span>
                                        </td>
                                        <td><input type="hidden"  class="size_val" name="size[3][3][size]" value="25" />
                                            <input type="hidden"  class="code_segment" name="size[3][3][code_segment]" value="1" />
                                            <span class="goods_size">25</span>
                                        </td>
                                        <td><input class="size-note" type="text" name="size[3][3][size_note]" value="17.5cm（内长1" /></td>
                                        <td><input class="text price sell_price" type="text" name="size[3][3][stocks_price]" data_type="price" nc_type="price" value="239.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text price goods_marketprice" type="text" name="size[3][3][stocks_marketprice]" data_type="marketprice" nc_type="|marketprice" value="239.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text sku stocks_code" type="text" name="size[3][3][stocks_sku]" nctype="stocks_code" value="" /><span class="error checkCode" style="display:none;">此货号已有其他颜色占用。</span><span class="error dberr" style="display:none;">此货号已被同品牌的其他商品占用。</span></td>
                                        <td><input class="text bar_code" type="text" name="size[3][3][stocks_bar_code]" data_type="stocks_bar_code" nc_type="|stocks_bar_code" value="" /></td>
                                        </tr>
                                                                                <tr class="creat_tr_3 size_tr_26">
                                        <input type="hidden"  class="goods_ea_id" name="size[3][4][goods_ea_id]" value="117792" />
                                        <td><input type="hidden"  class="color" name="size[3][4][color]" value="花色" />
                                            <span class="goods_color">奥运蓝+荧光绿</span>
                                        </td>
                                        <td><input type="hidden"  class="size_val" name="size[3][4][size]" value="26" />
                                            <input type="hidden"  class="code_segment" name="size[3][4][code_segment]" value="1" />
                                            <span class="goods_size">26</span>
                                        </td>
                                        <td><input class="size-note" type="text" name="size[3][4][size_note]" value="18cm（内长16c" /></td>
                                        <td><input class="text price sell_price" type="text" name="size[3][4][stocks_price]" data_type="price" nc_type="price" value="239.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text price goods_marketprice" type="text" name="size[3][4][stocks_marketprice]" data_type="marketprice" nc_type="|marketprice" value="239.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text sku stocks_code" type="text" name="size[3][4][stocks_sku]" nctype="stocks_code" value="" /><span class="error checkCode" style="display:none;">此货号已有其他颜色占用。</span><span class="error dberr" style="display:none;">此货号已被同品牌的其他商品占用。</span></td>
                                        <td><input class="text bar_code" type="text" name="size[3][4][stocks_bar_code]" data_type="stocks_bar_code" nc_type="|stocks_bar_code" value="" /></td>
                                        </tr>
                                                                                                                                                            <tr class="creat_tr_4 size_tr_22">
                                        <input type="hidden"  class="goods_ea_id" name="size[4][0][goods_ea_id]" value="117793" />
                                        <td><input type="hidden"  class="color" name="size[4][0][color]" value="花色" />
                                            <span class="goods_color">红+宝蓝</span>
                                        </td>
                                        <td><input type="hidden"  class="size_val" name="size[4][0][size]" value="22" />
                                            <input type="hidden"  class="code_segment" name="size[4][0][code_segment]" value="1" />
                                            <span class="goods_size">22</span>
                                        </td>
                                        <td><input class="size-note" type="text" name="size[4][0][size_note]" value="16cm（内长13." /></td>
                                        <td><input class="text price sell_price" type="text" name="size[4][0][stocks_price]" data_type="price" nc_type="price" value="239.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text price goods_marketprice" type="text" name="size[4][0][stocks_marketprice]" data_type="marketprice" nc_type="|marketprice" value="239.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text sku stocks_code" type="text" name="size[4][0][stocks_sku]" nctype="stocks_code" value="" /><span class="error checkCode" style="display:none;">此货号已有其他颜色占用。</span><span class="error dberr" style="display:none;">此货号已被同品牌的其他商品占用。</span></td>
                                        <td><input class="text bar_code" type="text" name="size[4][0][stocks_bar_code]" data_type="stocks_bar_code" nc_type="|stocks_bar_code" value="" /></td>
                                        </tr>
                                                                                <tr class="creat_tr_4 size_tr_23">
                                        <input type="hidden"  class="goods_ea_id" name="size[4][1][goods_ea_id]" value="117794" />
                                        <td><input type="hidden"  class="color" name="size[4][1][color]" value="花色" />
                                            <span class="goods_color">红+宝蓝</span>
                                        </td>
                                        <td><input type="hidden"  class="size_val" name="size[4][1][size]" value="23" />
                                            <input type="hidden"  class="code_segment" name="size[4][1][code_segment]" value="1" />
                                            <span class="goods_size">23</span>
                                        </td>
                                        <td><input class="size-note" type="text" name="size[4][1][size_note]" value="16.5cm（内长1" /></td>
                                        <td><input class="text price sell_price" type="text" name="size[4][1][stocks_price]" data_type="price" nc_type="price" value="239.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text price goods_marketprice" type="text" name="size[4][1][stocks_marketprice]" data_type="marketprice" nc_type="|marketprice" value="239.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text sku stocks_code" type="text" name="size[4][1][stocks_sku]" nctype="stocks_code" value="" /><span class="error checkCode" style="display:none;">此货号已有其他颜色占用。</span><span class="error dberr" style="display:none;">此货号已被同品牌的其他商品占用。</span></td>
                                        <td><input class="text bar_code" type="text" name="size[4][1][stocks_bar_code]" data_type="stocks_bar_code" nc_type="|stocks_bar_code" value="" /></td>
                                        </tr>
                                                                                <tr class="creat_tr_4 size_tr_24">
                                        <input type="hidden"  class="goods_ea_id" name="size[4][2][goods_ea_id]" value="117795" />
                                        <td><input type="hidden"  class="color" name="size[4][2][color]" value="花色" />
                                            <span class="goods_color">红+宝蓝</span>
                                        </td>
                                        <td><input type="hidden"  class="size_val" name="size[4][2][size]" value="24" />
                                            <input type="hidden"  class="code_segment" name="size[4][2][code_segment]" value="1" />
                                            <span class="goods_size">24</span>
                                        </td>
                                        <td><input class="size-note" type="text" name="size[4][2][size_note]" value="17cm（内长14." /></td>
                                        <td><input class="text price sell_price" type="text" name="size[4][2][stocks_price]" data_type="price" nc_type="price" value="239.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text price goods_marketprice" type="text" name="size[4][2][stocks_marketprice]" data_type="marketprice" nc_type="|marketprice" value="239.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text sku stocks_code" type="text" name="size[4][2][stocks_sku]" nctype="stocks_code" value="" /><span class="error checkCode" style="display:none;">此货号已有其他颜色占用。</span><span class="error dberr" style="display:none;">此货号已被同品牌的其他商品占用。</span></td>
                                        <td><input class="text bar_code" type="text" name="size[4][2][stocks_bar_code]" data_type="stocks_bar_code" nc_type="|stocks_bar_code" value="" /></td>
                                        </tr>
                                                                                <tr class="creat_tr_4 size_tr_25">
                                        <input type="hidden"  class="goods_ea_id" name="size[4][3][goods_ea_id]" value="117796" />
                                        <td><input type="hidden"  class="color" name="size[4][3][color]" value="花色" />
                                            <span class="goods_color">红+宝蓝</span>
                                        </td>
                                        <td><input type="hidden"  class="size_val" name="size[4][3][size]" value="25" />
                                            <input type="hidden"  class="code_segment" name="size[4][3][code_segment]" value="1" />
                                            <span class="goods_size">25</span>
                                        </td>
                                        <td><input class="size-note" type="text" name="size[4][3][size_note]" value="17.5cm（内长1" /></td>
                                        <td><input class="text price sell_price" type="text" name="size[4][3][stocks_price]" data_type="price" nc_type="price" value="239.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text price goods_marketprice" type="text" name="size[4][3][stocks_marketprice]" data_type="marketprice" nc_type="|marketprice" value="239.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text sku stocks_code" type="text" name="size[4][3][stocks_sku]" nctype="stocks_code" value="" /><span class="error checkCode" style="display:none;">此货号已有其他颜色占用。</span><span class="error dberr" style="display:none;">此货号已被同品牌的其他商品占用。</span></td>
                                        <td><input class="text bar_code" type="text" name="size[4][3][stocks_bar_code]" data_type="stocks_bar_code" nc_type="|stocks_bar_code" value="" /></td>
                                        </tr>
                                                                                <tr class="creat_tr_4 size_tr_26">
                                        <input type="hidden"  class="goods_ea_id" name="size[4][4][goods_ea_id]" value="117797" />
                                        <td><input type="hidden"  class="color" name="size[4][4][color]" value="花色" />
                                            <span class="goods_color">红+宝蓝</span>
                                        </td>
                                        <td><input type="hidden"  class="size_val" name="size[4][4][size]" value="26" />
                                            <input type="hidden"  class="code_segment" name="size[4][4][code_segment]" value="1" />
                                            <span class="goods_size">26</span>
                                        </td>
                                        <td><input class="size-note" type="text" name="size[4][4][size_note]" value="18cm（内长16c" /></td>
                                        <td><input class="text price sell_price" type="text" name="size[4][4][stocks_price]" data_type="price" nc_type="price" value="239.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text price goods_marketprice" type="text" name="size[4][4][stocks_marketprice]" data_type="marketprice" nc_type="|marketprice" value="239.00" /><em class="add-on"><i class="fa fa-rmb"></i></em></td>
                                        <td><input class="text sku stocks_code" type="text" name="size[4][4][stocks_sku]" nctype="stocks_code" value="" /><span class="error checkCode" style="display:none;">此货号已有其他颜色占用。</span><span class="error dberr" style="display:none;">此货号已被同品牌的其他商品占用。</span></td>
                                        <td><input class="text bar_code" type="text" name="size[4][4][stocks_bar_code]" data_type="stocks_bar_code" nc_type="|stocks_bar_code" value="" /></td>
                                        </tr>
                                                                                                                                        </tbody>
                        </table>
                ...
                <dd>
                    <div class="ncsc-goods-default-pic">
                        <div class="goodspic-uplaod">
                            <div class="upload-thumb"> <img nctype="goods_image" src="http://[::1]/yunjuke/data/shop/album_pic/134821557016452381.jpg"> </div>
                            <input type="hidden" name="base_info[goods_image]" id="image_path" nctype="goods_image" value="134821557016452381.jpg">
                            <span class="err"></span>
                    ...
                    <div id="" class="mt-20 hide demo">
                        ...
                        <!--  <a class="sample_demo" id="select_submit" href="" style="display:none;">提交</a>-->
                            ...
                            <ul class="list pic_list" >
                                <!-- <li onclick="insert_img('xx.png','http://[::1]/yunjuke/application/pay/views/images/u374.png')"><a href="JavaScript:void(0);"><img src="http://[::1]/yunjuke/application/pay/views/images/u374.png" ></a></li> -->
                        ...
                        <div id="tab_demo" class="HuiTab">
                            ...
                            <div class="tabCon mt-10">
                                <div class="" id="baidu_edit">
                                    <!-- 加载编辑器的容器 -->
                                    <textarea id="content" name="content" type="text/plain"><a name="hn_401418304150468776773_start"></a><div class="module moudleDrag" style="width:750.0px;display:inline-block;"><ul class="module-item-list" style="float:left;padding:0.0px;margin:0.0px;height:386.0px;width:750.0px;"><li style="width:748.0px;height:374.0px;float:left;margin-top:10.0px;border:1.0px solid #E83511;background-color:#ffffff;list-style:none;"><a style="height:56.0px;display:block;margin:0 16.0px;font-family:微软雅黑;font-size:22.0px;line-height:56.0px;text-align:left;color:#333333;font-weight:bold;overflow:hidden;text-decoration:none;float:none;display:block;clear:both;"><font style="color:#dd3314;">[今日活动]</font><font>ABCkids童鞋冬款新款男童跑鞋儿童休闲鞋男孩宝宝运动鞋Y65215197</font></a><div style="width:431.0px;float:left;text-align:center;"><table cellspacing="0" background="https://img.alicdn.com/imgextra/i1/401418304/TB2Q6RCb9FRMKJjy0FhXXX.xpXa-401418304.png" style="width:314.0px;height:118.0px;overflow:hidden;float:left;display:block;margin-left:58.0px;"><tr height="66" style="border:0;"><td width="314" height="66" colspan="5" style="vertical-align:top;padding:0;"><span style="width:200.0px;text-align:center;height:66.0px;line-height:66.0px;font-size:14.0px;font-weight:bold;font-family:微软雅黑;color:#ffffff;float:left;">￥<font style="font-size:40.0px;font-family:impact;font-weight:normal;">75</font></span><a href="http://item.taobao.com/item.htm?id=557698710047" style="width:90.0px;height:42.0px;margin:12.0px 24.0px 12.0px 0.0px;display:block;float:left;"><img src="https://img.alicdn.com/imgextra/i1/401418304/TB29jkvdUEIL1JjSZFFXXc5kVXa-401418304.png"></a></td></tr><tr height="52" style="border:0;"><td width="30" style="vertical-align:top;padding:0;"></td><td width="94" style="vertical-align:top;padding:0;"><span style="font-size:14.0px;line-height:20.0px;color:#3a3a3a;float:none;display:block;margin:6.0px 0.0px;">市场价<br><b>219.00</b></span></td><td width="79" style="vertical-align:top;padding:0;"><span style="font-size:14.0px;line-height:20.0px;color:#3a3a3a;float:none;display:block;margin:6.0px 0.0px;">折扣<br><b style="color:#e94745;">3.4<font></font></b></span></td><td width="81" style="vertical-align:top;padding:0;"><span style="font-size:14.0px;line-height:20.0px;color:#3a3a3a;float:none;display:block;margin:6.0px 0.0px;">节省<br><b>-144</b></span></td><td width="30" style="vertical-align:top;padding:0;"></td></tr></table><div style="width:214.0px;background-color:#ffffff;border:1.0px solid #FEF491;float:left;margin-left:87.0px;text-align:center;padding:18.0px 15.0px 15.0px 25.0px;"><div style="float:left;"><span style="display:block;width:100.0%;text-align:left;padding-bottom:14.0px;font-size:12.0px;font-family:微软雅黑;color:#333333;"><font style="color:#41a53a;font-size:22.0px;font-weight:bold;">5</font>人参加了活动！</span><span style="display:block;width:100.0%;text-align:left;padding-bottom:25.0px;font-size:14.0px;font-family:微软雅黑;color:#333333;">数量有限，赶快下单吧！</span><span style="display:block;width:100.0%;text-align:left;line-height:14.0px;font-family:宋体;font-size:14.0px;color:#666666;">剩余时间：</span><div class="module-item-countdown" style="clear:both;font-family:微软雅黑;height:28.0px;float:left;margin-top:16.0px;"><span class="day" style="float:left;line-height:28.0px;font-size:24.0px;padding:0 5.0px;color:#111111;">2</span><span style="float:left;font-size:14.0px;color:#3a3a3a;padding-top:7.0px;">天</span><span class="hour" style="float:left;line-height:28.0px;font-size:24.0px;padding:0 5.0px;color:#111111;">1</span><span style="float:left;font-size:14.0px;color:#3a3a3a;padding-top:7.0px;">时</span><span class="minute" style="float:left;line-height:28.0px;font-size:24.0px;padding:0 5.0px;color:#111111;">28</span><span style="float:left;font-size:14.0px;color:#3a3a3a;padding-top:7.0px;">分</span><span style="float:left;line-height:28.0px;padding:0 5.0px;"><img src="https://img.alicdn.com/imgextra/i3/401418304/TB2YazWdjJTMKJjSZFPXXbHUFXa-401418304.gif"></span><span style="float:left;font-size:14.0px;color:#3a3a3a;padding-top:7.0px;">秒</span></div></div></div></div><div style="float:right;padding:0 16.0px 0 0;"><a href="http://item.taobao.com/item.htm?id=557698710047" style="padding:7.0px;border:1.0px solid #9F0E00;background-color:#e83511;float:left;"><img class="module-item-pic" src="https://img.alicdn.com/bao/uploaded/i2/401418304/TB1fNybat.LL1JjSZFEXXcVmXXa_!!0-item_pic.jpg" style="width:285.0px;height:285.0px;"></a></div><div class="operate"><div class="opera_bg"></div><span class="close"></span></div></li></ul></div><a name="hn_401418304150468776773_end"></a><a name="hn_401418304_1504578818_start"></a><div class="module module-750" style="width:750.0px;background:#ffffff;display:inline-block;overflow:hidden;"><div style="width:734.0px;margin:5.0px 8.0px;float:left;"><div style="width:124.0px;height:168.0px;margin:9.0px 5.0px;float:left;"><img style="width:124.0px;height:168.0px;float:left;" src="https://img.alicdn.com/imgextra/i3/401418304/TB29uCNXgYDK1JjSZPiXXbcHVXa-401418304.png"></div><ul class="coupon-list" style="width:585.0px;margin:0;padding:0;list-style:none;display:block;float:right;"><li style="margin:5.0px;list-style:none;float:left;"><table width="185" height="176" cellspacing="0" border="0" background="https://img.alicdn.com/imgextra/i4/401418304/TB2znj7XwsSMeJjSspcXXXjFXXa-401418304.png"><tr style="border:0;"><td style="padding:0;vertical-align:top;"><a style="width:100.0%;height:100.0%;display:block;float:left;display:inline-block;display:inline-block;" href="https://taoquan.taobao.com/coupon/unify_apply.htm?sellerId=401418304&activityId=380543b83a56410dba0fe3dd6fc46829" target="_blank"><div style="width:185.0px;height:176.0px;font-family:微软雅黑;color:#ffffff;float:left;"><div style="width:100.0%;text-align:center;height:22.0px;line-height:22.0px;font-size:15.0px;margin:20.0px 0.0px 6.0px 0.0px;overflow:hidden;float:left;">&lt;限<font>17-09-30</font>&gt;</div><div style="width:100.0%;text-align:center;height:44.0px;float:left;"><div style="display:inline-block;float:none;"><table height="44" cellspacing="0" border="0" background="https://img.alicdn.com/imgextra/i3/401418304/TB2PnHKX5wIL1JjSZFsXXcXFFXa-401418304.png" style="background-position:0.0px 4.0px;background-repeat:no-repeat;"><tr style="border:0;"><td style="padding:0;vertical-align:top;"><div class="deno" style="height:44.0px;line-height:44.0px;font-size:44.0px;font-weight:bold;padding:0.0px 18.0px;float:left;">3</div></td></tr></table></div></div><div style="width:100.0%;text-align:center;height:22.0px;line-height:22.0px;font-size:15.0px;margin:6.0px 0.0px 56.0px 0.0px;overflow:hidden;float:left;">满<font>8</font>元使用</div></div></a></td></tr></table></li><li style="margin:5.0px;list-style:none;float:left;"><table width="185" height="176" cellspacing="0" border="0" background="https://img.alicdn.com/imgextra/i4/401418304/TB2znj7XwsSMeJjSspcXXXjFXXa-401418304.png"><tr style="border:0;"><td style="padding:0;vertical-align:top;"><a style="width:100.0%;height:100.0%;display:block;float:left;display:inline-block;display:inline-block;" href="https://taoquan.taobao.com/coupon/unify_apply.htm?sellerId=401418304&activityId=4598e0f0274042f5997a380098ba7daf" target="_blank"><div style="width:185.0px;height:176.0px;font-family:微软雅黑;color:#ffffff;float:left;"><div style="width:100.0%;text-align:center;height:22.0px;line-height:22.0px;font-size:15.0px;margin:20.0px 0.0px 6.0px 0.0px;overflow:hidden;float:left;">&lt;限<font>17-09-30</font>&gt;</div><div style="width:100.0%;text-align:center;height:44.0px;float:left;"><div style="display:inline-block;float:none;"><table height="44" cellspacing="0" border="0" background="https://img.alicdn.com/imgextra/i3/401418304/TB2PnHKX5wIL1JjSZFsXXcXFFXa-401418304.png" style="background-position:0.0px 4.0px;background-repeat:no-repeat;"><tr style="border:0;"><td style="padding:0;vertical-align:top;"><div class="deno" style="height:44.0px;line-height:44.0px;font-size:44.0px;font-weight:bold;padding:0.0px 18.0px;float:left;">5</div></td></tr></table></div></div><div style="width:100.0%;text-align:center;height:22.0px;line-height:22.0px;font-size:15.0px;margin:6.0px 0.0px 56.0px 0.0px;overflow:hidden;float:left;">满<font>138</font>元使用</div></div></a></td></tr></table><div class="operate"><div class="opera_bg"></div></div></li><li style="margin:5.0px;list-style:none;float:left;"><table width="185" height="176" cellspacing="0" border="0" background="https://img.alicdn.com/imgextra/i4/401418304/TB2znj7XwsSMeJjSspcXXXjFXXa-401418304.png"><tr style="border:0;"><td style="padding:0;vertical-align:top;"><a style="width:100.0%;height:100.0%;display:block;float:left;display:inline-block;display:inline-block;" href="https://taoquan.taobao.com/coupon/unify_apply.htm?sellerId=401418304&activityId=7732786ecd7f42be97f1f7b30f3805bd" target="_blank"><div style="width:185.0px;height:176.0px;font-family:微软雅黑;color:#ffffff;float:left;"><div style="width:100.0%;text-align:center;height:22.0px;line-height:22.0px;font-size:15.0px;margin:20.0px 0.0px 6.0px 0.0px;overflow:hidden;float:left;">&lt;限<font>17-09-30</font>&gt;</div><div style="width:100.0%;text-align:center;height:44.0px;float:left;"><div style="display:inline-block;float:none;"><table height="44" cellspacing="0" border="0" background="https://img.alicdn.com/imgextra/i3/401418304/TB2PnHKX5wIL1JjSZFsXXcXFFXa-401418304.png" style="background-position:0.0px 4.0px;background-repeat:no-repeat;"><tr style="border:0;"><td style="padding:0;vertical-align:top;"><div class="deno" style="height:44.0px;line-height:44.0px;font-size:44.0px;font-weight:bold;padding:0.0px 18.0px;float:left;">10</div></td></tr></table></div></div><div style="width:100.0%;text-align:center;height:22.0px;line-height:22.0px;font-size:15.0px;margin:6.0px 0.0px 56.0px 0.0px;overflow:hidden;float:left;">满<font>198</font>元使用</div></div></a></td></tr></table><div class="operate"><div class="opera_bg"></div></div></li></ul></div></div><a name="hn_401418304_1504578818_end"></a> <p><img style="max-width:750.0px;" src="https://img.alicdn.com/imgextra/i1/401418304/TB2vhxpaYH9F1JjSZFBXXc9ZFXa_!!401418304.gif" align="absmiddle"></p><p style="text-align:center;"><span style="font-size:24.0px;">款号：Y73215239  </span><span style="font-size:24.0px;line-height:1.5;">颜色：</span><span style="font-size:24.0px;color:#333333;font-family:arial;line-height:26.0px;">红+荧光绿 、湖兰+纯蓝   售价：219</span></p><p><img style="max-width:750.0px;" src="https://img.alicdn.com/imgextra/i4/401418304/TB2mWxZXx5GJuJjSZFFXXagvFXa-401418304.jpg" align="absmiddle"><img style="max-width:750.0px;" src="https://img.alicdn.com/imgextra/i2/401418304/TB2IL8WXqKIJuJjSZFxXXavHVXa-401418304.jpg" align="absmiddle"></p><p style="text-align:center;"><span style="font-size:18.0px;"><span style="color:#333333;font-family:arial;line-height:26.0px;text-align:center;"><span style="line-height:40.0px;text-align:center;">款号：Y73216229   颜色：</span><span style="text-align:center;color:#333333;font-family:arial;line-height:26.0px;"><span style="color:#333333;font-family:arial;line-height:26.0px;text-align:center;">黑+湖兰</span> 、<span style="color:#333333;font-family:arial;line-height:26.0px;text-align:center;">奥运蓝+荧光绿、<span style="color:#333333;font-family:arial;line-height:26.0px;text-align:center;">红+宝蓝</span></span>   售价：239<img style="max-width:750.0px;" src="https://img.alicdn.com/imgextra/i4/401418304/TB2l7OPa.ifF1JjSspnXXa5pVXa-401418304.jpg" align="absmiddle"><img style="max-width:750.0px;" src="https://img.alicdn.com/imgextra/i4/401418304/TB201uccxz_F1JjSZFIXXcxHVXa-401418304.jpg" align="absmiddle"></span></span></span><img style="max-width:750.0px;" src="https://img.alicdn.com/imgextra/i3/401418304/TB20F.NaHL9F1JjSZFlXXa2sVXa_!!401418304.jpg" align="absmiddle"><img style="max-width:750.0px;" src="https://img.alicdn.com/imgextra/i4/401418304/TB2tp6haHL9F1JjSZJiXXcDGpXa_!!401418304.gif" align="absmiddle"></p><div style="height:1.0px;overflow:hidden;line-height:20.0px;"> 最少5个字符</div></textarea>
                                    <!-- 实例化编辑器 -->
            ...
            <dl>
                ...
                <dl class="row">
                    ...
                    <dd class="opt">
                        <div class="onoff">
                            <label for="audit1" class="cb-enable " id="cb" title="开启">开启</label>
                            <label for="audit2" class="cb-disable selected" id="bc" title="关闭">关闭</label>
                            <input type="radio" id="audit1" name="base_info[available_coupons]" value="1" >
                            <input type="radio" id="audit2" name="base_info[available_coupons]" value="0" checked="checked">
                        </div>
                        <p class="notic"></p>
                    </dd>
                </dl>
                <dl class="row">
                    ...
                    <dd class="opt">
                        <div class="onoff">
                            <label for="audit3" class="cb-enable " id="cb" title="开启">开启</label>
                            <label for="audit4" class="cb-disable selected" id="bc" title="关闭">关闭</label>
                            <input type="radio" id="audit3" name="base_info[available_member_dis]" value="1" >
                            <input type="radio" id="audit4" name="base_info[available_member_dis]" value="0" checked="checked">
                        </div>
                        <p class="notic"></p>
                    </dd>
                </dl>
        ...
        <input name="m_body" autocomplete="off" type="hidden" value='http://a.m.taobao.com/i557016452381.htm'>
    </form>
<div id="fixedNavBar">
    <h3>页面导航</h3>
    <ul>
...
//  	判断是编辑还会提交新的内容
        ...
        function get_class_option(obj,class_id=0){
            if($(obj).length==0){
                return false;
            }
            $.ajax({
        ...
        function get_gstn_option(obj,gstn_id=0){
...
<script>
        ...
        //type:类型1：颜色 2：尺码
        //op:类型1：增加 2：删除
        function change_table(info={},type=1,op=1) {
        ...
        function become_color_select(){  //组装颜色选项卡
            ...
            $.each(color_arr, function (k, v) {
                ...
                if (v.cl_value.indexOf('#') > -1) {
                    ...
                    cl_value = 'url(http://[::1]/yunjuke/application/pay/views/images/' + v.cl_value + ')';
                }
            ...
            $.each(color_arr, function (k, v) {
                ...
                $.each(v.son_color, function (kk, vv) {
                    ...
                    if (vv.cl_value.indexOf('#') > -1) {
                        ...
                        cl_value = 'url(http://[::1]/yunjuke/application/pay/views/images/' + vv.cl_value + ')';
                    }
